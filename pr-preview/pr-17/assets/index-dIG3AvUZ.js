...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function tn(e,t,n){let r=new Float32Array(Vt),i=new I(0,1,0);return new g({name:`SphericalGaussianBlur`,defines:{n:Vt,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:an(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function nn(){return new g({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:an(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function rn(){return new g({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:an(),fragmentShader:`
	...
	`}var on=class extends nt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new tt(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var jr={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Mr(e,t){let n=jr[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Nr=new I;function Pr(){return W.getLuminanceCoefficients(Nr),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Nr.x.toFixed(4)}, ${Nr.y.toFixed(4)}, ${Nr.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Cr(i,i.VERTEX_SHADER,y),S=Cr(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=kr(i,x,`vertex`),n=kr(i,S,`fragment`);q(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`,za=class extends ha{scene;camera;layer;layerTarget;material;quad;savedClearColor=new P;constructor(e,t,n){super(),this.scene=e,this.camera=t,this.layer=n,this.layerTarget=new nt(1,1,{type:ue,depthBuffer:!0,depthTexture:Na(`Character fade depth`),stencilBuffer:!1}),this.layerTarget.texture.name=`Character fade layer`,this.layerTarget.samples=2,this.material=new g({name:`Depth-resolved character composite`,uniforms:{tWorld:{value:null},tLayer:{value:this.layerTarget.texture},tWorldDepth:{value:null},tLayerDepth:{value:this.layerTarget.depthTexture},uOpacity:{value:1}},vertexShader:La,fragmentShader:Ra,depthTest:!1,depthWrite:!1}),this.quad=new va(this.material)}setOpacity(e){this.material.uniforms.uOpacity.value=G.clamp(e,0,1)}getOpacity(){return this.material.uniforms.uOpacity.value}getDepthDiagnostics(){return{layerDepthTexture:this.layerTarget.depthTexture?.isDepthTexture===!0,worldDepthConnected:this.material.uniforms.tWorldDepth.value instanceof s}}setSize(e,t){this.layerTarget.setSize(e,t)}render(e,t,n){let r=this.camera.layers.mask,i=this.scene.background,a=e.getClearAlpha(),o=e.shadowMap.autoUpdate,s=e.getRenderTarget();e.getClearColor(this.savedClearColor);try{this.camera.layers.set(this.layer),this.scene.background=null,e.shadowMap.autoUpdate=!1,e.setRenderTarget(this.layerTarget),e.setClearColor(0,0),e.clear(!0,!0,!1),e.render(this.scene,this.camera)}finally{this.camera.layers.mask=r,this.scene.background=i,e.shadowMap.autoUpdate=o,e.setClearColor(this.savedClearColor,a),e.setRenderTarget(s)}if(!n.depthTexture)throw Error(`World render target has no depth texture for character occlusion.`);this.material.uniforms.tWorld.value=n.texture,this.material.uniforms.tWorldDepth.value=n.depthTexture,e.setRenderTarget(this.renderToScreen?null:t),this.clear&&e.clear(),this.quad.render(e)}dispose(){this.layerTarget.dispose(),this.material.dispose(),this.quad.dispose()}},Ba=class{renderer;composer;bloom;characterComposite;camera;resolutionScale=1;sizing=null;targetResizeCount=0;lastFrameRenderStats=Pa;constructor(e,t,n){this.camera=n,this.renderer=new Wi({canvas:e,antialias:!1,alpha:!1,powerPreference:`high-performance`,stencil:!1,depth:!0}),this.renderer.outputColorSpace=lt,this.renderer.toneMapping=6,this.renderer.toneMappingExposure=1.24,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.renderer.info.autoReset=!1,n.layers.set(0);let r=new nt(1,1,{type:ue,depthBuffer:!0,depthTexture:Na(`World scene depth`),stencilBuffer:!1});r.samples=2,this.composer=new Sa(this.renderer,r),this.composer.addPass(new Ta(t,n)),this.characterComposite=new za(t,n,1),this.composer.addPass(this.characterComposite),this.bloom=new Da(new U(1,1),.42,.48,.88),this.composer.addPass(this.bloom),this.composer.addPass(new wa),this.resize()}async init(){}render(e){this.renderer.info.reset();let t=Oa(this.characterComposite.getOpacity());this.camera.layers.set(0),this.characterComposite.enabled=t===`isolated-fade`,t===`direct-opaque`&&this.camera.layers.enable(1),this.composer.render(e),this.lastFrameRenderStats=Fa(this.renderer.info.render)}renderManual(e=0){this.render(e)}getLastFrameRenderStats(){return this.lastFrameRenderStats}resize(){let e=ja(window.innerWidth,window.innerHeight,window.devicePixelRatio,this.resolutionScale),t=!this.sizing||e.width!==this.sizing.width||e.height!==this.sizing.height,n=!this.sizing||Math.abs(e.pixelRatio-this.sizing.pixelRatio)>1e-4;!t&&!n||(n&&(this.renderer.setPixelRatio(e.pixelRatio),this.composer.setPixelRatio(e.pixelRatio),this.targetResizeCount+=1),t&&(this.renderer.setSize(e.width,e.height,!1),this.composer.setSize(e.width,e.height),this.targetResizeCount+=1),this.sizing=e)}setResolutionScale(e){Math.abs(e-this.resolutionScale)<.001||(this.resolutionScale=e,this.resize())}setCharacterOpacity(e){this.characterComposite.setOpacity(e)}bundleFixedChildren(e){}bundleDynamicChildren(e){}getCharacterOpacity(){return this.characterComposite.getOpacity()}getDepthCompositeDiagnostics(){return{...this.characterComposite.getDepthDiagnostics(),renderMode:Oa(this.characterComposite.getOpacity())}}readScreenCenterPixel(){let e=this.renderer.getContext(),t=this.renderer.getDrawingBufferSize(new U),n=new Uint8Array(4);return e.finish(),e.readPixels(Math.floor(t.x*.5),Math.floor(t.y*.5),1,1,e.RGBA,e.UNSIGNED_BYTE,n),[n[0],n[1],n[2],n[3]]}getSizingDiagnostics(){return{...this.sizing??ja(1,1,1,this.resolutionScale),targetResizeCount:this.targetResizeCount}}getActualBackend(){return`webgl`}onDeviceLost(e){return()=>void 0}getBackendDiagnostics(){let e=this.renderer.getContext(),t=e.getExtension(`WEBGL_debug_renderer_info`);return{preference:`webgl`,actual:`webgl`,backend:String(e.getParameter(e.VERSION)),vendor:String(e.getParameter(t?.UNMASKED_VENDOR_WEBGL??e.VENDOR)),device:String(e.getParameter(t?.UNMASKED_RENDERER_WEBGL??e.RENDERER)),fallback:!1}}getProgramCount(){return this.renderer.info.programs?.length??0}async synchronizeForLocalProfile(){this.renderer.getContext().finish()}async resolveGpuFrameTimeForLocalProfile(){return null}async compile(e,t){let n=t.layers.mask;try{t.layers.enable(1),await this.renderer.compileAsync(e,t)}finally{t.layers.mask=n}}dispose(){this.composer.dispose(),this.characterComposite.dispose(),this.renderer.dispose()}},Va=`modulepreload`,Ha=function(e){return`/cape-physics/pr-preview/pr-17/`+e},Ua={},Wa=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=Ha(t,n),t=s(t),t in Ua)return;Ua[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:Va,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Ga=class{canvas;scene;camera;trackTimestamps;implementation;preference;constructor(e,t,n,r,i=!1){this.canvas=e,this.scene=t,this.camera=n,this.trackTimestamps=i,this.preference=r,this.implementation=r===`webgl`?new Ba(e,t,n):null}get active(){if(!this.implementation)throw Error(`Render pipeline was used before initialization.`);return this.implementation}get renderer(){return this.active.renderer}usesNodeRenderer(){return!(this.active instanceof Ba)}getMaxAnisotropy(){return this.active instanceof Ba?this.active.renderer.capabilities.getMaxAnisotropy():this.active.renderer.getMaxAnisotropy()}async init(){if(!this.implementation){let{WebGpuRenderPipeline:e}=await Wa(async()=>{let{WebGpuRenderPipeline:e}=await import(`./WebGpuRenderPipeline-cKeYtlIA.js`);return{WebGpuRenderPipeline:e}},__vite__mapDeps([0,1,2,3]));this.implementation=new e(this.canvas,this.scene,this.camera,this.preference,this.trackTimestamps)}await this.active.init()}render(e=0){this.active.render(e)}renderManual(e=0){this.active.renderManual(e)}getLastFrameRenderStats(){return this.active.getLastFrameRenderStats()}resize(){this.active.resize()}setResolutionScale(e){this.active.setResolutionScale(e)}setCharacterOpacity(e){this.active.setCharacterOpacity(e)}bundleFixedChildren(e){this.active.bundleFixedChildren(e)}bundleDynamicChildren(e){this.active.bundleDynamicChildren(e)}getCharacterOpacity(){return this.active.getCharacterOpacity()}getDepthCompositeDiagnostics(){return this.active.getDepthCompositeDiagnostics()}async readScreenCenterPixel(){return await this.active.readScreenCenterPixel()}getSizingDiagnostics(){return this.active.getSizingDiagnostics()}getActualBackend(){return this.active.getActualBackend()}getWebGlRenderer(){return this.active instanceof Ba?this.active.renderer:null}getNodeRenderer(){return this.usesNodeRenderer()?this.active.renderer:null}getWebGpuRenderer(){return this.active.getActualBackend()===`webgpu`?this.getNodeRenderer():null}onDeviceLost(e){return this.active.onDeviceLost(e)}getBackendDiagnostics(){return this.active.getBackendDiagnostics()}getProgramCount(){return this.active.getProgramCount()}async synchronizeForLocalProfile(){await this.active.synchronizeForLocalProfile()}async resolveGpuFrameTimeForLocalProfile(){return await this.active.resolveGpuFrameTimeForLocalProfile()}async compile(e,t){await this.active.compile(e,t)}dispose(){this.implementation?.dispose(),this.implementation=null}},Ka=`renderer`;function qa(e){return e===`webgpu`||e===`webgl`?e:null}function Ja(e){let t=qa(new URLSearchParams(e.search).get(Ka));return t===null?`webgl`:t}function Ya(e){let t=new URL(e);return t.searchParams.delete(Ka),t.href}function Xa(e,t){let n=new URL(e);return n.searchParams.set(Ka,t),n.href}function Za(e=navigator){return`gpu`in e&&e.gpu!==void 0}function Qa(e,t,n=``){let r=new ae(e,t,t,qe);return r.wrapS=w,r.wrapT=w,r.colorSpace=n,r.needsUpdate=!0,r}function $a(e,t,n,r,i){e[t]=Math.round(G.clamp(n,0,255)),e[t+1]=Math.round(G.clamp(r,0,255)),e[t+2]=Math.round(G.clamp(i,0,255)),e[t+3]=255}function eo(e,t,n){let r=G.clamp((n-e)/(t-e),0,1);return r*r*(3-2*r)}function to(e=512){let t=new Uint8Array(e*e*4),n=new Uint8Array(e*e*4),r=new Uint8Array(e*e*4),i=new Uint8Array(e*e*4),a=new Float32Array(e*e);for(let t=0;t<e;t+=1)for(let n=0;n<e;n+=1){let r=n/e*8,i=t/e*8,o=_t(r,i,8,20903),s=_t(r*3,i*3,24,50238),c=Math.sin((r+o*.9)*3.1+Math.sin(i*1.8))*.5+.5;a[t*e+n]=G.clamp(o*.68+s*.2+c*.12,0,1)}for(let o=0;o<e;o+=1)for(let s=0;s<e;s+=1){let c=(o*e+s)*4,l=(t,n)=>{let r=(t+e)%e,i=(n+e)%e;return a[i*e+r]??0},u=l(s,o),d=Math.max(0,_t(s/e*24,o/e*24,24,6602)-.62),f=u**1.7;$a(t,c,25+f*29+d*48,31+f*31+d*24,31+f*27+d*12),$a(n,c,u*255,u*255,u*255);let p=l(s-1,o)-l(s+1,o),m=l(s,o-1)-l(s,o+1),h=new I(p*3.7,m*3.7,1).normalize();$a(r,c,(h.x*.5+.5)*255,(h.y*.5+.5)*255,h.z*255);let g=205+(1-u)*34+d*24;$a(i,c,g,g,g)}return{color:Qa(t,e,lt),height:Qa(n,e),normal:Qa(r,e),roughness:Qa(i,e)}}function no(e=256){let t=new Uint8Array(e*e*4),n=new Uint8Array(e*e*4),r=new Uint8Array(e*e*4);for(let i=0;i<e;i+=1)for(let a=0;a<e;a+=1){let o=(i*e+a)*4,s=Math.max(0,Math.sin(a/e*Math.PI*64))**8,c=Math.max(0,Math.sin(i/e*Math.PI*72))**8,l=_t(a/e*8,i/e*8,8,41244),u=s*.52+c*.48,d=.76+l*.24+u*.13,f=.92+_t(a/e*3,i/e*3,3,29172)*.08,p=(a+.5)/e,m=(i+.5)/e,h=1-eo(.018,.052,Math.min(p,1-p)),g=1-eo(.018,.052,m),_=Math.max(h,g)*.72,v=148*d*f,y=10*d,b=19*d;$a(t,o,G.lerp(v,158,_),G.lerp(y,73,_),G.lerp(b,28,_)),$a(n,o,128+(s-c)*18,128+(c-s)*18,249);let x=188+l*35-u*18;$a(r,o,x,x,x)}return{color:Qa(t,e,lt),normal:Qa(n,e),roughness:Qa(r,e)}}function ro(e,t){for(let n of Object.values(e))n.anisotropy=t}var io=class{canvas;onFirstInteraction;pressed=new Set;orbitDelta=new U;movement=new U;virtualMovement=new U;touchMovement=new U;zoomDelta=0;activePointer=null;lastPointer=new U;interacted=!1;virtualMovementEnabled=!1;virtualRunning=!1;touchMovementEnabled=!1;touchRunning=!1;jumpQueued=!1;virtualJumpQueued=!1;touchJumpQueued=!1;constructor(e,t){this.canvas=e,this.onFirstInteraction=t,window.addEventListener(`keydown`,this.handleKeyDown),window.addEventListener(`keyup`,this.handleKeyUp),window.addEventListener(`blur`,this.handleBlur),e.addEventListener(`pointerdown`,this.handlePointerDown),e.addEventListener(`pointermove`,this.handlePointerMove),e.addEventListener(`pointerup`,this.handlePointerUp),e.addEventListener(`pointercancel`,this.handlePointerUp),e.addEventListener(`wheel`,this.handleWheel,{passive:!1}),e.addEventListener(`contextmenu`,this.handleContextMenu)}getMovement(){if(this.virtualMovementEnabled)return this.virtualMovement;let e=Number(this.pressed.has(`KeyD`))-Number(this.pressed.has(`KeyA`)),t=Number(this.pressed.has(`KeyW`))-Number(this.pressed.has(`KeyS`));return this.movement.set(e,t),this.touchMovementEnabled&&this.movement.add(this.touchMovement),this.movement.clampLength(0,1)}setVirtualMovement(e,t){this.virtualMovement.set(e,t).clampLength(0,1),this.virtualMovementEnabled=!0}isRunning(){return this.virtualMovementEnabled?this.virtualRunning:this.touchRunning||this.pressed.has(`ShiftLeft`)||this.pressed.has(`ShiftRight`)}setVirtualRunning(e){this.virtualRunning=e}consumeJump(){let e=this.jumpQueued||this.virtualJumpQueued||this.touchJumpQueued;return this.jumpQueued=!1,this.virtualJumpQueued=!1,this.touchJumpQueued=!1,e}queueVirtualJump(){this.virtualJumpQueued=!0}clearVirtualMovement(){this.virtualMovement.set(0,0),this.virtualMovementEnabled=!1,this.virtualRunning=!1,this.virtualJumpQueued=!1}setTouchMovement(e,t){this.touchMovement.set(e,t).clampLength(0,1),this.touchMovementEnabled=!0,this.markInteracted()}clearTouchMovement(){this.touchMovement.set(0,0),this.touchMovementEnabled=!1}setTouchRunning(e){this.touchRunning=e,e&&this.markInteracted()}queueTouchJump(){this.touchJumpQueued=!0,this.markInteracted()}addTouchOrbitDelta(e,t){this.orbitDelta.x+=G.clamp(e,-180,180),this.orbitDelta.y+=G.clamp(t,-180,180),this.markInteracted()}addTouchZoomDelta(e){this.zoomDelta+=G.clamp(e,-2,2),e!==0&&this.markInteracted()}clearTouchInput(){this.clearTouchMovement(),this.touchRunning=!1,this.touchJumpQueued=!1}consumeOrbitDelta(e){e.copy(this.orbitDelta),this.orbitDelta.set(0,0)}consumeZoomDelta(){let e=this.zoomDelta;return this.zoomDelta=0,e}dispose(){window.removeEventListener(`keydown`,this.handleKeyDown),window.removeEventListener(`keyup`,this.handleKeyUp),window.removeEventListener(`blur`,this.handleBlur),this.canvas.removeEventListener(`pointerdown`,this.handlePointerDown),this.canvas.removeEventListener(`pointermove`,this.handlePointerMove),this.canvas.removeEventListener(`pointerup`,this.handlePointerUp),this.canvas.removeEventListener(`pointercancel`,this.handlePointerUp),this.canvas.removeEventListener(`wheel`,this.handleWheel),this.canvas.removeEventListener(`contextmenu`,this.handleContextMenu)}markInteracted(){this.interacted||(this.interacted=!0,this.onFirstInteraction?.())}handleKeyDown=e=>{let t=e.target;t instanceof HTMLElement&&t.closest(`input, button, select, textarea, [contenteditable="true"]`)||(e.code===`KeyW`||e.code===`KeyA`||e.code===`KeyS`||e.code===`KeyD`||e.code===`ShiftLeft`||e.code===`ShiftRight`||e.code===`Space`)&&(e.preventDefault(),this.pressed.add(e.code),e.code===`Space`&&!e.repeat&&(this.jumpQueued=!0),this.markInteracted())};handleKeyUp=e=>{this.pressed.delete(e.code)};handleBlur=()=>{this.pressed.clear(),this.jumpQueued=!1,this.clearTouchInput(),this.activePointer=null,document.body.classList.remove(`is-orbiting`)};handlePointerDown=e=>{e.pointerType!==`touch`&&(e.button===0||e.button===2)&&(this.activePointer=e.pointerId,this.lastPointer.set(e.clientX,e.clientY),this.canvas.setPointerCapture(e.pointerId),document.body.classList.add(`is-orbiting`),this.markInteracted())};handlePointerMove=e=>{e.pointerType!==`touch`&&e.pointerId===this.activePointer&&(this.orbitDelta.x+=e.clientX-this.lastPointer.x,this.orbitDelta.y+=e.clientY-this.lastPointer.y,this.lastPointer.set(e.clientX,e.clientY))};handlePointerUp=e=>{e.pointerType!==`touch`&&e.pointerId===this.activePointer&&(this.activePointer=null,document.body.classList.remove(`is-orbiting`),this.canvas.hasPointerCapture(e.pointerId)&&this.canvas.releasePointerCapture(e.pointerId))};handleWheel=e=>{e.preventDefault(),this.zoomDelta+=Math.sign(e.deltaY)*Math.min(1.5,Math.abs(e.deltaY)/120),this.markInteracted()};handleContextMenu=e=>{e.preventDefault()}},ao=.12,oo=72,so={orbitX:0,orbitY:0,zoom:0};function co(e,t,n,r,i){let a=Math.max(1,i),o=e-n,s=t-r,c=Math.hypot(o,s);if(c<1e-6)return{horizontal:0,forward:0,visualX:0,visualY:0};let l=o/c,u=s/c,d=Math.min(1,c/a),f=d<=ao?0:(d-ao)/.88,p=Math.min(c,a);return{horizontal:f===0?0:l*f,forward:f===0?0:-u*f,visualX:l*p,visualY:u*p}}function lo(e,t){return e>0||t}var uo=class{points=new Map;start(e,t,n){return!this.points.has(e)&&this.points.size>=2?!1:(this.points.set(e,{x:t,y:n}),!0)}move(e,t,n){let r=this.points.get(e);if(!r)return so;if(this.points.size===1){let e=t-r.x,i=n-r.y;return r.x=t,r.y=n,{orbitX:e,orbitY:i,zoom:0}}let i=this.getPinchDistance();r.x=t,r.y=n;let a=this.getPinchDistance();return{orbitX:0,orbitY:0,zoom:i===null||a===null?0:(i-a)/oo}}end(e){this.points.delete(e)}clear(){this.points.clear()}get pointerCount(){return this.points.size}getPinchDistance(){let e,t;for(let n of this.points.values())if(!e)e=n;else{t=n;break}return e&&t?Math.hypot(t.x-e.x,t.y-e.y):null}};function fo(e){let t=document.querySelector(e);if(!t)throw Error(`Mobile control element is missing: ${e}`);return t}function po(e){return e.pointerType===`touch`}var mo=class{canvas;input;root=fo(`[data-mobile-controls]`);stick=fo(`[data-touch-move]`);stickThumb=fo(`[data-touch-move-thumb]`);runButton=fo(`[data-touch-run]`);jumpButton=fo(`[data-touch-jump]`);coarsePointer=window.matchMedia(`(any-pointer: coarse)`);gesture=new uo;movementPointer=null;runPointer=null;jumpPointer=null;active=!1;constructor(e,t){this.canvas=e,this.input=t,this.stick.addEventListener(`pointerdown`,this.handleMoveStart),this.stick.addEventListener(`pointermove`,this.handleMove),this.stick.addEventListener(`pointerup`,this.handleMoveEnd),this.stick.addEventListener(`pointercancel`,this.handleMoveEnd),this.stick.addEventListener(`lostpointercapture`,this.handleMoveEnd),this.runButton.addEventListener(`pointerdown`,this.handleRunStart),this.runButton.addEventListener(`pointerup`,this.handleRunEnd),this.runButton.addEventListener(`pointercancel`,this.handleRunEnd),this.runButton.addEventListener(`lostpointercapture`,this.handleRunEnd),this.jumpButton.addEventListener(`pointerdown`,this.handleJumpStart),this.jumpButton.addEventListener(`pointerup`,this.handleJumpEnd),this.jumpButton.addEventListener(`pointercancel`,this.handleJumpEnd),this.jumpButton.addEventListener(`lostpointercapture`,this.handleJumpEnd),this.canvas.addEventListener(`pointerdown`,this.handleGestureStart),this.canvas.addEventListener(`pointermove`,this.handleGestureMove),this.canvas.addEventListener(`pointerup`,this.handleGestureEnd),this.canvas.addEventListener(`pointercancel`,this.handleGestureEnd),this.canvas.addEventListener(`lostpointercapture`,this.handleGestureEnd),window.addEventListener(`blur`,this.handleReset),window.addEventListener(`orientationchange`,this.handleReset),document.addEventListener(`visibilitychange`,this.handleVisibilityChange),this.coarsePointer.addEventListener(`change`,this.handleCapabilityChange),lo(navigator.maxTouchPoints,this.coarsePointer.matches)&&this.activate()}dispose(){this.reset(),this.stick.removeEventListener(`pointerdown`,this.handleMoveStart),this.stick.removeEventListener(`pointermove`,this.handleMove),this.stick.removeEventListener(`pointerup`,this.handleMoveEnd),this.stick.removeEventListener(`pointercancel`,this.handleMoveEnd),this.stick.removeEventListener(`lostpointercapture`,this.handleMoveEnd),this.runButton.removeEventListener(`pointerdown`,this.handleRunStart),this.runButton.removeEventListener(`pointerup`,this.handleRunEnd),this.runButton.removeEventListener(`pointercancel`,this.handleRunEnd),this.runButton.removeEventListener(`lostpointercapture`,this.handleRunEnd),this.jumpButton.removeEventListener(`pointerdown`,this.handleJumpStart),this.jumpButton.removeEventListener(`pointerup`,this.handleJumpEnd),this.jumpButton.removeEventListener(`pointercancel`,this.handleJumpEnd),this.jumpButton.removeEventListener(`lostpointercapture`,this.handleJumpEnd),this.canvas.removeEventListener(`pointerdown`,this.handleGestureStart),this.canvas.removeEventListener(`pointermove`,this.handleGestureMove),this.canvas.removeEventListener(`pointerup`,this.handleGestureEnd),this.canvas.removeEventListener(`pointercancel`,this.handleGestureEnd),this.canvas.removeEventListener(`lostpointercapture`,this.handleGestureEnd),window.removeEventListener(`blur`,this.handleReset),window.removeEventListener(`orientationchange`,this.handleReset),document.removeEventListener(`visibilitychange`,this.handleVisibilityChange),this.coarsePointer.removeEventListener(`change`,this.handleCapabilityChange),document.body.classList.remove(`has-touch-controls`,`is-touch-orbiting`),this.root.setAttribute(`aria-hidden`,`true`)}activate(){if(this.active)return;this.active=!0,document.body.classList.add(`has-touch-controls`),this.root.setAttribute(`aria-hidden`,`false`);let e=document.querySelector(`[data-onboarding-prompt]`),t=document.querySelector(`[data-onboarding-action]`);e&&(e.textContent=`Touch and drag anywhere`),t&&(t.textContent=`SWIPE TO LOOK AROUND`)}reset(){this.movementPointer=null,this.runPointer=null,this.jumpPointer=null,this.gesture.clear(),this.input.clearTouchInput(),this.stick.classList.remove(`is-active`),this.runButton.classList.remove(`is-active`),this.jumpButton.classList.remove(`is-active`),this.runButton.setAttribute(`aria-pressed`,`false`),this.stickThumb.style.setProperty(`--touch-x`,`0px`),this.stickThumb.style.setProperty(`--touch-y`,`0px`),this.stick.setAttribute(`aria-valuetext`,`Centered`),document.body.classList.remove(`is-touch-orbiting`)}updateMovement(e){let t=this.stick.getBoundingClientRect(),n=Math.min(t.width,t.height)*.36,r=co(e.clientX,e.clientY,t.left+t.width*.5,t.top+t.height*.5,n);this.stickThumb.style.setProperty(`--touch-x`,`${r.visualX.toFixed(2)}px`),this.stickThumb.style.setProperty(`--touch-y`,`${r.visualY.toFixed(2)}px`),this.stick.setAttribute(`aria-valuetext`,`Horizontal ${r.horizontal.toFixed(2)}, forward ${r.forward.toFixed(2)}`),this.input.setTouchMovement(r.horizontal,r.forward)}capturePointer(e,t){try{e.setPointerCapture(t)}catch{}}releasePointer(e,t){try{e.hasPointerCapture(t)&&e.releasePointerCapture(t)}catch{}}handleMoveStart=e=>{!po(e)||this.movementPointer!==null||(e.preventDefault(),this.activate(),this.movementPointer=e.pointerId,this.capturePointer(this.stick,e.pointerId),this.stick.classList.add(`is-active`),this.updateMovement(e))};handleMove=e=>{e.pointerId===this.movementPointer&&(e.preventDefault(),this.updateMovement(e))};handleMoveEnd=e=>{e.pointerId===this.movementPointer&&(e.preventDefault(),this.releasePointer(this.stick,e.pointerId),this.movementPointer=null,this.input.clearTouchMovement(),this.stick.classList.remove(`is-active`),this.stickThumb.style.setProperty(`--touch-x`,`0px`),this.stickThumb.style.setProperty(`--touch-y`,`0px`),this.stick.setAttribute(`aria-valuetext`,`Centered`))};handleRunStart=e=>{!po(e)||this.runPointer!==null||(e.preventDefault(),this.activate(),this.runPointer=e.pointerId,this.capturePointer(this.runButton,e.pointerId),this.runButton.classList.add(`is-active`),this.runButton.setAttribute(`aria-pressed`,`true`),this.input.setTouchRunning(!0))};handleRunEnd=e=>{e.pointerId===this.runPointer&&(e.preventDefault(),this.releasePointer(this.runButton,e.pointerId),this.runPointer=null,this.runButton.classList.remove(`is-active`),this.runButton.setAttribute(`aria-pressed`,`false`),this.input.setTouchRunning(!1))};handleJumpStart=e=>{!po(e)||this.jumpPointer!==null||(e.preventDefault(),this.activate(),this.jumpPointer=e.pointerId,this.capturePointer(this.jumpButton,e.pointerId),this.jumpButton.classList.add(`is-active`),this.input.queueTouchJump())};handleJumpEnd=e=>{e.pointerId===this.jumpPointer&&(e.preventDefault(),this.releasePointer(this.jumpButton,e.pointerId),this.jumpPointer=null,this.jumpButton.classList.remove(`is-active`))};handleGestureStart=e=>{!po(e)||!this.gesture.start(e.pointerId,e.clientX,e.clientY)||(e.preventDefault(),this.activate(),this.capturePointer(this.canvas,e.pointerId),document.body.classList.add(`is-touch-orbiting`))};handleGestureMove=e=>{if(!po(e))return;let t=this.gesture.move(e.pointerId,e.clientX,e.clientY);(t.orbitX!==0||t.orbitY!==0||t.zoom!==0)&&(e.preventDefault(),this.input.addTouchOrbitDelta(t.orbitX,t.orbitY),this.input.addTouchZoomDelta(t.zoom))};handleGestureEnd=e=>{po(e)&&(this.releasePointer(this.canvas,e.pointerId),this.gesture.end(e.pointerId),this.gesture.pointerCount===0&&document.body.classList.remove(`is-touch-orbiting`))};handleReset=()=>{this.reset()};handleVisibilityChange=()=>{document.hidden&&this.reset()};handleCapabilityChange=e=>{e.matches&&this.activate()}},ho=class extends fe{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new ve;e.deleteAttribute(`uv`);let t=new f({side:1}),n=new f,r=new ie(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new N(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new me(e,n,6),o=new E;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new N(e,go(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new N(e,go(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new N(e,go(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new N(e,go(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new N(e,go(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let p=new N(e,go(100));p.position.set(0,20,0),p.scale.set(1,.1,1),this.add(p)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function go(e){return new at({color:0,emissive:16777215,emissiveIntensity:e})}var _o=class{group=new h;rimLight;capeFill;target=new E;environmentTarget;rimOffset=new I(-2.8,4.7,3.2);targetOffset=new I(0,1.05,0);fillOffset=new I(0,1.4,.85);constructor(e,t){this.group.name=`Cinematic fill lighting`;let n=new pe(7904401,1510409,.36),r=new ze(5272942,.15);this.rimLight=new Ke(7523775,13,15,.63,.9,1.5),this.rimLight.target=this.target,this.capeFill=new ie(13187883,2.8,4.5,2),this.group.add(n,r,this.rimLight,this.target,this.capeFill);let i=new Xt(t),a=new ho;this.environmentTarget=i.fromScene(a,.06),e.environment=this.environmentTarget.texture,e.environmentIntensity=.24,a.dispose(),i.dispose()}update(e,t){this.rimLight.position.copy(e).add(this.rimOffset),this.target.position.copy(e).add(this.targetOffset),this.capeFill.position.copy(e).add(this.fillOffset),this.capeFill.intensity=2.6+Math.sin(t*1.7)*.18}dispose(){this.environmentTarget.dispose()}};function vo(e){return e.shape===`convex-rock`}function yo(e){return e.clearance??.026}function bo(e){return(e.depthRadius??e.radius)+yo(e)}var xo=class{positions;previous;inverseMass;columns;rows;triangle=new Xe;closestPoint=new I;barycentric=new I;capsuleAxis=new I;sampleCenter=new I;delta=new I;boundsMinimum=new I;boundsMaximum=new I;motion=new I;rowMinimumY;rowMaximumY;constructor(e,t,n,r,i){this.positions=e,this.previous=t,this.inverseMass=n,this.columns=r,this.rows=i,this.rowMinimumY=new Float32Array(i),this.rowMaximumY=new Float32Array(i)}solve(e,t){this.updateBounds(),this.forEachCapsuleSample(e,(e,n,r)=>{let i=Math.max(n,r);this.intersectsBounds(e,i)&&this.forEachTriangle(e.y,i,(i,a,o)=>{this.solveTriangle(i,a,o,e,n,r,t)})})}getMaximumPenetration(e,t){this.updateBounds();let n=0;return this.forEachCapsuleSample(e,(e,r,i)=>{let a=Math.max(r,i);this.intersectsBounds(e,a)&&this.forEachTriangle(e.y,a,(a,o,s)=>{n=Math.max(n,this.getTrianglePenetration(a,o,s,e,r,i,t))})}),n}solveTriangle(e,t,n,r,i,a,o){let s=this.positions[e],c=this.positions[t],l=this.positions[n];if(!s||!c||!l)return;let u=Math.max(i,a);if(!this.intersectsTriangleBounds(s,c,l,r,u))return;this.triangle.set(s,c,l),this.triangle.closestPointToPoint(r,this.closestPoint);let d=this.oneSidedPenetration(this.closestPoint,r,i,a,o);if(d<=0||this.triangle.getBarycoord(this.closestPoint,this.barycentric)===null)return;let f=this.inverseMass[e]??0,p=this.inverseMass[t]??0,m=this.inverseMass[n]??0,h=f*this.barycentric.x*this.barycentric.x+p*this.barycentric.y*this.barycentric.y+m*this.barycentric.z*this.barycentric.z;if(h<1e-6)return;let g=d/h;this.applyCorrection(e,f*this.barycentric.x*g,o),this.applyCorrection(t,p*this.barycentric.y*g,o),this.applyCorrection(n,m*this.barycentric.z*g,o)}getTrianglePenetration(e,t,n,r,i,a,o){let s=this.positions[e],c=this.positions[t],l=this.positions[n];if(!s||!c||!l)return 0;let u=Math.max(i,a);return this.intersectsTriangleBounds(s,c,l,r,u)?(this.triangle.set(s,c,l),this.triangle.closestPointToPoint(r,this.closestPoint),this.oneSidedPenetration(this.closestPoint,r,i,a,o)):0}oneSidedPenetration(e,t,n,r,i){this.delta.copy(e).sub(t);let a=this.delta.dot(i),o=Math.max(0,this.delta.lengthSq()-a*a);if(o>=n*n)return 0;let s=o/(n*n),c=r*Math.sqrt(1-s);return Math.max(0,c-a)}forEachCapsuleSample(e,t){for(let n of e){this.capsuleAxis.copy(n.end).sub(n.start);let e=this.capsuleAxis.length(),r=yo(n),i=n.radius+r,a=bo(n),o=n.faceSampleSpacing??Math.max(.04,i*.82),s=e<1e-6?0:Math.max(1,Math.ceil(e/o)),c=s>0?e/s:0,l=Math.hypot(i,c*.5),u=a*l/i;for(let e=0;e<=s;e+=1){let r=s>0?e/s:0;this.sampleCenter.lerpVectors(n.start,n.end,r),t(this.sampleCenter,l,u)}}}forEachTriangle(e,t,n){for(let r=0;r<this.rows-1;r+=1){let i=Math.min(this.rowMinimumY[r],this.rowMinimumY[r+1]),a=Math.max(this.rowMaximumY[r],this.rowMaximumY[r+1]);if(!(e+t<i||e-t>a))for(let e=0;e<this.columns-1;e+=1){let t=this.index(e,r),i=this.index(e,r+1);n(t,i,t+1),n(i,i+1,t+1)}}}applyCorrection(e,t,n){if(t<=0)return;let r=this.positions[e],i=this.previous[e];if(!r||!i)return;r.addScaledVector(n,t),i.addScaledVector(n,t);let a=this.motion.copy(r).sub(i).dot(n);a<0&&i.addScaledVector(n,a)}updateBounds(){this.boundsMinimum.set(1/0,1/0,1/0),this.boundsMaximum.set(-1/0,-1/0,-1/0),this.rowMinimumY.fill(1/0),this.rowMaximumY.fill(-1/0);for(let e=0;e<this.positions.length;e+=1){let t=this.positions[e];if(!t)continue;this.boundsMinimum.min(t),this.boundsMaximum.max(t);let n=Math.floor(e/this.columns);this.rowMinimumY[n]=Math.min(this.rowMinimumY[n],t.y),this.rowMaximumY[n]=Math.max(this.rowMaximumY[n],t.y)}}intersectsBounds(e,t){return e.x+t>=this.boundsMinimum.x&&e.x-t<=this.boundsMaximum.x&&e.y+t>=this.boundsMinimum.y&&e.y-t<=this.boundsMaximum.y&&e.z+t>=this.boundsMinimum.z&&e.z-t<=this.boundsMaximum.z}intersectsTriangleBounds(e,t,n,r,i){return r.x+i>=Math.min(e.x,t.x,n.x)&&r.x-i<=Math.max(e.x,t.x,n.x)&&r.y+i>=Math.min(e.y,t.y,n.y)&&r.y-i<=Math.max(e.y,t.y,n.y)&&r.z+i>=Math.min(e.z,t.z,n.z)&&r.z-i<=Math.max(e.z,t.z,n.z)}index(e,t){return t*this.columns+e}},So=1e-5,Co=1e-5,wo=[`x`,`y`,`z`];function To(e,t){return e.walkable&&t<=e.bounds.min.y+(e.bounds.max.y-e.bounds.min.y)*.72}function Eo(e,t,n){let r=e.getAttribute(`position`);if(!r)throw Error(`Rock collision geometry has no positions.`);e.boundingSphere||e.computeBoundingSphere();let i=e.boundingSphere;if(!i)throw Error(`Rock collision geometry has no bounding sphere.`);let a=i.center.clone().applyMatrix4(t),o=[],s=new Map,c=e.index,l=(c?.count??r.count)/3,u=new I,d=e=>{let n=c?.getX(e)??e;return u.fromBufferAttribute(r,n).clone().applyMatrix4(t)},f=e=>`${e.x.toFixed(6)}:${e.y.toFixed(6)}:${e.z.toFixed(6)}`;for(let e=0;e<l;e+=1){let t=e*3,n=d(t),r=d(t+1),i=d(t+2),c=new Xe(n,r,i),l=c.getNormal(new I),u=c.getMidpoint(new I);if(l.dot(u.sub(a))<0&&l.negate(),!(l.lengthSq()<.5)){o.push({triangle:c,normal:l,planeConstant:l.dot(n),bounds:new Ne().setFromPoints([n,r,i])});for(let e of[n,r,i]){let t=f(e);s.has(t)||s.set(t,e.clone())}}}if(o.length===0)throw Error(`Rock collision geometry has no valid faces.`);let p=[...s.values()],m=new Ne().setFromPoints(p),h=0;for(let e of p)h=Math.max(h,e.distanceTo(a));return{center:a,radius:h,walkable:n,kind:`rock`,shape:`convex-rock`,bounds:m,faces:o}}var Do=class{closestSurface=new I;candidate=new I;delta=new I;intersectsExpandedBounds(e,t,n,r){let i=0,a=1;for(let o of wo){let s=e.bounds.min[o]-r,c=e.bounds.max[o]+r,l=t[o],u=n[o]-l;if(Math.abs(u)<So){if(l<s||l>c)return!1;continue}let d=(s-l)/u,f=(c-l)/u;if(d>f){let e=d;d=f,f=e}if(i=Math.max(i,d),a=Math.min(a,f),i>a)return!1}return a>=0&&i<=1}getSignedDistance(e,t,n){let r=!0,i=1/0,a;for(let n of e.faces){n.normal.dot(t)-n.planeConstant>So&&(r=!1),n.triangle.closestPointToPoint(t,this.candidate);let e=this.candidate.distanceToSquared(t);e>=i||(i=e,a=n,this.closestSurface.copy(this.candidate))}let o=Math.sqrt(i);return o>So?n.copy(r?this.closestSurface:t).sub(r?t:this.closestSurface).multiplyScalar(1/o):a?n.copy(a.normal):(n.copy(t).sub(e.center),n.lengthSq()<So?n.set(0,1,0):n.normalize()),r?-o:o}getSupportHeight(e,t,n){if(t<e.bounds.min.x-Co||t>e.bounds.max.x+Co||n<e.bounds.min.z-Co||n>e.bounds.max.z+Co)return null;let r=-1/0;for(let i of e.faces){if(i.normal.y<=Co)continue;let{a:e,b:a,c:o}=i.triangle;if(t<i.bounds.min.x-Co||t>i.bounds.max.x+Co||n<i.bounds.min.z-Co||n>i.bounds.max.z+Co)continue;let s=a.x-e.x,c=a.z-e.z,l=o.x-e.x,u=o.z-e.z,d=t-e.x,f=n-e.z,p=s*u-l*c;if(Math.abs(p)<Co)continue;let m=(d*u-l*f)/p,h=(s*f-d*c)/p;if(m<-1e-5||h<-1e-5||m+h>1.00001)continue;let g=e.y+m*(a.y-e.y)+h*(o.y-e.y);r=Math.max(r,g)}return Number.isFinite(r)?r:null}sweep(e,t,n,r,i){if(!this.intersectsExpandedBounds(e,t,n,r))return null;let a=0,o=1,s,c=!0;for(let i of e.faces){let e=i.planeConstant+r,l=i.normal.dot(t)-e,u=i.normal.dot(n)-e;if(l>0&&(c=!1),l>0&&u>0)return null;if(l<=0&&u<=0)continue;let d=l/(l-u);if(l>u?d>a&&(a=d,s=i):o=Math.min(o,d),a>o)return null}return c||!s||a<0||a>1?null:(i.copy(s.normal),a)}getPlanarSeparation(e,t,n,r){let i=n-this.getSignedDistance(e,t,this.delta);if(i<=0)return 0;r.set(this.delta.x,this.delta.z);let a=r.length();return a<So?(r.set(t.x-e.center.x,t.z-e.center.z),r.lengthSq()<So&&r.set(1,0),r.normalize()):r.multiplyScalar(1/a),i}},Oo=1e-6,ko=1e-5,Ao=class{firstDirection=new I;secondDirection=new I;segmentOffset=new I;segmentDirection=new I;triangleFirstEdge=new I;triangleSecondEdge=new I;determinantVector=new I;vertexOffset=new I;barycentricVector=new I;candidateFirst=new I;candidateSecond=new I;intersectAtPoint(e,t,n,r,i,a){return this.intersectSegmentTriangle(e.a,e.b,t,i)||this.intersectSegmentTriangle(e.b,e.c,t,i)||this.intersectSegmentTriangle(e.c,e.a,t,i)?(a.copy(n),2):this.intersectSegmentTriangle(t.a,t.b,e,i)||this.intersectSegmentTriangle(t.b,t.c,e,i)||this.intersectSegmentTriangle(t.c,t.a,e,i)?(e.getNormal(a),a.dot(r)<0&&a.negate(),a.lengthSq()<Oo&&a.copy(n),1):0}closestPoints(e,t,n,r){let i=1/0,a=(e,t)=>{let a=e.distanceToSquared(t);a>=i||(i=a,n.copy(e),r.copy(t))};t.closestPointToPoint(e.a,this.candidateSecond),a(e.a,this.candidateSecond),t.closestPointToPoint(e.b,this.candidateSecond),a(e.b,this.candidateSecond),t.closestPointToPoint(e.c,this.candidateSecond),a(e.c,this.candidateSecond),e.closestPointToPoint(t.a,this.candidateFirst),a(this.candidateFirst,t.a),e.closestPointToPoint(t.b,this.candidateFirst),a(this.candidateFirst,t.b),e.closestPointToPoint(t.c,this.candidateFirst),a(this.candidateFirst,t.c);let o=(e,t,n,r)=>{this.closestSegmentPoints(e,t,n,r,this.candidateFirst,this.candidateSecond),a(this.candidateFirst,this.candidateSecond)};return o(e.a,e.b,t.a,t.b),o(e.a,e.b,t.b,t.c),o(e.a,e.b,t.c,t.a),o(e.b,e.c,t.a,t.b),o(e.b,e.c,t.b,t.c),o(e.b,e.c,t.c,t.a),o(e.c,e.a,t.a,t.b),o(e.c,e.a,t.b,t.c),o(e.c,e.a,t.c,t.a),i}intersectSegmentTriangle(e,t,n,r){this.segmentDirection.copy(t).sub(e),this.triangleFirstEdge.copy(n.b).sub(n.a),this.triangleSecondEdge.copy(n.c).sub(n.a),this.determinantVector.copy(this.segmentDirection).cross(this.triangleSecondEdge);let i=this.triangleFirstEdge.dot(this.determinantVector);if(Math.abs(i)<=ko)return!1;let a=1/i;this.vertexOffset.copy(e).sub(n.a);let o=this.vertexOffset.dot(this.determinantVector)*a;if(o<-1e-5||o>1.00001)return!1;this.barycentricVector.copy(this.vertexOffset).cross(this.triangleFirstEdge);let s=this.segmentDirection.dot(this.barycentricVector)*a;if(s<-1e-5||o+s>1.00001)return!1;let c=this.triangleSecondEdge.dot(this.barycentricVector)*a;return c<-1e-5||c>1.00001?!1:(r.copy(e).addScaledVector(this.segmentDirection,G.clamp(c,0,1)),!0)}closestSegmentPoints(e,t,n,r,i,a){this.firstDirection.copy(t).sub(e),this.secondDirection.copy(r).sub(n),this.segmentOffset.copy(e).sub(n);let o=this.firstDirection.lengthSq(),s=this.secondDirection.lengthSq(),c=this.secondDirection.dot(this.segmentOffset),l=0,u=0;if(o<=Oo&&s<=Oo){i.copy(e),a.copy(n);return}if(o<=Oo)u=G.clamp(c/s,0,1);else{let e=this.firstDirection.dot(this.segmentOffset);if(s<=Oo)l=G.clamp(-e/o,0,1);else{let t=this.firstDirection.dot(this.secondDirection),n=o*s-t*t;Math.abs(n)>Oo&&(l=G.clamp((t*c-e*s)/n,0,1)),u=(t*l+c)/s,u<0?(u=0,l=G.clamp(-e/o,0,1)):u>1&&(u=1,l=G.clamp((t-e)/o,0,1))}}i.copy(e).addScaledVector(this.firstDirection,l),a.copy(n).addScaledVector(this.secondDirection,u)}},jo=1e-6,Mo=1.5,No=4,Po=10,Fo=class{positions;previous;inverseMass;columns;rows;clearance;clothTriangle=new Xe;previousTriangle=new Xe;clothPoint=new I;candidateCloth=new I;candidateRock=new I;barycentric=new I;normal=new I;boundsMinimum=new I;boundsMaximum=new I;clothBounds=new Ne;previousBounds=new Ne;vertexNormal=new I;previousCentroid=new I;referenceDirection=new I;candidateContactNormal=new I;intersectionNormal=new I;intersectionSeparation=0;motion=new I;rockQuery=new Do;triangleQuery=new Ao;faceCorrectionUsed;sweptFaceRecoveryPending=!0;constructor(e,t,n,r,i,a){this.positions=e,this.previous=t,this.inverseMass=n,this.columns=r,this.rows=i,this.clearance=a,this.faceCorrectionUsed=new Float32Array(n.length)}beginStep(){this.sweptFaceRecoveryPending=!0,this.beginPass()}beginPass(){this.faceCorrectionUsed.fill(0)}solve(e,t){let n=this.sweptFaceRecoveryPending;this.sweptFaceRecoveryPending=!1,this.updateBounds();let r=0;for(let i of e){if(!this.intersectsColliderBounds(i))continue;let e=0;this.forEachTriangle((t,r,a)=>{e+=this.solveTriangle(t,r,a,i,n)}),r+=e,e>0&&t&&!t.includes(i)&&t.push(i)}return r}getMaximumPenetration(e){return this.getMaximumPenetrationDiagnostics(e).maximum}getMaximumPenetrationDiagnostics(e){this.updateBounds();let t=0,n=null,r=null,i=null,a=null;for(let o of e)this.intersectsColliderBounds(o)&&this.forEachTriangle((e,s,c)=>{let l=this.getTrianglePenetration(e,s,c,o);l<=t||(t=l,n=[e,s,c],r=[e,s,c].map(e=>{let t=this.positions[e]??new I;return[t.x,t.y,t.z]}),i=[e,s,c].map(e=>{let t=this.previous[e]??new I;return[t.x,t.y,t.z]}),a=[o.center.x,o.center.y,o.center.z])});return{maximum:t,triangle:n,positions:r,previous:i,rockCenter:a}}getClosestSurfaceContact(e){this.updateBounds();let t=e.map(e=>({collider:e,lowerBoundSquared:this.getBoundsDistanceSquared(this.boundsMinimum,this.boundsMaximum,e.bounds.min,e.bounds.max)})).sort((e,t)=>e.lowerBoundSquared-t.lowerBoundSquared),n=1/0,r;for(let e of t){if(e.lowerBoundSquared>n)break;let{collider:t}=e;this.forEachTriangle((e,i,a)=>{let o=this.positions[e],s=this.positions[i],c=this.positions[a];if(!(!o||!s||!c)){this.clothTriangle.set(o,s,c),this.clothBounds.makeEmpty(),this.clothBounds.expandByPoint(o),this.clothBounds.expandByPoint(s),this.clothBounds.expandByPoint(c);for(let e of t.faces){if(this.getBoundsDistanceSquared(this.clothBounds.min,this.clothBounds.max,e.bounds.min,e.bounds.max)>n)continue;let i=this.triangleQuery.closestPoints(this.clothTriangle,e.triangle,this.candidateCloth,this.candidateRock);i>=n||(n=i,r=t)}}})}return r&&Number.isFinite(n)?{distance:Math.sqrt(n),collider:r}:null}getBoundsDistanceSquared(e,t,n,r){let i=Math.max(0,n.x-t.x,e.x-r.x),a=Math.max(0,n.y-t.y,e.y-r.y),o=Math.max(0,n.z-t.z,e.z-r.z);return i*i+a*a+o*o}solveTriangle(e,t,n,r,i){let a=this.findTrianglePenetration(e,t,n,r,!0);if(a<=0)return i&&this.sweptTriangleIntersectsCollider(e,t,n,r)&&this.restorePreviousTriangle(e,t,n,r)?1:0;if(this.clothTriangle.getBarycoord(this.clothPoint,this.barycentric)===null)return 0;if(this.restorePreviousTriangle(e,t,n,r))return 1;(To(r,this.clothPoint.y)||this.normal.y<0&&this.clothPoint.y<=r.bounds.min.y+this.clearance*2)&&(this.normal.set(this.clothPoint.x-r.center.x,0,this.clothPoint.z-r.center.z),this.normal.lengthSq()<jo?this.normal.set(1,0,0):this.normal.normalize());for(let r of[e,t,n])(this.inverseMass[r]??0)>0&&this.applyCorrection(r,a);return 1}getTrianglePenetration(e,t,n,r){let i=this.findTrianglePenetration(e,t,n,r,!1);return Math.max(0,i)}restorePreviousTriangle(e,t,n,r){let i=this.previous[e],a=this.previous[t],o=this.previous[n];if(!i||!a||!o||this.rockQuery.getSignedDistance(r,i,this.vertexNormal)<0||this.rockQuery.getSignedDistance(r,a,this.vertexNormal)<0||this.rockQuery.getSignedDistance(r,o,this.vertexNormal)<0||(this.previousTriangle.set(i,a,o),this.triangleIntersectsCollider(this.previousTriangle,r)))return!1;let s=!1;for(let r of[e,t,n]){if((this.inverseMass[r]??0)<=0)continue;let e=this.positions[r],t=this.previous[r];!e||!t||(e.copy(t),s=!0)}return s}sweptTriangleIntersectsCollider(e,t,n,r){let i=this.positions[e],a=this.positions[t],o=this.positions[n],s=this.previous[e],c=this.previous[t],l=this.previous[n];if(!i||!a||!o||!s||!c||!l||(this.previousBounds.makeEmpty(),this.previousBounds.expandByPoint(i),this.previousBounds.expandByPoint(a),this.previousBounds.expandByPoint(o),this.previousBounds.expandByPoint(s),this.previousBounds.expandByPoint(c),this.previousBounds.expandByPoint(l),!this.previousBounds.intersectsBox(r.bounds)))return!1;for(let e=1;e<No;e+=1){let t=e/No;if(this.previousTriangle.set(this.candidateCloth.lerpVectors(s,i,t),this.candidateRock.lerpVectors(c,a,t),this.motion.lerpVectors(l,o,t)),this.triangleIntersectsCollider(this.previousTriangle,r))return!0}return!1}triangleIntersectsCollider(e,t){if(this.previousBounds.setFromPoints([e.a,e.b,e.c]),!this.previousBounds.intersectsBox(t.bounds))return!1;e.getMidpoint(this.referenceDirection).sub(t.center),this.referenceDirection.lengthSq()<jo?e.getNormal(this.referenceDirection):this.referenceDirection.normalize();for(let n of t.faces)if(this.previousBounds.intersectsBox(n.bounds)&&this.triangleQuery.intersectAtPoint(e,n.triangle,n.normal,this.referenceDirection,this.candidateCloth,this.candidateContactNormal)>0)return!0;return!1}findTrianglePenetration(e,t,n,r,i){let a=this.positions[e],o=this.positions[t],s=this.positions[n];if(!a||!o||!s||(this.clothTriangle.set(a,o,s),this.clothBounds.setFromPoints([a,o,s]).expandByScalar(this.clearance),!this.clothBounds.intersectsBox(r.bounds)))return 0;let c=this.previous[e]??a,l=this.previous[t]??o,u=this.previous[n]??s;this.previousCentroid.copy(c).add(l).add(u).multiplyScalar(1/3),this.referenceDirection.copy(this.previousCentroid).sub(r.center),this.referenceDirection.lengthSq()<jo&&this.clothTriangle.getMidpoint(this.referenceDirection).sub(r.center),this.referenceDirection.lengthSq()<jo?this.clothTriangle.getNormal(this.referenceDirection):this.referenceDirection.normalize();let d=0,f=-1/0,p=1/0;for(let e of r.faces){if(!this.clothBounds.intersectsBox(e.bounds))continue;let t=this.triangleQuery.intersectAtPoint(this.clothTriangle,e.triangle,e.normal,this.referenceDirection,this.candidateCloth,this.candidateContactNormal);if(t>0){let n=this.candidateContactNormal.dot(this.referenceDirection),r=t===2?this.clearance-Math.min(e.normal.dot(a)-e.planeConstant,e.normal.dot(o)-e.planeConstant,e.normal.dot(s)-e.planeConstant):this.clearance*Mo;(t>d||t===d&&(r<p||Math.abs(r-p)<jo&&n>f))&&(d=t,f=n,p=r,this.intersectionNormal.copy(this.candidateContactNormal),this.intersectionSeparation=r,this.clothPoint.copy(this.candidateCloth))}}return d>0?(this.normal.copy(this.intersectionNormal),i?Math.max(this.clearance*Mo,this.intersectionSeparation):this.clearance):0}applyCorrection(e,t){if(t<=0)return;let n=Math.max(0,this.clearance*Po-(this.faceCorrectionUsed[e]??0)),r=Math.min(t,n);if(r<=0)return;let i=this.positions[e],a=this.previous[e];if(!i||!a)return;i.addScaledVector(this.normal,r),a.addScaledVector(this.normal,r);let o=this.motion.copy(i).sub(a).dot(this.normal);o<0&&a.addScaledVector(this.normal,o),this.faceCorrectionUsed[e]=(this.faceCorrectionUsed[e]??0)+r}forEachTriangle(e){for(let t=0;t<this.rows-1;t+=1)for(let n=0;n<this.columns-1;n+=1){let r=t*this.columns+n,i=r+this.columns;e(r,i,r+1),e(i,i+1,r+1)}}updateBounds(){this.boundsMinimum.set(1/0,1/0,1/0),this.boundsMaximum.set(-1/0,-1/0,-1/0);for(let e=0;e<this.positions.length;e+=1){let t=this.positions[e],n=this.previous[e];t&&(this.boundsMinimum.min(t),this.boundsMaximum.max(t)),n&&(this.boundsMinimum.min(n),this.boundsMaximum.max(n))}}intersectsColliderBounds(e){return e.bounds.max.x+this.clearance>=this.boundsMinimum.x&&e.bounds.min.x-this.clearance<=this.boundsMaximum.x&&e.bounds.max.y+this.clearance>=this.boundsMinimum.y&&e.bounds.min.y-this.clearance<=this.boundsMaximum.y&&e.bounds.max.z+this.clearance>=this.boundsMinimum.z&&e.bounds.min.z-this.clearance<=this.boundsMaximum.z}},Io=.045;function Lo(e,t,n,r,i,a){let o=dt(e.x,e.z)+r;if(i.y>=0||e.y>o+Io)return null;let s=e.x-t.x,c=e.y-t.y,l=e.z-t.z,u=Math.hypot(s,l),d=Math.sqrt(Math.max(0,n*n-c*c));return i.set(s,0,l),u<1e-6?(i.set(a.x-t.x,0,a.z-t.z),i.lengthSq()<1e-6?i.set(1,0,0):i.normalize()):i.multiplyScalar(1/u),Math.max(0,d-u)}var Ro=.004,zo=.003,Bo=4;function Vo(e){return e.kind===`rock`?zo:Ro}var Ho=class{positions;previous;inverseMass;columns;rows;triangle=new Xe;previousTriangle=new Xe;closestPoint=new I;barycentric=new I;normal=new I;centroid=new I;boundsMinimum=new I;boundsMaximum=new I;motion=new I;sweptFaceRecoveryPending=!0;constructor(e,t,n,r,i){this.positions=e,this.previous=t,this.inverseMass=n,this.columns=r,this.rows=i}beginStep(){this.sweptFaceRecoveryPending=!0}solve(e,t){let n=this.sweptFaceRecoveryPending;this.sweptFaceRecoveryPending=!1,this.updateBounds();let r=0;for(let i of e){let e=i.radius+Vo(i);if(!this.intersectsBounds(i.center,e))continue;let a=0;for(let e=0;e<this.rows-1;e+=1)for(let t=0;t<this.columns-1;t+=1){let r=this.index(t,e),o=this.index(t,e+1);a+=this.solveTriangle(r,o,r+1,i,n),a+=this.solveTriangle(o,o+1,r+1,i,n)}r+=a,a>0&&t&&!t.includes(i)&&t.push(i)}return r}getMaximumPenetration(e){this.updateBounds();let t=0;for(let n of e){let e=n.radius+Vo(n);if(this.intersectsBounds(n.center,e))for(let r=0;r<this.rows-1;r+=1)for(let i=0;i<this.columns-1;i+=1){let a=this.index(i,r),o=this.index(i,r+1);t=Math.max(t,this.getTrianglePenetration(a,o,a+1,n.center,e),this.getTrianglePenetration(o,o+1,a+1,n.center,e))}}return t}solveTriangle(e,t,n,r,i){let a=this.positions[e],o=this.positions[t],s=this.positions[n];if(!a||!o||!s)return 0;let c=Vo(r),l=r.radius+c,u=this.previous[e],d=this.previous[t],f=this.previous[n],p=this.intersectsTriangleBounds(a,o,s,r.center,l),m=i&&u&&d&&f&&this.intersectsSweptTriangleBounds(a,o,s,u,d,f,r.center,l);if(!p&&!m)return 0;this.triangle.set(a,o,s),this.triangle.closestPointToPoint(r.center,this.closestPoint);let h=this.closestPoint.distanceToSquared(r.center);if(h>=l*l)return i&&u&&d&&f&&this.restoreSweptTriangle(e,t,n,u,d,f,r.center,l)?1:0;if(this.triangle.getBarycoord(this.closestPoint,this.barycentric)===null)return 0;let g=this.inverseMass[e]??0,_=this.inverseMass[t]??0,v=this.inverseMass[n]??0,y=g*this.barycentric.x*this.barycentric.x+_*this.barycentric.y*this.barycentric.y+v*this.barycentric.z*this.barycentric.z;if(y<1e-6)return 0;let b=Math.sqrt(h);this.normal.copy(this.closestPoint).sub(r.center),b>1e-6?this.normal.multiplyScalar(1/b):(this.triangle.getNormal(this.normal),this.triangle.getMidpoint(this.centroid),this.normal.dot(this.centroid.sub(r.center))<0&&this.normal.negate(),this.normal.lengthSq()<1e-6&&this.normal.set(0,1,0)),this.triangle.getMidpoint(this.centroid);let x=(Lo(this.closestPoint,r.center,l,c,this.normal,this.centroid)??l-b)/y;return this.applyCorrection(e,g*this.barycentric.x*x),this.applyCorrection(t,_*this.barycentric.y*x),this.applyCorrection(n,v*this.barycentric.z*x),1}getTrianglePenetration(e,t,n,r,i){let a=this.positions[e],o=this.positions[t],s=this.positions[n];return!a||!o||!s||!this.intersectsTriangleBounds(a,o,s,r,i)?0:(this.triangle.set(a,o,s),this.triangle.closestPointToPoint(r,this.closestPoint),Math.max(0,i-this.closestPoint.distanceTo(r)))}applyCorrection(e,t){if(t<=0)return;let n=this.positions[e],r=this.previous[e];if(!n||!r)return;n.addScaledVector(this.normal,t),r.addScaledVector(this.normal,t);let i=this.motion.copy(n).sub(r).dot(this.normal);i<0&&r.addScaledVector(this.normal,i)}updateBounds(){this.boundsMinimum.set(1/0,1/0,1/0),this.boundsMaximum.set(-1/0,-1/0,-1/0);for(let e=0;e<this.positions.length;e+=1){let t=this.positions[e],n=this.previous[e];t&&(this.boundsMinimum.min(t),this.boundsMaximum.max(t)),n&&(this.boundsMinimum.min(n),this.boundsMaximum.max(n))}}restoreSweptTriangle(e,t,n,r,i,a,o,s){if(this.previousTriangle.set(r,i,a),this.previousTriangle.closestPointToPoint(o,this.closestPoint),this.closestPoint.distanceToSquared(o)<s*s)return!1;let c=!1;for(let l=1;l<Bo;l+=1){let u=l/Bo;if(this.previousTriangle.set(this.normal.lerpVectors(r,this.positions[e],u),this.centroid.lerpVectors(i,this.positions[t],u),this.motion.lerpVectors(a,this.positions[n],u)),this.previousTriangle.closestPointToPoint(o,this.closestPoint),this.closestPoint.distanceToSquared(o)<s*s){c=!0;break}}if(!c)return!1;let l=!1;for(let r of[e,t,n]){if((this.inverseMass[r]??0)<=0)continue;let e=this.positions[r],t=this.previous[r];!e||!t||(e.copy(t),l=!0)}return l}intersectsBounds(e,t){return e.x+t>=this.boundsMinimum.x&&e.x-t<=this.boundsMaximum.x&&e.y+t>=this.boundsMinimum.y&&e.y-t<=this.boundsMaximum.y&&e.z+t>=this.boundsMinimum.z&&e.z-t<=this.boundsMaximum.z}intersectsTriangleBounds(e,t,n,r,i){return r.x+i>=Math.min(e.x,t.x,n.x)&&r.x-i<=Math.max(e.x,t.x,n.x)&&r.y+i>=Math.min(e.y,t.y,n.y)&&r.y-i<=Math.max(e.y,t.y,n.y)&&r.z+i>=Math.min(e.z,t.z,n.z)&&r.z-i<=Math.max(e.z,t.z,n.z)}intersectsSweptTriangleBounds(e,t,n,r,i,a,o,s){return o.x+s>=Math.min(e.x,t.x,n.x,r.x,i.x,a.x)&&o.x-s<=Math.max(e.x,t.x,n.x,r.x,i.x,a.x)&&o.y+s>=Math.min(e.y,t.y,n.y,r.y,i.y,a.y)&&o.y-s<=Math.max(e.y,t.y,n.y,r.y,i.y,a.y)&&o.z+s>=Math.min(e.z,t.z,n.z,r.z,i.z,a.z)&&o.z-s<=Math.max(e.z,t.z,n.z,r.z,i.z,a.z)}index(e,t){return t*this.columns+e}},Uo=1e-6,Wo=[{first:1/3,second:1/3,third:1/3},{first:1/2,second:1/2,third:0},{first:1/2,second:0,third:1/2},{first:0,second:1/2,third:1/2}],Go=class{positions;previous;inverseMass;columns;rows;nearBoundary;sample=new I;bounds={minimum:0,maximum:0};constructor(e,t,n,r,i,a){this.positions=e,this.previous=t,this.inverseMass=n,this.columns=r,this.rows=i,this.nearBoundary=a}solve(){let e=0;for(let t=0;t<this.rows-1;t+=1)for(let n=0;n<this.columns-1;n+=1){let r=this.index(n,t),i=this.index(n,t+1);this.isNearBoundary(r,i,r+1)&&(e+=this.solveTriangle(r,i,r+1)),this.isNearBoundary(i,i+1,r+1)&&(e+=this.solveTriangle(i,i+1,r+1))}return e}getMaximumPenetration(){let e=0;for(let t=0;t<this.rows-1;t+=1)for(let n=0;n<this.columns-1;n+=1){let r=this.index(n,t),i=this.index(n,t+1);e=Math.max(e,this.getTrianglePenetration(r,i,r+1),this.getTrianglePenetration(i,i+1,r+1))}return e}solveTriangle(e,t,n){let r=this.positions[e],i=this.positions[t],a=this.positions[n];if(!r||!i||!a)return 0;let o=0;for(let s of Wo){let c=this.getSampleCorrection(r,i,a,s);if(Math.abs(c)<=Uo)continue;let l=this.inverseMass[e]??0,u=this.inverseMass[t]??0,d=this.inverseMass[n]??0,f=l*s.first*s.first+u*s.second*s.second+d*s.third*s.third;if(f<=Uo)continue;let p=c/f;this.applyCorrection(e,l*s.first*p),this.applyCorrection(t,u*s.second*p),this.applyCorrection(n,d*s.third*p),o+=1}return o}getTrianglePenetration(e,t,n){let r=this.positions[e],i=this.positions[t],a=this.positions[n];if(!r||!i||!a)return 0;let o=0;for(let e of Wo)o=Math.max(o,Math.abs(this.getSampleCorrection(r,i,a,e)));return o}getSampleCorrection(e,t,n,r){return this.sample.set(e.x*r.first+t.x*r.second+n.x*r.third,e.y*r.first+t.y*r.second+n.y*r.third,e.z*r.first+t.z*r.second+n.z*r.third),wt(this.sample.y,this.sample.z,Ro,this.bounds),this.sample.x<this.bounds.minimum?this.bounds.minimum-this.sample.x:this.sample.x>this.bounds.maximum?this.bounds.maximum-this.sample.x:0}applyCorrection(e,t){if(Math.abs(t)<=Uo)return;let n=this.positions[e],r=this.previous[e];if(!n||!r)return;let i=Math.sign(t),a=(n.x-r.x)*i;n.x+=t,r.x+=t,a<0&&(r.x+=a*i)}index(e,t){return t*this.columns+e}isNearBoundary(e,t,n){return!this.nearBoundary||this.nearBoundary[e]===1||this.nearBoundary[t]===1||this.nearBoundary[n]===1}},Ko=Y.lengthRange.max+2.2,qo=.08,Jo=.16,Yo=3,Xo=3,Zo=.015,Qo=.03,$o=.08,es=class{positions;previous;nearbyWorldColliders=[];activeWorldColliders=[];activeWorldSpheres=[];activeRocks=[];preparedBodyColliders=[];delta=new I;sweep=new I;sweepStart=new I;hitPoint=new I;contactNormal=new I;remainingMotion=new I;boundsMinimum=new I;boundsMaximum=new I;caveBounds={minimum:0,maximum:0};worldContactsLastStep=0;worldContactEvents=0;bodySolvePass=0;caveSolvePass=0;bodyFaceCollision;faceCollision;rockFaceCollision;caveFaceCollision;rockQuery=new Do;rockCorrectionUsed;rockSweepResolved;caveFloor;caveCeilingHeight;caveMinimumX;caveMaximumX;caveNearBoundary;caveNearWall;constructor(e,t,n){this.positions=e,this.previous=t,this.rockCorrectionUsed=new Float32Array(n.length),this.rockSweepResolved=new Uint8Array(n.length),this.caveFloor=new Float64Array(n.length),this.caveCeilingHeight=new Float64Array(n.length),this.caveMinimumX=new Float64Array(n.length),this.caveMaximumX=new Float64Array(n.length),this.caveNearBoundary=new Uint8Array(n.length),this.caveNearWall=new Uint8Array(n.length),this.bodyFaceCollision=new xo(e,t,n,Y.columns,Y.rows),this.caveFaceCollision=new Go(e,t,n,Y.columns,Y.rows,this.caveNearWall),this.faceCollision=new Ho(e,t,n,Y.columns,Y.rows),this.rockFaceCollision=new Fo(e,t,n,Y.columns,Y.rows,zo)}beginStep(e,t,n,r){this.worldContactsLastStep=0,this.bodySolvePass=0,this.caveSolvePass=0,this.prepareBodyColliders(n,r),this.rockCorrectionUsed.fill(0),this.rockSweepResolved.fill(0),this.faceCollision.beginStep(),this.rockFaceCollision.beginStep(),this.nearbyWorldColliders.length=0;for(let n of t){let t=Ko+n.radius;n.center.distanceToSquared(e)<=t*t&&this.nearbyWorldColliders.push(n)}}solveBody(e,t){for(let e=Y.columns;e<this.positions.length;e+=1){let n=this.positions[e],r=this.previous[e];if(!(!n||!r))for(let e of this.preparedBodyColliders){let i=this.getCapsulePenetration(n,e,t);i<=0||(n.addScaledVector(t,i),r.addScaledVector(t,i),this.removeInwardMotion(n,r,t))}}this.bodySolvePass+=1,this.bodySolvePass>Y.solverIterations-Yo&&this.bodyFaceCollision.solve(e,t)}solveWorld(){this.updateActiveWorldColliders();for(let e=Y.columns;e<this.positions.length;e+=1){let t=this.positions[e],n=this.previous[e];if(!(!t||!n))for(let r of this.activeWorldColliders)vo(r)?this.solveWorldRock(e,t,n,r):this.solveWorldSphere(t,n,r)}let e=this.faceCollision.solve(this.activeWorldSpheres)+this.rockFaceCollision.solve(this.activeRocks);this.worldContactsLastStep+=e,this.worldContactEvents+=e}solvePostCaveWorldContacts(){if(this.activeWorldSpheres.length===0&&this.activeRocks.length===0)return 0;this.rockFaceCollision.beginPass();let e=0;for(let t=Y.columns;t<this.positions.length;t+=1){let n=this.positions[t],r=this.previous[t];if(!(!n||!r))for(let i of this.activeWorldColliders)(vo(i)?this.solveWorldRock(t,n,r,i,!0):this.solveWorldSphere(n,r,i))&&(e+=1)}let t=this.faceCollision.solve(this.activeWorldSpheres)+this.rockFaceCollision.solve(this.activeRocks);return this.worldContactsLastStep+=t,this.worldContactEvents+=t,e+t}solveCave(){this.caveSolvePass+=1;let e=this.caveSolvePass===1||this.caveSolvePass>=Y.solverIterations;for(let t=Y.columns;t<this.positions.length;t+=1){let n=this.positions[t],r=this.previous[t];if(!n||!r)continue;let i=e||this.caveNearBoundary[t]===1,a=G.clamp(n.z,Et.endZ+.08,Et.startZ-.08);a!==n.z&&this.applyAxisCorrection(n,r,`z`,a-n.z);let o=i?dt(n.x,n.z)+Ro:this.caveFloor[t]??0;i&&(this.caveFloor[t]=o),n.y<o&&this.applyAxisCorrection(n,r,`y`,o-n.y);let s=i?Ct(n.z)+.12-Ro:this.caveCeilingHeight[t]??0;i&&(this.caveCeilingHeight[t]=s),n.y>s&&this.applyAxisCorrection(n,r,`y`,s-n.y),i&&(wt(n.y,n.z,Ro,this.caveBounds),this.caveMinimumX[t]=this.caveBounds.minimum,this.caveMaximumX[t]=this.caveBounds.maximum);let c=G.clamp(n.x,this.caveMinimumX[t]??0,this.caveMaximumX[t]??0);c!==n.x&&this.applyAxisCorrection(n,r,`x`,c-n.x),i&&(this.caveNearWall[t]=+(n.x-this.caveMinimumX[t]<Jo||this.caveMaximumX[t]-n.x<Jo),this.caveNearBoundary[t]=+(n.y-o<Jo||s-n.y<Jo||this.caveNearWall[t]===1))}this.caveSolvePass>Y.solverIterations-Xo&&this.caveFaceCollision.solve()}getMaximumBodyPenetration(e,t){return this.getBodyPenetrationDiagnostics(e,t).maximum}getBodyPenetrationDiagnostics(e,t){this.prepareBodyColliders(e,t);let n=0;for(let e=0;e<this.positions.length;e+=1){let r=this.positions[e];if(r)for(let e of this.preparedBodyColliders)n=Math.max(n,this.getCapsulePenetration(r,e,t))}let r=this.bodyFaceCollision.getMaximumPenetration(e,t);return{point:n,face:r,maximum:Math.max(n,r)}}getMaximumEnvironmentPenetration(e){return this.getEnvironmentPenetrationDiagnostics(e).maximum}getEnvironmentPenetrationDiagnostics(e){let t=0,n=0,r=0,i=0,a=null,o=null,s=null,c=null,l=null,u=null,d=null;for(let f=Y.columns;f<this.positions.length;f+=1){let p=this.positions[f];if(!p)continue;for(let r of e){let e=vo(r)?zo-this.rockQuery.getSignedDistance(r,p,this.contactNormal):r.radius+Vo(r)-p.distanceTo(r.center);vo(r)?e>n&&(n=e,c=f,l=[p.x,p.y,p.z],u=[r.center.x,r.center.y,r.center.z],d=r.walkable):t=Math.max(t,e)}let m=dt(p.x,p.z)+Ro,h=m-p.y;h>r&&(r=h,a=f,o=[p.x,p.y,p.z],s=m),wt(p.y,p.z,Ro,this.caveBounds),i=Math.max(i,this.caveBounds.minimum-p.x,p.x-this.caveBounds.maximum)}let f=this.faceCollision.getMaximumPenetration(e.filter(e=>!vo(e))),p=this.rockFaceCollision.getMaximumPenetrationDiagnostics(e.filter(vo)),m=p.maximum,h=this.caveFaceCollision.getMaximumPenetration();return{sphere:t,rock:n,floor:r,wall:i,sphereFace:f,rockFace:m,caveFace:h,maximum:Math.max(t,n,r,i,f,m,h),floorParticleIndex:a,floorPosition:o,floorHeight:s,rockParticleIndex:c,rockPosition:l,rockCenter:u,rockWalkable:d,rockFaceDetail:{triangle:p.triangle,positions:p.positions,previous:p.previous,rockCenter:p.rockCenter}}}getMaximumEnvironmentFacePenetration(e){return Math.max(this.faceCollision.getMaximumPenetration(e.filter(e=>!vo(e))),this.rockFaceCollision.getMaximumPenetration(e.filter(vo)),this.caveFaceCollision.getMaximumPenetration())}getClosestActiveRockSurfaceContact(e=this.activeRocks){let t=this.rockFaceCollision.getClosestSurfaceContact(e.filter(vo));if(!t)return null;let{center:n}=t.collider;return{distance:t.distance,center:[n.x,n.y,n.z]}}getDiagnostics(){return{lastStep:this.worldContactsLastStep,total:this.worldContactEvents}}getCapsulePenetration(e,t,n){if(e.y<t.minimumY||e.y>t.maximumY)return 0;let r=e.x-t.startX,i=e.y-t.startY,a=e.z-t.startZ,o=r*n.x+i*n.y+a*n.z,s=r-n.x*o,c=i-n.y*o,l=a-n.z*o,u=t.lateralLengthSquared>1e-6?G.clamp((s*t.lateralAxisX+c*t.lateralAxisY+l*t.lateralAxisZ)/t.lateralLengthSquared,0,1):0,d=t.startX+t.axisX*u,f=t.startY+t.axisY*u,p=t.startZ+t.axisZ*u,m=e.x-d,h=e.y-f,g=e.z-p,_=m*n.x+h*n.y+g*n.z,v=Math.max(0,m*m+h*h+g*g-_*_);if(v>=t.lateralRadius*t.lateralRadius)return 0;let y=v/(t.lateralRadius*t.lateralRadius),b=t.depthRadius*Math.sqrt(1-y);return Math.max(0,b-_)}prepareBodyColliders(e,t){this.preparedBodyColliders.length=e.length;for(let n=0;n<e.length;n+=1){let r=e[n];if(!r)continue;let i=this.preparedBodyColliders[n]??{startX:0,startY:0,startZ:0,axisX:0,axisY:0,axisZ:0,lateralAxisX:0,lateralAxisY:0,lateralAxisZ:0,lateralLengthSquared:0,lateralRadius:0,depthRadius:0,minimumY:0,maximumY:0},a=r.end.x-r.start.x,o=r.end.y-r.start.y,s=r.end.z-r.start.z,c=a*t.x+o*t.y+s*t.z,l=a-t.x*c,u=o-t.y*c,d=s-t.z*c,f=r.radius+yo(r),p=bo(r),m=Math.max(f,p);i.startX=r.start.x,i.startY=r.start.y,i.startZ=r.start.z,i.axisX=a,i.axisY=o,i.axisZ=s,i.lateralAxisX=l,i.lateralAxisY=u,i.lateralAxisZ=d,i.lateralLengthSquared=l*l+u*u+d*d,i.lateralRadius=f,i.depthRadius=p,Math.abs(t.y)<1e-4?(i.minimumY=Math.min(r.start.y,r.end.y)-m,i.maximumY=Math.max(r.start.y,r.end.y)+m):(i.minimumY=-1/0,i.maximumY=1/0),this.preparedBodyColliders[n]=i}}solveWorldSphere(e,t,n){let r=Vo(n),i=n.radius+r;this.delta.copy(e).sub(n.center);let a=this.delta.lengthSq();if(a<i*i){this.registerWorldContact();let o=Math.sqrt(a);o<1e-6?(this.contactNormal.copy(t).sub(n.center),this.contactNormal.lengthSq()<1e-6?this.contactNormal.set(0,1,0):this.contactNormal.normalize()):this.contactNormal.copy(this.delta).multiplyScalar(1/o);let s=i-o,c=Lo(e,n.center,i,r,this.contactNormal,t);return c!==null&&(s=c),e.addScaledVector(this.contactNormal,s),t.addScaledVector(this.contactNormal,s),this.removeInwardMotion(e,t,this.contactNormal),!0}this.sweep.copy(e).sub(t);let o=this.sweep.lengthSq();if(o<1e-7)return!1;this.sweepStart.copy(t).sub(n.center);let s=this.sweepStart.lengthSq()-i*i;if(s<=0)return!1;let c=this.sweepStart.dot(this.sweep);if(c>=0)return!1;let l=c*c-o*s;if(l<0)return!1;let u=(-c-Math.sqrt(l))/o;if(u<0||u>1)return!1;this.registerWorldContact(),this.hitPoint.copy(t).addScaledVector(this.sweep,u),this.contactNormal.copy(this.hitPoint).sub(n.center).normalize(),this.remainingMotion.copy(this.sweep).multiplyScalar(1-u);let d=this.remainingMotion.dot(this.contactNormal);return d<0&&this.remainingMotion.addScaledVector(this.contactNormal,-d),this.remainingMotion.multiplyScalar(.76),this.hitPoint.addScaledVector(this.contactNormal,.0015),t.copy(this.hitPoint),e.copy(this.hitPoint).add(this.remainingMotion),!0}solveWorldRock(e,t,n,r,i=!1){if(!this.rockQuery.intersectsExpandedBounds(r,n,t,.003))return!1;let a=this.rockQuery.getSignedDistance(r,n,this.delta);if(this.sweep.copy(t).sub(n),this.rockSweepResolved[e]===0&&this.sweep.lengthSq()<=$o**2&&a>=.003){let i=this.rockQuery.sweep(r,n,t,zo,this.contactNormal);if(i!==null){this.registerWorldContact(),this.rockSweepResolved[e]=1,this.hitPoint.copy(n).addScaledVector(this.sweep,i),this.redirectRockContactAlongFloor(this.hitPoint,r),this.remainingMotion.copy(this.sweep).multiplyScalar(1-i);let a=this.remainingMotion.dot(this.contactNormal);return a<0&&this.remainingMotion.addScaledVector(this.contactNormal,-a),this.remainingMotion.multiplyScalar(.76),this.hitPoint.addScaledVector(this.contactNormal,.001),n.copy(this.hitPoint),t.copy(this.hitPoint).add(this.remainingMotion),!0}}let o=this.rockQuery.getSignedDistance(r,t,this.contactNormal);if(o<.003){this.registerWorldContact();let a=zo-o;this.redirectRockContactAlongFloor(t,r)&&(a=Math.min(a,r.radius*.5));let s=i?1/0:Math.max(0,(r.walkable?Zo:Qo)-(this.rockCorrectionUsed[e]??0));return a=Math.min(a,s),a<=0||(t.addScaledVector(this.contactNormal,a),n.addScaledVector(this.contactNormal,a),this.removeInwardMotion(t,n,this.contactNormal),this.rockCorrectionUsed[e]=(this.rockCorrectionUsed[e]??0)+a,!0)}return!1}redirectRockContactAlongFloor(e,t){let n=this.contactNormal.y<0&&e.y<=dt(e.x,e.z)+.006;return!To(t,e.y)&&!n?!1:(this.contactNormal.set(e.x-t.center.x,0,e.z-t.center.z),this.contactNormal.lengthSq()<1e-6?this.contactNormal.set(1,0,0):this.contactNormal.normalize(),!0)}applyAxisCorrection(e,t,n,r){let i=(e[n]-t[n])*Math.sign(r);e[n]+=r,t[n]+=r,i<0&&(t[n]+=i*Math.sign(r))}removeInwardMotion(e,t,n){let r=this.delta.copy(e).sub(t).dot(n);r<0&&t.addScaledVector(n,r)}registerWorldContact(){this.worldContactsLastStep+=1,this.worldContactEvents+=1}updateActiveWorldColliders(){this.boundsMinimum.set(1/0,1/0,1/0),this.boundsMaximum.set(-1/0,-1/0,-1/0);for(let e=0;e<this.positions.length;e+=1){let t=this.positions[e],n=this.previous[e];t&&(this.boundsMinimum.min(t),this.boundsMaximum.max(t)),n&&(this.boundsMinimum.min(n),this.boundsMaximum.max(n))}this.activeWorldColliders.length=0,this.activeWorldSpheres.length=0,this.activeRocks.length=0;for(let e of this.nearbyWorldColliders){if(vo(e)){let t=zo+qo;if(e.bounds.max.x+t<this.boundsMinimum.x||e.bounds.min.x-t>this.boundsMaximum.x||e.bounds.max.y+t<this.boundsMinimum.y||e.bounds.min.y-t>this.boundsMaximum.y||e.bounds.max.z+t<this.boundsMinimum.z||e.bounds.min.z-t>this.boundsMaximum.z)continue;this.activeWorldColliders.push(e),this.activeRocks.push(e);continue}let t=e.radius+Vo(e)+qo;e.center.x+t<this.boundsMinimum.x||e.center.x-t>this.boundsMaximum.x||e.center.y+t<this.boundsMinimum.y||e.center.y-t>this.boundsMaximum.y||e.center.z+t<this.boundsMinimum.z||e.center.z-t>this.boundsMaximum.z||(this.activeWorldColliders.push(e),this.activeWorldSpheres.push(e))}}},ts=[`prediction`,`constraints`,`selfCollision`,`foldGuard`,`bodyCollision`,`worldCollision`,`caveCollision`,`reconciliation`,`anchors`,`finalization`],ns=32;function rs(){return{prediction:0,constraints:0,selfCollision:0,foldGuard:0,bodyCollision:0,worldCollision:0,caveCollision:0,reconciliation:0,anchors:0,finalization:0}}var is=class{sampleIntervalSteps;phaseTotals=rs();totalSteps=0;activeSteps=0;sampledActiveSteps=0;totalMilliseconds=0;sampling=!1;constructor(e=ns){if(this.sampleIntervalSteps=e,!Number.isInteger(e)||e<1)throw RangeError(`Cape profile sample interval must be a positive integer.`)}beginStep(e){return this.totalSteps+=1,e?(this.activeSteps+=1,this.sampling=(this.activeSteps-1)%this.sampleIntervalSteps==0,this.sampling):(this.sampling=!1,!1)}record(e,t){!this.sampling||!Number.isFinite(t)||(this.phaseTotals[e]+=Math.max(0,t))}endStep(e){this.sampling&&=(Number.isFinite(e)&&(this.totalMilliseconds+=Math.max(0,e)),this.sampledActiveSteps+=1,!1)}getDiagnostics(){let e=Math.max(1,this.sampledActiveSteps),t=rs();for(let n of ts)t[n]=this.phaseTotals[n]/e;return{implementation:`cpu-pbd`,sampleIntervalSteps:this.sampleIntervalSteps,totalSteps:this.totalSteps,activeSteps:this.activeSteps,sampledActiveSteps:this.sampledActiveSteps,averageStepMilliseconds:this.totalMilliseconds/e,phases:t}}},as=.5,os=.1;function ss(e,t,n=Y.width){let r=G.clamp(t,0,1),i=G.smoothstep(r,0,os),a=Math.max(e,as),o=G.lerp(e,a,i),s=r*r*(3-2*r);return G.lerp(o,n*1.16,s)}function cs(e,t){let n=G.clamp(e,0,1),r=1-Math.abs(G.clamp(t,-.5,.5))*2,i=.008+n*.1+(1-n)**2*r*.035,a=.009+n*.045+(1-n)**2*r*.035,o=1/(Y.rows-1),s=3/(Y.rows-1),c=G.smoothstep(n,o,s),l=Math.max(0,1-Math.abs(n-.15)/.16)*r*.028;return G.lerp(a,i,c)+l}var ls={length:Y.lengthRange,width:Y.widthRange,stiffness:{min:.1,max:1.5,step:.05},damping:{min:.5,max:1.8,step:.05},weight:{min:.5,max:1.5,step:.05}},us=Object.freeze({length:Y.length,width:Y.width,stiffness:1,damping:1,weight:1});function ds(e,t){return typeof e==`number`&&Number.isFinite(e)?e:t}function fs(e={}){return{length:G.clamp(ds(e.length,us.length),ls.length.min,ls.length.max),width:G.clamp(ds(e.width,us.width),ls.width.min,ls.width.max),stiffness:G.clamp(ds(e.stiffness,us.stiffness),ls.stiffness.min,ls.stiffness.max),damping:G.clamp(ds(e.damping,us.damping),ls.damping.min,ls.damping.max),weight:G.clamp(ds(e.weight,us.weight),ls.weight.min,ls.weight.max)}}var ps=.022,ms=.68,hs=class{columns;rows;constructor(e,t){this.columns=e,this.rows=t}solve(e,t,n){for(let r=1;r<this.rows;r+=1)for(let i=0;i<this.columns;i+=1){let a=(r-1)*this.columns+i,o=r*this.columns+i,s=e[a],c=e[o],l=t[a],u=t[o];if(!s||!c||!l||!u)continue;let d=c.y-s.y-ps;if(d<=0)continue;let f=n[a]??0,p=n[o]??0,m=f+p;if(m<=0)continue;let h=d*ms,g=h*f/m,_=h*p/m;s.y+=g,l.y+=g,c.y-=_,u.y-=_}}getMaximumUpwardFold(e){let t=0;for(let n=1;n<this.rows;n+=1)for(let r=0;r<this.columns;r+=1){let i=e[(n-1)*this.columns+r],a=e[n*this.columns+r];i&&a&&(t=Math.max(t,a.y-i.y))}return t}},gs=.058,_s=.072,vs=521,ys=class{columns;heads=new Int32Array(vs);next;cellX;cellY;cellZ;delta=new I;correction=new I;constructor(e,t){this.columns=t,this.next=new Int16Array(e),this.cellX=new Int16Array(e),this.cellY=new Int16Array(e),this.cellZ=new Int16Array(e)}solve(e,t,n){this.rebuild(e);let r=gs*gs;for(let i=0;i<e.length;i+=1){let a=e[i],o=t[i];if(!a||!o)continue;let s=this.cellX[i]??0,c=this.cellY[i]??0,l=this.cellZ[i]??0;for(let u=-1;u<=1;u+=1)for(let d=-1;d<=1;d+=1)for(let f=-1;f<=1;f+=1){let p=s+u,m=c+d,h=l+f,g=this.heads[this.hash(p,m,h)]??-1;for(;g>=0;){if(g<i&&this.cellX[g]===p&&this.cellY[g]===m&&this.cellZ[g]===h&&!this.isTopologicalNeighbor(i,g)){let s=e[g],c=t[g];if(s&&c){this.delta.copy(a).sub(s);let e=this.delta.lengthSq();if(e<r){let t=Math.sqrt(e);t<1e-6?this.fallbackNormal(i,g):this.delta.multiplyScalar(1/t);let r=n[i]??0,l=n[g]??0,u=r+l;u>0&&(this.correction.copy(this.delta).multiplyScalar((gs-t)/u),r>0&&(a.addScaledVector(this.correction,r),o.addScaledVector(this.correction,r)),l>0&&(s.addScaledVector(this.correction,-l),c.addScaledVector(this.correction,-l)))}}}g=this.next[g]??-1}}}}getMinimumSeparation(e){let t=1/0;for(let n=0;n<e.length;n+=1){let r=e[n];if(r)for(let i=0;i<n;i+=1){let a=e[i];!a||this.isTopologicalNeighbor(n,i)||(t=Math.min(t,r.distanceTo(a)))}}return t}rebuild(e){this.heads.fill(-1);for(let t=0;t<e.length;t+=1){let n=e[t];if(!n)continue;let r=Math.floor(n.x/_s),i=Math.floor(n.y/_s),a=Math.floor(n.z/_s);this.cellX[t]=r,this.cellY[t]=i,this.cellZ[t]=a;let o=this.hash(r,i,a);this.next[t]=this.heads[o]??-1,this.heads[o]=t}}isTopologicalNeighbor(e,t){let n=Math.floor(e/this.columns),r=Math.floor(t/this.columns),i=e%this.columns,a=t%this.columns;return Math.abs(n-r)<=2&&Math.abs(i-a)<=2}hash(e,t,n){return((Math.imul(e,73856093)^Math.imul(t,19349663)^Math.imul(n,83492791))>>>0)%vs}fallbackNormal(e,t){let n=e*.754877666+t*.569840291;this.delta.set(Math.sin(n),Math.cos(n*1.37),Math.sin(n*.73+1.1)).normalize()}},bs=2.05,xs=2.8,Ss=.55,Cs=.0025,ws=.48,Ts=.18,Es=.016,Ds=.12,Os=.001,ks=.08,As=class{mesh;positions=[];previous=[];inverseMass;constraints=[];positionAttribute;selfCollision;foldGuard;contactSolver;profiler=new is;velocity=new I;airflow=new I;normal=new I;tangentAcross=new I;tangentDown=new I;correction=new I;delta=new I;anchorTarget=new I;anchorCenter=new I;rightAxis=new I;rowCenter=new I;drapeDelta=new I;stepStart=[];opacity=1;settledSeconds=0;sleeping=!1;maximumParticleMotion=0;maximumParticleVerticalMotion=0;settings;constructor(e,t={}){this.settings=fs(t);let n=Y.columns*Y.rows;this.inverseMass=new Float32Array(n),this.selfCollision=new ys(n,Y.columns),this.foldGuard=new hs(Y.columns,Y.rows),this.contactSolver=new es(this.positions,this.previous,this.inverseMass),this.initializeParticles(e),this.positions.forEach(e=>this.stepStart.push(e.clone())),this.createConstraints();let r=this.createGeometry();this.positionAttribute=r.getAttribute(`position`);let i=no();i.color.repeat.set(1,1),i.normal.repeat.set(1,1),i.roughness.repeat.set(1,1);let a=new le({map:i.color,normalMap:i.normal,normalScale:new U(.48,.48),roughnessMap:i.roughness,roughness:.78,metalness:.01,sheen:.92,sheenColor:new P(7276307),sheenRoughness:.72,clearcoat:.04,side:2,transparent:!1,depthWrite:!0});a.name=`Woven crimson cape`,this.mesh=new N(r,a),this.mesh.name=`PBD cape`,this.mesh.castShadow=!0,this.mesh.receiveShadow=!0,this.mesh.frustumCulled=!1}step(e,t,n,r,i,a){let o=i.length(),s=this.profiler.beginStep(!this.sleeping||o>ks),c=s?performance.now():0,l=c;this.captureStepStart();let u=Math.hypot(i.x,i.z);if(o>ks&&(this.settledSeconds=0,this.sleeping=!1),this.pinAnchors(t),this.contactSolver.beginStep(this.anchorCenter,r,n,t.back),this.sleeping){if(this.measureStepMotion(),s){let e=performance.now();this.profiler.record(`prediction`,e-l),this.profiler.endStep(e-c)}return}let d=G.smoothstep(o,ks,2.4),f=G.smoothstep(u,X.walkSpeed*1.02,X.runSpeed*.92),p=G.lerp(.28,1,f),m=G.lerp(.32,1.28,f);this.airflow.set(Math.sin(a*.47)*.38+Math.sin(a*1.91)*.16,.08+Math.sin(a*.71)*.05,.62+Math.cos(a*.31)*.24).multiplyScalar(G.lerp(.025,p,d)).addScaledVector(i,-m);let h=e*e;for(let t=1;t<Y.rows;t+=1)for(let n=0;n<Y.columns;n+=1){let r=this.index(n,t),i=this.positions[r],o=this.previous[r];if(!i||!o)continue;let s=G.lerp(xs,bs,d)*this.settings.damping;this.velocity.copy(i).sub(o).multiplyScalar(Math.exp(-s*e)),o.copy(i),this.estimateNormal(n,t);let c=this.airflow.dot(this.normal),l=Math.sin(a*4.3+t*.83+n*1.71)*.42;i.add(this.velocity),i.y-=9.81*this.settings.weight*h,i.addScaledVector(this.normal,c*Math.abs(c)*.026*h),i.addScaledVector(this.airflow,(.048+l*.011)*h)}if(s){let e=performance.now();this.profiler.record(`prediction`,e-l),l=e}for(let e=0;e<Y.solverIterations;e+=1){for(let e of this.constraints)this.solveConstraint(e);if(s){let e=performance.now();this.profiler.record(`constraints`,e-l),l=e}if(this.selfCollision.solve(this.positions,this.previous,this.inverseMass),s){let e=performance.now();this.profiler.record(`selfCollision`,e-l),l=e}if(this.foldGuard.solve(this.positions,this.previous,this.inverseMass),s){let e=performance.now();this.profiler.record(`foldGuard`,e-l),l=e}if(e===0&&o<=ks&&this.getMaximumLowerCapeLateralOffset(t)>Ds&&this.solveIdleDrapeRecovery(t),this.contactSolver.solveBody(n,t.back),s){let e=performance.now();this.profiler.record(`bodyCollision`,e-l),l=e}if(this.contactSolver.solveWorld(),s){let e=performance.now();this.profiler.record(`worldCollision`,e-l),l=e}if(this.contactSolver.solveCave(),s){let e=performance.now();this.profiler.record(`caveCollision`,e-l),l=e}if(e===Y.solverIterations-1&&(this.contactSolver.solvePostCaveWorldContacts(),this.contactSolver.solveBody(n,t.back),this.contactSolver.solvePostCaveWorldContacts()>0&&(this.contactSolver.solveBody(n,t.back),this.contactSolver.solvePostCaveWorldContacts()),this.contactSolver.solveCave()),s){let e=performance.now();this.profiler.record(`reconciliation`,e-l),l=e}if(this.pinAnchors(t),s){let e=performance.now();this.profiler.record(`anchors`,e-l),l=e}}this.measureStepMotion();let g=this.getMaximumLowerCapeLateralOffset(t)<Ts,_=o<=ks&&this.getHemDrop()>.72&&this.getMinimumLowerCapeDrop()>ws&&g&&this.contactSolver.getMaximumBodyPenetration(n,t.back)<Os;if(_&&this.dampResidualMotion(.14),_&&this.maximumParticleMotion<Cs?this.settledSeconds+=e:this.settledSeconds=_?Math.max(0,this.settledSeconds-e*.2):0,this.settledSeconds>=Ss&&(this.sleeping=!0,this.positions.forEach((e,t)=>this.previous[t]?.copy(e))),this.guardAgainstInvalidState(t),s){let e=performance.now();this.profiler.record(`finalization`,e-l),this.profiler.endStep(e-c)}}syncGeometry(){let e=this.positionAttribute.array;this.positions.forEach((t,n)=>{e[n*3]=t.x,e[n*3+1]=t.y,e[n*3+2]=t.z}),this.positionAttribute.needsUpdate=!0,this.mesh.geometry.computeVertexNormals();let t=this.mesh.geometry.getAttribute(`normal`);t&&(t.needsUpdate=!0)}async refreshDiagnostics(){}overwriteStateFromGpu(e,t){let n=this.positions.length*4;if(e.length<n||t.length<n)throw RangeError(`GPU cape state is smaller than the simulation grid.`);this.positions.forEach((n,r)=>{let i=r*4;n.set(e[i]??0,e[i+1]??0,e[i+2]??0),this.previous[r]?.set(t[i]??0,t[i+1]??0,t[i+2]??0)})}reset(e){this.positions.length=0,this.previous.length=0,this.initializeParticles(e),this.pinAnchors(e),this.positions.forEach((e,t)=>{let n=this.stepStart[t];n?n.copy(e):this.stepStart.push(e.clone())}),this.settledSeconds=0,this.sleeping=!1,this.maximumParticleMotion=0,this.maximumParticleVerticalMotion=0}updateSettings(e,t){let n=fs(e),r=n.length!==this.settings.length||n.width!==this.settings.width;this.settings=n,this.settledSeconds=0,this.sleeping=!1,r&&(this.constraints.length=0,this.reset(t),this.createConstraints(),this.syncGeometry())}getSettings(){return{...this.settings}}setOpacity(e){let t=G.clamp(e,gt,1);Math.abs(t-this.opacity)<.002||(this.opacity=t)}getParticlePosition(e,t){let n=this.positions[this.index(e,t)];if(!n)throw RangeError(`Cape particle index is outside the simulation grid.`);return n.clone()}getMaximumStructuralError(){let e=0;for(let t of this.constraints){if(!t.structural)continue;let n=this.positions[t.first],r=this.positions[t.second];!n||!r||(e=Math.max(e,Math.abs(n.distanceTo(r)-t.restLength)))}return e}getMaximumBodyPenetration(e,t){return this.contactSolver.getMaximumBodyPenetration(e,t)}getBodyPenetrationDiagnostics(e,t){return this.contactSolver.getBodyPenetrationDiagnostics(e,t)}getMaximumEnvironmentPenetration(e){return this.contactSolver.getMaximumEnvironmentPenetration(e)}getEnvironmentPenetrationDiagnostics(e){return this.contactSolver.getEnvironmentPenetrationDiagnostics(e)}getMaximumEnvironmentFacePenetration(e){return this.contactSolver.getMaximumEnvironmentFacePenetration(e)}getMinimumSelfSeparation(){return this.selfCollision.getMinimumSeparation(this.positions)}getMaximumUpwardFold(){return this.foldGuard.getMaximumUpwardFold(this.positions)}getHemDrop(){let e=0;for(let t=0;t<Y.columns;t+=1)e+=this.positions[this.index(t,Y.rows-1)]?.y??this.anchorCenter.y;return this.anchorCenter.y-e/Y.columns}getMinimumLowerCapeDrop(){let e=1/0,t=Math.floor(Y.rows*.58);for(let n=t;n<Y.rows;n+=1)for(let t=0;t<Y.columns;t+=1){let r=this.positions[this.index(t,n)];r&&(e=Math.min(e,this.anchorCenter.y-r.y))}return e}getMaximumLowerCapeLateralOffset(e){this.rightAxis.copy(e.right).sub(e.left).normalize();let t=Math.floor(Y.rows*.58),n=0;for(let e=t;e<Y.rows;e+=1)this.getRowCenter(e,this.rowCenter),n=Math.max(n,Math.abs(this.drapeDelta.copy(this.rowCenter).sub(this.anchorCenter).dot(this.rightAxis)));return n}getHemBackOffset(e){return this.getRowCenter(Y.rows-1,this.rowCenter),this.drapeDelta.copy(this.rowCenter).sub(this.anchorCenter).dot(e.back)}getMinimumHemGroundClearance(){let e=1/0;for(let t=0;t<Y.columns;t+=1){let n=this.positions[this.index(t,Y.rows-1)];n&&(e=Math.min(e,n.y-dt(n.x,n.z)))}return e}getMaximumParticleMotion(){return this.maximumParticleMotion}getMaximumParticleVerticalMotion(){return this.maximumParticleVerticalMotion}isSleeping(){return this.sleeping}getWorldContactDiagnostics(){return this.contactSolver.getDiagnostics()}getPerformanceDiagnostics(){return this.profiler.getDiagnostics()}getClosestActiveRockSurfaceContact(e){return this.contactSolver.getClosestActiveRockSurfaceContact(e)}initializeParticles(e){this.anchorCenter.copy(e.left).add(e.right).multiplyScalar(.5);let t=e.right.distanceTo(e.left),n=e.right.clone().sub(e.left).normalize(),r=e.left.clone().add(e.right).multiplyScalar(.5);for(let i=0;i<Y.rows;i+=1){let a=i/(Y.rows-1),o=ss(t,a,this.settings.width);for(let t=0;t<Y.columns;t+=1){let s=t/(Y.columns-1)-.5,c=r.clone().addScaledVector(n,s*o).addScaledVector(e.back,cs(a,s)).add(new I(0,-a*this.settings.length*(1-Math.abs(s)*.085),0));i===0&&this.setAnchorTarget(e,t/(Y.columns-1),c),this.positions.push(c),this.previous.push(c.clone()),this.inverseMass[this.index(t,i)]=i===0?0:1}}}createConstraints(){for(let e=0;e<Y.rows;e+=1)for(let t=0;t<Y.columns;t+=1)t+1<Y.columns&&this.addConstraint(t,e,t+1,e,.93,!0),e+1<Y.rows&&this.addConstraint(t,e,t,e+1,.96,!0),t+1<Y.columns&&e+1<Y.rows&&(this.addConstraint(t,e,t+1,e+1,.8,!1),this.addConstraint(t+1,e,t,e+1,.8,!1)),t+2<Y.columns&&this.addConstraint(t,e,t+2,e,.58,!1),e+2<Y.rows&&this.addConstraint(t,e,t,e+2,.82,!1),t+3<Y.columns&&this.addConstraint(t,e,t+3,e,.16,!1),e+3<Y.rows&&this.addConstraint(t,e,t,e+3,.38,!1)}addConstraint(e,t,n,r,i,a){let o=this.index(e,t),s=this.index(n,r),c=this.positions[o],l=this.positions[s];!c||!l||this.constraints.push({first:o,second:s,restLength:c.distanceTo(l),stiffness:i,structural:a})}createGeometry(){let t=new Float32Array(this.positions.length*3),n=new Float32Array(this.positions.length*2),r=[];this.positions.forEach((e,r)=>{e.toArray(t,r*3);let i=r%Y.columns,a=Math.floor(r/Y.columns);n[r*2]=i/(Y.columns-1),n[r*2+1]=1-a/(Y.rows-1)});for(let e=0;e<Y.rows-1;e+=1)for(let t=0;t<Y.columns-1;t+=1){let n=this.index(t,e),i=this.index(t,e+1);r.push(n,i,n+1,i,i+1,n+1)}let i=new K,a=new He(t,3);return a.setUsage(e),i.setAttribute(`position`,a),i.setAttribute(`uv`,new He(n,2)),i.setIndex(r),i.computeVertexNormals(),i}pinAnchors(e){this.anchorCenter.copy(e.left).add(e.right).multiplyScalar(.5);for(let t=0;t<Y.columns;t+=1){let n=this.index(t,0),r=this.positions[n],i=this.previous[n];!r||!i||(this.setAnchorTarget(e,t/(Y.columns-1),this.anchorTarget),r.copy(this.anchorTarget),i.copy(this.anchorTarget))}}setAnchorTarget(e,t,n){let r=Math.sin(t*Math.PI);n.lerpVectors(e.left,e.right,t),n.y+=r*Y.attachment.necklineRise,n.addScaledVector(e.back,r*Y.attachment.necklineDepth)}dampResidualMotion(e){for(let t=Y.columns;t<this.positions.length;t+=1){let n=this.positions[t],r=this.previous[t];n&&r&&r.lerp(n,e)}}solveIdleDrapeRecovery(e){this.rightAxis.copy(e.right).sub(e.left).normalize();for(let e=1;e<Y.rows;e+=1){this.getRowCenter(e,this.rowCenter);let t=this.drapeDelta.copy(this.rowCenter).sub(this.anchorCenter).dot(this.rightAxis),n=e/(Y.rows-1),r=-t*Es*G.smoothstep(n,.05,1);for(let t=0;t<Y.columns;t+=1){let n=this.index(t,e);this.positions[n]?.addScaledVector(this.rightAxis,r),this.previous[n]?.addScaledVector(this.rightAxis,r)}}}getRowCenter(e,t){t.set(0,0,0);for(let n=0;n<Y.columns;n+=1){let r=this.positions[this.index(n,e)];r&&t.add(r)}return t.multiplyScalar(1/Y.columns)}captureStepStart(){this.positions.forEach((e,t)=>{let n=this.stepStart[t];n?n.copy(e):this.stepStart.push(e.clone())})}measureStepMotion(){let e=0,t=0;for(let n=Y.columns;n<this.positions.length;n+=1){let r=this.positions[n],i=this.stepStart[n];!r||!i||(e=Math.max(e,r.distanceTo(i)),t=Math.max(t,Math.abs(r.y-i.y)))}this.maximumParticleMotion=e,this.maximumParticleVerticalMotion=t}solveConstraint(e){let t=this.positions[e.first],n=this.positions[e.second];if(!t||!n)return;this.delta.copy(n).sub(t);let r=this.delta.length();if(r<1e-6)return;let i=this.inverseMass[e.first]??0,a=this.inverseMass[e.second]??0,o=i+a;if(o===0)return;let s=Math.min(.999,e.stiffness*this.settings.stiffness);this.correction.copy(this.delta).multiplyScalar((r-e.restLength)/r*s),i>0&&t.addScaledVector(this.correction,i/o),a>0&&n.addScaledVector(this.correction,-a/o)}estimateNormal(e,t){let n=this.positions[this.index(Math.max(0,e-1),t)],r=this.positions[this.index(Math.min(Y.columns-1,e+1),t)],i=this.positions[this.index(e,Math.max(0,t-1))],a=this.positions[this.index(e,Math.min(Y.rows-1,t+1))];if(!n||!r||!i||!a){this.normal.set(0,0,1);return}this.tangentAcross.copy(r).sub(n),this.tangentDown.copy(a).sub(i),this.normal.crossVectors(this.tangentAcross,this.tangentDown).normalize()}guardAgainstInvalidState(e){this.positions.some(e=>!Number.isFinite(e.lengthSq())||e.distanceToSquared(this.anchorCenter)>25)&&this.reset(e)}index(e,t){return t*Y.columns+e}},js=class{rig;walkPhase=0;gaitBob=0;runningBlend=0;airborneBlend=0;jumpPhase=0;constructor(e){this.rig=e}update(e,t,n,r){let i=G.smoothstep(t,.04,X.walkSpeed*.45);this.runningBlend=G.smoothstep(t,X.walkSpeed*1.02,X.runSpeed*.9),this.walkPhase+=e*G.lerp(6.4,10.8,this.runningBlend)*i,this.airborneBlend=ht(this.airborneBlend,+!n,n?14:22,e),n?this.airborneBlend<.02&&(this.jumpPhase=0):this.jumpPhase=G.clamp(.5-r/(X.jumpSpeed*2),0,1);let a=Math.sin(this.walkPhase)*i,o=G.lerp(.55,.78,this.runningBlend),s=a*o,c=-a*o,l=G.lerp(.38,.58,this.runningBlend),u=-a*l-.08,d=a*l-.08,f=Math.sin(this.jumpPhase*Math.PI),p=G.smoothstep(this.jumpPhase,.62,1),m=Math.sin(this.jumpPhase*Math.PI*2)*.055,h=.16+f*.38-p*.24+m,g=.06+f*.26-p*.18-m,_=.28+f*.58-p*.16,v=-.16+f*.34+p*.18;this.rig.leftLeg.rotation.x=G.lerp(s,h,this.airborneBlend),this.rig.rightLeg.rotation.x=G.lerp(c,g,this.airborneBlend),this.rig.leftArm.rotation.x=G.lerp(u,_+m,this.airborneBlend),this.rig.rightArm.rotation.x=G.lerp(d,_-m,this.airborneBlend),this.rig.leftFoot.rotation.x=G.lerp(-a*.14,v+m,this.airborneBlend),this.rig.rightFoot.rotation.x=G.lerp(a*.14,v-m,this.airborneBlend),this.gaitBob=Math.abs(Math.sin(this.walkPhase*2))*G.lerp(.018,.046,this.runningBlend)*i*(1-this.airborneBlend),this.rig.body.position.y=this.gaitBob+Math.sin(this.jumpPhase*Math.PI)*.012*this.airborneBlend,this.rig.body.rotation.x=G.lerp(-this.runningBlend*i*.035,.025,this.airborneBlend),this.rig.body.rotation.z=-a*G.lerp(.014,.024,this.runningBlend)*(1-this.airborneBlend)}getDiagnostics(){return{bob:this.gaitBob,runningBlend:this.runningBlend,airborneBlend:this.airborneBlend,jumpPhase:this.jumpPhase,armAngles:[this.rig.leftArm.rotation.x,this.rig.rightArm.rotation.x],legAngles:[this.rig.leftLeg.rotation.x,this.rig.rightLeg.rotation.x],footAngles:[this.rig.leftFoot.rotation.x,this.rig.rightFoot.rotation.x]}}};function Ms(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new K,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=Ns(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=Ns(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function Ns(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new He(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var Ps=`Cape neckline seam`,Fs=`Paired cape throat ties`,Is=[0,1.505,-.17];function Ls(e,t){let n=G.clamp(e,0,1),r=Math.sin(n*Math.PI);return t.set(G.lerp(-Y.attachment.halfWidth,Y.attachment.halfWidth,n),Y.attachment.height+r*Y.attachment.necklineRise,Y.attachment.depth+r*Y.attachment.necklineDepth)}function Rs(e,t){let n=new h;n.name=`Cape neck attachment`;let r=Array.from({length:Y.columns},(e,t)=>Ls(t/(Y.columns-1),new I)),i=new Qe(r,!1,`centripetal`),a=new Be(i,28,.022,7,!1),o=new N(a,e);o.name=Ps;let s=zs(-1),c=zs(1),l=Ms([s,c]);if(s.dispose(),c.dispose(),!l)throw Error(`Unable to merge procedural cape throat ties.`);let u=new N(l,t);return u.name=Fs,n.add(o,u),n}function zs(e){let[t,n,r]=Is,i=new Qe([new I(t+e*.006,n,r),new I(e*.065,1.52,-.045),new I(e*Y.attachment.halfWidth,Y.attachment.height,Y.attachment.depth)],!1,`centripetal`);return new Be(i,10,.008,6,!1)}var Bs=`Traveller face`,Vs=`Fitted helmet shell and cheek guards`,Hs=`Flush helmet brow and temple trim`;function Us(e,t,n){let r=new h;r.name=`Proportioned procedural head`;let i=Gs([Ws(new b(.155,20,14),new I(0,1.69,-.004),new I(.82,1.08,.88)),Ws(new Me(.023,.055,7),new I(0,1.68,-.137),new I(1,1,1),new Fe(-Math.PI/2,0,0)),Ws(new b(.024,8,6),new I(-.118,1.69,-.002),new I(.55,1,.72)),Ws(new b(.024,8,6),new I(.118,1.69,-.002),new I(.55,1,.72))],`face`),a=new N(i,e);a.name=Bs;let o=Gs([Ws(new b(.176,20,14,0,Math.PI*2,0,Math.PI*.47),new I(0,1.72,0),new I(.92,1,.96)),Ws(new Re(.022,.115,4,8),new I(-.14,1.66,-.006),new I(1,1,1.2)),Ws(new Re(.022,.115,4,8),new I(.14,1.66,-.006),new I(1,1,1.2)),Ws(new b(.012,8,6),new I(-.045,1.705,-.143),new I(1.25,.68,.5)),Ws(new b(.012,8,6),new I(.045,1.705,-.143),new I(1.25,.68,.5)),Ws(new ve(.052,.007,.006),new I(0,1.635,-.137))],`helmet shell`),s=new N(o,t);s.name=Vs;let c=Gs([Ws(new ve(.226,.018,.018),new I(0,1.744,-.166)),Ws(new b(.022,8,6),new I(-.145,1.742,-.035),new I(.65,1,1)),Ws(new b(.022,8,6),new I(.145,1.742,-.035),new I(.65,1,1))],`helmet trim`),l=new N(c,n);return l.name=Hs,r.add(a,s,l),r}function Ws(e,t,n=new I(1,1,1),r=new Fe){let i=new je().compose(t,new M().setFromEuler(r),n);return e.applyMatrix4(i),e}function Gs(e,t){let n=Ms(e,!1);if(e.forEach(e=>e.dispose()),!n)throw Error(`Unable to merge procedural ${t} geometry.`);return n.computeBoundingBox(),n.computeBoundingSphere(),n}var Ks=16,qs=[{y:.95,halfWidth:.18,halfDepth:.13},{y:1.12,halfWidth:.19,halfDepth:.137},{y:1.34,halfWidth:.205,halfDepth:.145},{y:1.4,halfWidth:.218,halfDepth:.13},{y:1.46,halfWidth:.165,halfDepth:.105},{y:1.5,halfWidth:.085,halfDepth:.065}];function Js(){let e=[],t=[],n=[];for(let n of qs)for(let r=0;r<=Ks;r+=1){let i=r/Ks,a=i*Math.PI*2;e.push(Math.cos(a)*n.halfWidth,n.y,Math.sin(a)*n.halfDepth),t.push(i,(n.y-qs[0].y)/Xs())}for(let e=0;e<qs.length-1;e+=1){let t=e*17,r=(e+1)*17;for(let e=0;e<Ks;e+=1){let i=t+e,a=r+e;n.push(i,a,i+1,i+1,a,a+1)}}Ys(e,t,n,0,!1),Ys(e,t,n,qs.length-1,!0);let r=new K;return r.setAttribute(`position`,new p(e,3)),r.setAttribute(`uv`,new p(t,2)),r.setIndex(n),r.computeVertexNormals(),r.computeBoundingBox(),r.computeBoundingSphere(),r}function Ys(e,t,n,r,i){let a=qs[r];if(!a)return;let o=e.length/3;e.push(0,a.y,0),t.push(.5,.5);let s=r*17;for(let e=0;e<Ks;e+=1)i?n.push(o,s+e+1,s+e):n.push(o,s+e,s+e+1)}function Xs(){let e=qs[0],t=qs.at(-1);return e&&t?t.y-e.y:1}var Zs=`Tapered torso armor`,Qs=`Fitted hip armor`,$s=`Fitted leather waist strap`,ec=`Visible skin neck`,tc=`Fitted leather gorget`,nc=`Left fitted shoulder armor`,rc=`Right fitted shoulder armor`;function ic(e){e.traverse(e=>{e instanceof N&&(e.castShadow=!0,e.receiveShadow=!0)})}var ac=class{root=new h;velocity=new I;rig=new h;leftArm=new h;rightArm=new h;leftLeg=new h;rightLeg=new h;leftFoot=new h;rightFoot=new h;leftCapeAnchor=new E;rightCapeAnchor=new E;leftAnchorWorld=new I;rightAnchorWorld=new I;backWorld=new I;capeAttachmentBounds=new Ne;capeAnchors={left:this.leftAnchorWorld,right:this.rightAnchorWorld,back:this.backWorld};capeColliderRig={shoulders:this.createCapeCollider(.095,`shoulders`,.008),upperTorso:this.createCapeCollider(.211,`upper torso`,.006,.07,.145),gorget:this.createCapeCollider(.109,`gorget`,.006,.03),hips:this.createCapeCollider(.198,`hips`,.008,.08),belt:this.createCapeCollider(.138,`belt strap`,.006,.04),leftArm:this.createCapeCollider(.095,`left arm`,.008,void 0,.075),rightArm:this.createCapeCollider(.095,`right arm`,.008,void 0,.075),leftThigh:this.createCapeCollider(.085,`left thigh`),leftKnee:this.createCapeCollider(.08,`left knee`),leftLowerLeg:this.createCapeCollider(.075,`left lower leg`),leftBoot:this.createCapeCollider(.095,`left boot`),rightThigh:this.createCapeCollider(.085,`right thigh`),rightKnee:this.createCapeCollider(.08,`right knee`),rightLowerLeg:this.createCapeCollider(.075,`right lower leg`),rightBoot:this.createCapeCollider(.095,`right boot`)};capeColliders=Object.values(this.capeColliderRig);animator=new js({body:this.rig,leftArm:this.leftArm,rightArm:this.rightArm,leftLeg:this.leftLeg,rightLeg:this.rightLeg,leftFoot:this.leftFoot,rightFoot:this.rightFoot});materials=[];capeAttachment;opacity=1;constructor(){this.root.name=`Procedural hero`,this.root.add(this.rig),this.buildBody(),ic(this.root)}updateAnimation(e,t,n=!0,r=0){this.animator.update(e,t,n,r)}getCapeAnchors(){return this.root.updateMatrixWorld(!0),this.leftCapeAnchor.getWorldPosition(this.leftAnchorWorld),this.rightCapeAnchor.getWorldPosition(this.rightAnchorWorld),this.backWorld.set(0,0,1).applyQuaternion(this.root.quaternion).normalize(),this.capeAnchors}getCapeColliders(){let{shoulders:e,upperTorso:t,gorget:n,hips:r,belt:i,leftArm:a,rightArm:o,leftThigh:s,leftKnee:c,leftLowerLeg:l,leftBoot:u,rightThigh:d,rightKnee:f,rightLowerLeg:p,rightBoot:m}=this.capeColliderRig;return this.setWorldCapsule(e,this.rig,[-.195,1.45,-.0115],[.195,1.45,-.0115]),this.setWorldCapsule(t,this.rig,[0,1.33,0],[0,1.11,0]),this.setWorldCapsule(n,this.rig,[0,1.49,0],[0,1.49,0]),this.setWorldCapsule(r,this.rig,[0,1.01,-.068],[0,.77,-.068]),this.setWorldCapsule(i,this.rig,[-.054,1.01,0],[.054,1.01,0]),this.setWorldCapsule(a,this.leftArm,[0,-.02,0],[0,-.69,0]),this.setWorldCapsule(o,this.rightArm,[0,-.02,0],[0,-.69,0]),this.setWorldCapsule(s,this.leftLeg,[0,-.29,0],[0,-.29,0]),this.setWorldCapsule(c,this.leftLeg,[0,-.5,0],[0,-.5,0]),this.setWorldCapsule(l,this.leftLeg,[0,-.69,0],[0,-.69,0]),this.setWorldCapsule(u,this.leftFoot,[0,-.06,-.115],[0,-.06,-.005]),this.setWorldCapsule(d,this.rightLeg,[0,-.29,0],[0,-.29,0]),this.setWorldCapsule(f,this.rightLeg,[0,-.5,0],[0,-.5,0]),this.setWorldCapsule(p,this.rightLeg,[0,-.69,0],[0,-.69,0]),this.setWorldCapsule(m,this.rightFoot,[0,-.06,-.115],[0,-.06,-.005]),this.capeColliders}setOpacity(e){let t=G.clamp(e,gt,1);Math.abs(t-this.opacity)<.002||(this.opacity=t)}getOpacity(){return this.opacity}getAnimationDiagnostics(){return this.animator.getDiagnostics()}getCapeAttachmentDiagnostics(){let e=this.getCapeAnchors();this.capeAttachmentBounds.setFromObject(this.capeAttachment);let t=0;return this.capeAttachment.traverse(e=>{e instanceof N&&(t+=1)}),{meshes:t,maximumAnchorGap:Math.max(this.capeAttachmentBounds.distanceToPoint(e.left),this.capeAttachmentBounds.distanceToPoint(e.right))}}buildBody(){let e=new le({color:2766909,roughness:.38,metalness:.62,clearcoat:.2,clearcoatRoughness:.34}),t=new f({color:1120540,roughness:.46,metalness:.78}),n=new f({color:3416089,roughness:.86,metalness:.02}),r=new f({color:11109967,roughness:.34,metalness:.72}),i=new f({color:2107434,roughness:.94,metalness:0}),a=new f({color:9395010,roughness:.84,metalness:0}),o=new le({color:9701907,roughness:.78,metalness:.01,sheen:.92,sheenColor:new P(7276307),sheenRoughness:.72,side:2});this.materials.push(e,t,n,r,i,a,o);for(let e of this.materials)e.transparent=!1,e.depthWrite=!0;let s=new N(new Re(.18,.17,5,10),e);s.name=Qs,s.position.y=.87,s.scale.z=.72,this.rig.add(s);let c=new N(Js(),e);c.name=Zs,this.rig.add(c);let l=new N(new ot(.21,.178,.39,10,1,!1),t);l.position.set(0,1.255,-.064),l.scale.z=.69,this.rig.add(l);let u=new N(new ot(.19,.19,.06,18,1,!0),n);u.name=$s,u.position.y=1.01,u.scale.z=.72;let d=new N(new ve(.078,.064,.032),r);d.position.set(0,1.01,-.154),this.rig.add(u,d);let p=Us(a,t,r);p.position.y=.018;let m=new N(new ot(.067,.077,.16,12),a);m.name=ec,m.position.y=1.555;let h=new N(new Oe(.132,.019,6,20),n);h.name=tc,h.rotation.x=Math.PI/2,h.position.y=1.49,h.scale.set(1,.68,.76);let g=new N(new b(.032,10,8),r);g.name=`Cape throat clasp`,g.position.fromArray(Is),g.scale.z=.45,this.rig.add(p,m,h,g),this.createArm(this.leftArm,-1,e,t,n),this.createArm(this.rightArm,1,e,t,n),this.createLeg(this.leftLeg,this.leftFoot,-1,i,t),this.createLeg(this.rightLeg,this.rightFoot,1,i,t),this.rig.add(this.leftArm,this.rightArm,this.leftLeg,this.rightLeg);let _=new b(.08,12,8,0,Math.PI*2,0,Math.PI*.62),v=new N(_,e);v.name=nc,v.position.set(-.195,1.445,0),v.scale.set(1.06,.76,1),v.rotation.z=.35;let y=v.clone();y.name=rc,y.position.x=.195,y.rotation.z=-.35,this.rig.add(v,y),this.capeAttachment=Rs(o,r),this.rig.add(this.capeAttachment),this.leftCapeAnchor.position.set(-Y.attachment.halfWidth,Y.attachment.height,Y.attachment.depth),this.rightCapeAnchor.position.set(Y.attachment.halfWidth,Y.attachment.height,Y.attachment.depth),this.rig.add(this.leftCapeAnchor,this.rightCapeAnchor)}createArm(e,t,n,r,i){e.position.set(t*.205,1.405,0),e.rotation.z=t*-.08;let a=new N(new ot(.068,.06,.42,9),i);a.position.y=-.215;let o=new N(new ot(.066,.05,.31,9),n);o.position.y=-.545;let s=new N(new b(.056,9,7),r);s.position.y=-.72,e.add(a,o,s)}createLeg(e,t,n,r,i){e.position.set(n*.095,.79,0);let a=new N(new ot(.085,.074,.42,9),r);a.position.y=-.22;let o=new N(new ot(.074,.056,.4,9),i);o.position.y=-.62;let s=new N(new ve(.13,.13,.25),i);t.position.y=-.8,s.position.set(0,-.06,-.06),t.add(s),e.add(a,o,t)}setWorldCapsule(e,t,n,r){t.localToWorld(e.start.set(...n)),t.localToWorld(e.end.set(...r))}createCapeCollider(e,t,n,r,i){return{start:new I,end:new I,radius:e,depthRadius:i,name:t,clearance:n,faceSampleSpacing:r}}},oc=class{character;input;worldCollision;desiredVelocity=new I;cameraForward=new I;cameraRight=new I;running=!1;grounded=!0;verticalVelocity=0;landingImpactSpeed=0;turnRate=0;constructor(e,t,n){this.character=e,this.input=t,this.worldCollision=n}update(e,t){let n=this.input.getMovement();if(this.cameraForward.set(-Math.sin(t),0,-Math.cos(t)),this.cameraRight.set(Math.cos(t),0,-Math.sin(t)),this.desiredVelocity.set(0,0,0).addScaledVector(this.cameraRight,n.x).addScaledVector(this.cameraForward,n.y),this.running=this.desiredVelocity.lengthSq()>0&&this.input.isRunning(),this.desiredVelocity.lengthSq()>0){let e=this.running?X.runSpeed:X.walkSpeed;this.desiredVelocity.normalize().multiplyScalar(e)}let r=this.desiredVelocity.lengthSq()>0?X.acceleration:X.deceleration,i=1-Math.exp(-r*e);this.character.velocity.x=G.lerp(this.character.velocity.x,this.desiredVelocity.x,i),this.character.velocity.z=G.lerp(this.character.velocity.z,this.desiredVelocity.z,i),this.character.velocity.x*this.character.velocity.x+this.character.velocity.z*this.character.velocity.z<1e-4&&(this.character.velocity.x=0,this.character.velocity.z=0),this.input.consumeJump()&&this.grounded&&(this.verticalVelocity=X.jumpSpeed,this.grounded=!1),this.grounded?this.verticalVelocity=0:this.verticalVelocity-=X.gravity*e,this.character.velocity.y=this.verticalVelocity;let a=this.grounded,o=this.character.root.position.y;this.character.root.position.addScaledVector(this.character.velocity,e);let s=this.worldCollision.resolvePlayer(this.character.root.position,{previousY:o,velocityY:this.verticalVelocity,grounded:this.grounded});this.grounded=s.grounded,!a&&this.grounded&&this.verticalVelocity<0&&(this.landingImpactSpeed=-this.verticalVelocity),(s.grounded&&this.verticalVelocity<0||s.hitCeiling&&this.verticalVelocity>0)&&(this.verticalVelocity=0,this.character.velocity.y=0);let c=Math.hypot(this.character.velocity.x,this.character.velocity.z);if(c>.08){let t=Math.atan2(-this.character.velocity.x,-this.character.velocity.z),n=Math.atan2(Math.sin(t-this.character.root.rotation.y),Math.cos(t-this.character.root.rotation.y)),r=G.smoothstep(c,.08,X.runSpeed),i=G.lerp(X.walkTurnRate,X.runTurnRate,r),a=G.clamp(n*X.turnResponse,-i,i);this.turnRate=ht(this.turnRate,a,G.lerp(7,12,r),e);let o=G.clamp(this.turnRate*e,-Math.abs(n),Math.abs(n)),s=this.character.root.rotation.y+o;this.character.root.rotation.y=Math.atan2(Math.sin(s),Math.cos(s))}else this.turnRate=ht(this.turnRate,0,10,e);this.character.updateAnimation(e,c,this.grounded,this.verticalVelocity)}isRunning(){return this.running}isGrounded(){return this.grounded}consumeLandingImpact(){let e=this.landingImpactSpeed;return this.landingImpactSpeed=0,e}resetVerticalState(){this.grounded=!0,this.verticalVelocity=0,this.landingImpactSpeed=0,this.character.velocity.y=0}},sc=.16,cc=.11,lc=.13;function uc(e,t){return Math.max(Math.abs(e[0]-t[0]),Math.abs(e[1]-t[1]),Math.abs(e[2]-t[2]),Math.abs(e[3]-t[3]))}async function dc(e,t,n){let r=n.getCharacterOpacity(),i=t.getWorldDirection(new I),a=new S(lc,lc),o=new rt({color:2162544,side:2,toneMapped:!1}),s=new rt({color:13639935,side:2,toneMapped:!1}),c=fc(t,i,sc,a,o,1,`Depth audit character-layer marker`),l=fc(t,i,cc,a,s,0,`Depth audit world occluder`);e.add(c);try{n.setCharacterOpacity(0),n.render(0);let t=await n.readScreenCenterPixel();n.setCharacterOpacity(r),n.render(0);let i=await n.readScreenCenterPixel();e.add(l),n.setCharacterOpacity(0),n.render(0);let a=await n.readScreenCenterPixel();n.setCharacterOpacity(r),n.render(0);let o=await n.readScreenCenterPixel();return{visibleWorldPixel:t,visibleLayerPixel:i,occludedWorldPixel:a,occludedLayerPixel:o,visibleLayerDelta:uc(t,i),occludedLayerDelta:uc(a,o),depthComposite:n.getDepthCompositeDiagnostics()}}finally{e.remove(c,l),a.dispose(),o.dispose(),s.dispose(),n.setCharacterOpacity(r),n.render(0)}}function fc(e,t,n,r,i,a,o){let s=new N(r,i);return s.name=o,s.position.copy(e.position).addScaledVector(t,n),s.quaternion.copy(e.quaternion),s.layers.set(a),s.frustumCulled=!1,s.updateMatrixWorld(!0),s}var pc=128,mc=2;async function hc(e){let t=new fe;t.background=new P(328965);let n=new ne(-2.2,2.2,2.2,-2.2,.1,20);n.position.set(4,5,6),n.lookAt(0,0,0),n.updateMatrixWorld(!0);let r=new f({color:12105912,roughness:1,metalness:0}),i=new N(new S(6,6),r);i.name=`Shadow layer probe receiver`,i.rotation.x=-Math.PI/2,i.receiveShadow=!0,i.layers.set(0);let a=new f({color:6316128,roughness:1}),o=new N(new ve(.8,1.2,.8),a);o.name=`Shadow layer probe caster`,o.position.y=.6,o.castShadow=!0,o.layers.set(1),aa(o,e instanceof Wi?`webgl`:`webgpu`);let s=new ze(16777215,.08),c=new k(16777215,3.4);c.position.set(-3,6,3),c.target.position.set(0,0,0),c.castShadow=!0,c.shadow.mapSize.set(512,512),c.shadow.camera.left=-4,c.shadow.camera.right=4,c.shadow.camera.top=4,c.shadow.camera.bottom=-4,c.shadow.camera.near=.1,c.shadow.camera.far=14,c.shadow.camera.layers.enable(1),c.shadow.bias=-2e-4,c.shadow.normalBias=.015,t.add(i,o,s,c,c.target),t.updateMatrixWorld(!0);let l=e instanceof Wi?new nt(pc,pc,{type:Ue,depthBuffer:!0,stencilBuffer:!1}):new R(pc,pc,{type:Ue,depthBuffer:!0,stencilBuffer:!1}),u=(e instanceof Wi,e.getRenderTarget()),d=e.shadowMap.enabled,p=e.getClearAlpha(),m=e.getClearColor(new P).clone(),h=new I(.5,.001,-.5),g=new I(-1.1,.001,.9);try{e.shadowMap.enabled=!0;let r=await gc(e,t,n,l,h,g,!0),i=await gc(e,t,n,l,h,g,!1);n.position.set(4,5,-6),n.lookAt(0,0,0),n.updateMatrixWorld(!0);let a=await gc(e,t,n,l,h,g,!1);return{direct:r,isolated:i,secondAngle:a,contrastDelta:Math.abs(r.contrast-i.contrast),angleContrastDelta:Math.abs(i.contrast-a.contrast)}}finally{yc(e,u),e.shadowMap.enabled=d,e.setClearColor(m,p),l.dispose(),i.geometry.dispose(),o.geometry.dispose(),r.dispose(),a.dispose(),c.dispose()}}async function gc(e,t,n,r,i,a,o){n.layers.set(0),o&&n.layers.enable(1),yc(e,r),e.setClearColor(328965,1),e.clear(!0,!0,!1),e.render(t,n);let s=await _c(e,r,n,i),c=await _c(e,r,n,a);return{shadowPixel:s,litPixel:c,contrast:bc(c)-bc(s)}}async function _c(e,t,n,r){let i=r.clone().project(n),a=G.clamp(Math.round((i.x*.5+.5)*127),mc,125),o=G.clamp(vc(i.y,pc,e.coordinateSystem),mc,125),s=e instanceof Wi?await e.readRenderTargetPixelsAsync(t,a-mc,o-mc,5,5,new Uint8Array(100)):await e.readRenderTargetPixelsAsync(t,a-mc,o-mc,5,5),c=0,l=0,u=0,d=0;for(let e=0;e<s.length;e+=4)c+=s[e]??0,l+=s[e+1]??0,u+=s[e+2]??0,d+=s[e+3]??0;return[Math.round(c/25),Math.round(l/25),Math.round(u/25),Math.round(d/25)]}function vc(e,t,n){let r=e*.5+.5,i=n===2001?1-r:r;return Math.round(i*(t-1))}function yc(e,t){if(e instanceof Wi){e.setRenderTarget(t);return}e.setRenderTarget(t)}function bc(e){return e[0]*.2126+e[1]*.7152+e[2]*.0722}var xc=class{root;bar;status;constructor(){this.root=sa(document.querySelector(`[data-loading]`),`Loading screen is missing.`),this.bar=sa(document.querySelector(`[data-loading-bar]`),`Loading bar is missing.`),this.status=sa(document.querySelector(`[data-loading-status]`),`Loading status is missing.`)}async update(e,t){this.bar.style.width=`${Math.round(e*100)}%`,this.status.textContent=t,await new Promise(e=>requestAnimationFrame(()=>e()))}async reveal(){await this.update(1,`Enter the deep`),document.body.classList.add(`is-ready`)}fail(){this.root.classList.add(`has-error`),this.status.textContent=`Graphics initialization failed — see console for details`}},Sc=Object.freeze({...us,lights:!0,shadows:!0,reflections:!0}),Cc=[`length`,`width`,`stiffness`,`damping`,`weight`],wc=[`lights`,`shadows`,`reflections`],Tc=class{onChange;root;panel;toggle;resetButton;status;numericInputs=new Map;toggleInputs=new Map;outputElements=new Map;settings={...Sc};constructor(e){this.onChange=e,this.root=sa(document.querySelector(`[data-customization]`),`Customization panel is missing.`),this.panel=sa(this.root.querySelector(`[data-customization-panel]`),`Customization panel content is missing.`),this.toggle=sa(this.root.querySelector(`[data-customization-toggle]`),`Customization panel toggle is missing.`),this.resetButton=sa(this.root.querySelector(`[data-customization-reset]`),`Customization reset button is missing.`),this.status=sa(this.root.querySelector(`[data-customization-status]`),`Customization status is missing.`);for(let e of Cc){let t=sa(this.root.querySelector(`[data-customization-setting="${e}"]`),`Customization input ${e} is missing.`),n=sa(this.root.querySelector(`[data-customization-value="${e}"]`),`Customization output ${e} is missing.`),r=ls[e];t.min=String(r.min),t.max=String(r.max),t.step=String(r.step),t.addEventListener(`input`,this.handleNumericInput),(e===`length`||e===`width`)&&t.addEventListener(`change`,this.handleDimensionCommit),this.numericInputs.set(e,t),this.outputElements.set(e,n)}for(let e of wc){let t=sa(this.root.querySelector(`[data-customization-setting="${e}"]`),`Customization switch ${e} is missing.`);t.addEventListener(`change`,this.handleToggleInput),this.toggleInputs.set(e,t)}this.toggle.addEventListener(`click`,this.handlePanelToggle),this.resetButton.addEventListener(`click`,this.handleReset),this.syncControls();let t=window.matchMedia(`(max-width: 900px), (pointer: coarse)`).matches;this.setExpanded(!t)}getSettings(){return{...this.settings}}dispose(){this.numericInputs.forEach(e=>{e.removeEventListener(`input`,this.handleNumericInput),e.removeEventListener(`change`,this.handleDimensionCommit)}),this.toggleInputs.forEach(e=>{e.removeEventListener(`change`,this.handleToggleInput)}),this.toggle.removeEventListener(`click`,this.handlePanelToggle),this.resetButton.removeEventListener(`click`,this.handleReset)}handleNumericInput=e=>{let t=e.currentTarget,n=t.dataset.customizationSetting,r=fs({...this.settings,[n]:t.valueAsNumber});this.settings={...this.settings,...r},this.updateOutput(n),this.status.textContent=`Custom settings active`,this.emitChange()};handleDimensionCommit=()=>{this.emitChange(!0)};handleToggleInput=e=>{let t=e.currentTarget,n=t.dataset.customizationSetting;this.settings={...this.settings,[n]:t.checked},this.status.textContent=`Custom settings active`,this.emitChange()};handlePanelToggle=()=>{this.setExpanded(this.toggle.getAttribute(`aria-expanded`)!==`true`)};handleReset=()=>{this.settings={...Sc},this.syncControls(),this.status.textContent=`Defaults restored`,this.emitChange(!0)};emitChange(e=!1){this.onChange({...this.settings},e)}syncControls(){this.numericInputs.forEach((e,t)=>{e.value=String(this.settings[t]),this.updateOutput(t)}),this.toggleInputs.forEach((e,t)=>{e.checked=this.settings[t]})}updateOutput(e){let t=this.outputElements.get(e);if(!t)return;let n=this.settings[e];t.value=e===`length`||e===`width`?`${n.toFixed(2)} m`:`${n.toFixed(2)}×`}setExpanded(e){this.root.classList.toggle(`is-collapsed`,!e),this.toggle.setAttribute(`aria-expanded`,String(e)),this.toggle.setAttribute(`aria-label`,e?`Collapse cape customization`:`Expand cape customization`),this.panel.hidden=!e}},Ec=class{environment;root;buttons;constructor(e,t,n={location:window.location}){this.environment=n,this.root=sa(document.querySelector(`[data-renderer-switch]`),`Renderer switch is missing.`),this.buttons=Array.from(this.root.querySelectorAll(`[data-renderer-option]`));let r=this.buttons.find(e=>e.dataset.rendererOption===`webgpu`);r&&!t&&(r.disabled=!0,r.title=`WebGPU is not available in this browser`),this.setActive(e,e);for(let e of this.buttons)e.addEventListener(`click`,this.handleSelection)}setActive(e,t){this.root.dataset.rendererBackend=e,this.root.dataset.rendererFallback=String(e!==t);for(let t of this.buttons){let n=t.dataset.rendererOption===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-pressed`,String(n))}this.root.title=e===t?e===`webgpu`?`Experimental WebGPU renderer active; WebGL is recommended`:`WebGL renderer active (recommended)`:`WebGPU was requested but unavailable; WebGL is active`}dispose(){for(let e of this.buttons)e.removeEventListener(`click`,this.handleSelection)}handleSelection=e=>{let t=e.currentTarget,n=t.dataset.rendererOption;n!==`webgpu`&&n!==`webgl`||t.disabled||this.environment.location.replace(Xa(this.environment.location.href,n))}},Dc=`
  uniform float uTime;
...
`,kc=class{points;material;constructor(){let e=new yt(53335),t=new Float32Array(1860),n=new Float32Array(620),r=new Float32Array(620);for(let i=0;i<620;i+=1){let a=e.range(Et.endZ,Et.startZ),o=vt(a)+e.range(-1,1)*xt(a)*.83;t[i*3]=o,t[i*3+1]=e.range(.25,Ct(a)*.92),t[i*3+2]=a,n[i]=e.range(0,Math.PI*2),r[i]=e.range(.45,1.15)}let i=new K;i.setAttribute(`position`,new He(t,3)),i.setAttribute(`aPhase`,new He(n,1)),i.setAttribute(`aSize`,new He(r,1)),this.material=new g({uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)}},vertexShader:Dc,fragmentShader:Oc,transparent:!0,depthWrite:!1,blending:2}),this.points=new ut(i,this.material),this.points.name=`Suspended cave dust`,this.points.frustumCulled=!1}update(e){this.material.uniforms.uTime.value=e}resize(){this.material.uniforms.uPixelRatio.value=Math.min(window.devicePixelRatio,2)}};function Ac(e){let t=new yt(e),n=[],r=[],i=[],a=Math.abs(e)%3,o=Array.from({length:10},()=>t.range(-.11,.11)),s=t.range(0,Math.PI*2),c=t.range(0,Math.PI*2),l=t.range(.1,.22),u=t.range(.08,.19),d=a===1?t.range(1.4,1.85):t.range(.76,1.28),f=e=>[(Math.sin(e*3.4+s)-Math.sin(s))*l*e+Math.sin(e*8.7+c)*.018*e,(Math.sin(e*2.8+c)-Math.sin(c))*u*e+Math.cos(e*7.3+s)*.016*e];for(let e=0;e<9;e+=1){let i=e/9,l=a===2?.58:.74,u=(1-i)**l,p=Math.exp(-(((i-.3)/.12)**2))*(a===0?.26:.13),m=Math.exp(-(((i-.58)/.09)**2))*(a===2?.22:.1),h=Math.exp(-(((i-.46)/.075)**2))*.1,g=1+Math.sin(i*17+s)*.105+Math.sin(i*31+c)*.045+t.range(-.055,.055),_=1+Math.exp(-i*8)*.3,v=Math.max(.025,.32*u*g*_*(1+p+m-h)),[y,b]=f(i),x=i*t.range(-.45,.45);for(let e=0;e<=10;e+=1){let t=e%10,a=e/10*Math.PI*2+x,c=1+(o[t]??0)+Math.sin(a*3+i*9+s)*.035;n.push(y+Math.cos(a)*v*d*c,-1.6*i,b+Math.sin(a)*v/d*c),r.push(e/10,i)}}for(let e=0;e<8;e+=1)for(let t=0;t<10;t+=1){let n=e*11+t,r=n+11;i.push(n,n+1,r,r,n+1,r+1)}let[m,h]=f(1),g=n.length/3;n.push(m,-1.6,h),r.push(.5,1);for(let e=0;e<10;e+=1)i.push(88+e,88+e+1,g);let _=n.length/3;n.push(0,0,0),r.push(.5,0);for(let e=0;e<10;e+=1)i.push(_,e+1,e);let v=new K;return v.setAttribute(`position`,new p(n,3)),v.setAttribute(`uv`,new p(r,2)),v.setIndex(i),v.computeVertexNormals(),v.computeBoundingSphere(),v}var jc=.14,Mc=.012,Nc=class{colliders=[];localVertex=new I;worldVertex=new I;sampleCenter=new I;addSpeleothem(e,t){let n=e.getAttribute(`position`);if(!n)throw Error(`Speleothem collision geometry has no positions.`);let r=[];for(let e=0;e<9;e+=1){let i=new I;for(let t=0;t<10;t+=1){let r=e*11+t;this.localVertex.fromBufferAttribute(n,r),i.add(this.localVertex)}i.multiplyScalar(1/10).applyMatrix4(t);let a=0;for(let r=0;r<10;r+=1){let o=e*11+r;this.worldVertex.fromBufferAttribute(n,o).applyMatrix4(t),a=Math.max(a,this.worldVertex.distanceTo(i))}r.push({center:i,radius:a})}let i=new I().fromBufferAttribute(n,99).applyMatrix4(t);r.push({center:i,radius:0}),this.addFormationSections(r)}addCollar(e,t){this.addSphere(e,.38*Math.max(t.x,t.z),!1,`formation`)}addRock(e,t,n=!0){this.colliders.push(Eo(e,t,n))}addFormationSections(e){for(let t=0;t<e.length-1;t+=1){let n=e[t],r=e[t+1];if(!n||!r)continue;let i=n.center.distanceTo(r.center),a=Math.max(1,Math.ceil(i/jc)),o=i/a*.5,s=Math.abs(r.radius-n.radius)/a*.5,c=Math.hypot(o,s)+Mc,l=t===0?0:1;for(let e=l;e<=a;e+=1){let t=e/a;this.sampleCenter.lerpVectors(n.center,r.center,t),this.addSphere(this.sampleCenter,G.lerp(n.radius,r.radius,t)+c,!1,`formation`)}}}addSphere(e,t,n,r){this.colliders.push({center:e.clone(),radius:t,walkable:n,kind:r})}},Pc=.42,Fc=X.radius+.42,Ic=.08;X.radius*2+.25;var Lc=[{size:`large`,z:3.1,lateralOffset:-.82,scale:[1.65,1.35,1.05],rotation:[.16,.48,-.1],embedDepth:.08},{size:`small`,z:1.2,lateralOffset:.44,scale:[.55,.48,.62],rotation:[-.08,1.12,.2],embedDepth:.035},{size:`large`,z:-.9,lateralOffset:.94,scale:[1.12,1.05,.78],rotation:[.24,2.08,-.14],embedDepth:.065},{size:`small`,z:-2.9,lateralOffset:-.4,scale:[.48,.38,.7],rotation:[.12,2.72,.08],embedDepth:.03},{size:`large`,z:-5,lateralOffset:-.98,scale:[1.38,1.08,1.48],rotation:[-.18,.86,.14],embedDepth:.075},{size:`small`,z:-6.8,lateralOffset:.5,scale:[.64,.46,.52],rotation:[.18,1.66,-.16],embedDepth:.035}];function Rc(e){return vt(e.z)+e.lateralOffset}function zc(e){let t=xt(e.z)-Fc,n=Pc*Math.max(...e.scale)+X.radius+Ic,r=t+e.lateralOffset-n,i=t-e.lateralOffset-n;return Math.max(r,i)}var Bc=10,Vc=-.2,Hc=.07,Uc=.3;function Wc(){let e=[...Gc(Vc,1,0,0),...Gc(Hc,.78,.018,-.012),...Gc(Uc,.28,.034,-.022),new I(0,Vc,0),new I(.034,Uc,-.022)],t=[];for(let e=0;e<Bc;e+=1){let n=(e+1)%Bc,r=Bc+e,i=Bc+n,a=20+e,o=20+n;t.push([e,n,i],[e,i,r],[r,i,o],[r,o,a],[30,n,e],[31,a,o])}let n=e.reduce((e,t)=>e.add(t),new I).multiplyScalar(1/e.length),r=[],i=[],a=new I,o=new I,s=new I,c=new I;for(let l of t){let[t,u,d]=l,f=e[t],p=e[u],m=e[d];if(!(!f||!p||!m)){if(s.crossVectors(a.copy(p).sub(f),o.copy(m).sub(f)),c.copy(f).add(p).add(m).multiplyScalar(1/3),s.dot(c.sub(n))<0){let t=u;if(u=d,d=t,p=e[u],m=e[d],!p||!m)continue}for(let e of[f,p,m])r.push(e.x,e.y,e.z),i.push(.5+Math.atan2(e.z,e.x)/(Math.PI*2),G.inverseLerp(Vc,Uc,e.y))}}let l=new K;return l.setAttribute(`position`,new p(r,3)),l.setAttribute(`uv`,new p(i,2)),l.computeVertexNormals(),l.computeBoundingBox(),l.computeBoundingSphere(),l.name=`Deterministic grounded irregular rock`,l}function Gc(e,t,n,r){return Array.from({length:Bc},(i,a)=>{let o=a/Bc*Math.PI*2,s=Math.cos(o),c=Math.sin(o);return new I((s*.44+c*.025)*t+n,e,(c*.36-s*.018)*t+r)})}var Kc=class{group=new h;worldColliders;contactRocks;walls;floor;colliderBuilder=new Nc;constructor(e){this.group.name=`Procedural cave`,this.walls=this.createWalls(e),this.floor=this.createFloor(e),this.group.add(this.walls,this.floor),this.createFormations(e),this.contactRocks=this.createRockScatter(e),this.worldColliders=this.colliderBuilder.colliders}createMaterial(e,t=!1){return new f({map:e.color,normalMap:e.normal,normalScale:new U(t?.72:1.05,t?.72:1.05),roughnessMap:e.roughness,roughness:t?.58:.91,metalness:t?.08:.015,color:t?6779246:8092531})}createWalls(e){let t=[],n=[],r=[],{segments:i,radialSegments:a,startZ:o,endZ:s}=Et;for(let e=0;e<=i;e+=1){let r=e/i,c=G.lerp(o,s,r),l=vt(c),u=Ct(c),d=u*.5-.25,f=u*.5+.45,p=xt(c);for(let e=0;e<=a;e+=1){let i=e/a,o=i*Math.PI*2,s=_t(r*11.5,i*8,8,30767)-.5,u=Math.sin(c*.42+o*5)*.12,m=s*.72+u,h=Math.cos(o),g=Math.sin(o);t.push(l+h*(p+m),d+g*(f+m*.66),c),n.push(i*4,r*16)}}let c=a+1;for(let e=0;e<i;e+=1)for(let t=0;t<a;t+=1){let n=e*c+t,i=n+c;r.push(n,i,n+1,i,i+1,n+1)}let l=new K;l.setAttribute(`position`,new p(t,3)),l.setAttribute(`uv`,new p(n,2)),l.setIndex(r),l.computeVertexNormals(),l.computeBoundingSphere();let u=this.createMaterial(e);u.side=1,u.normalScale.set(-1.05,-1.05);let d=new N(l,u);return d.name=`Cave shell`,d.receiveShadow=!0,d}createFloor(e){let t=[],n=[],r=[];for(let e=0;e<=180;e+=1){let r=e/180,i=G.lerp(Et.startZ,Et.endZ,r),a=vt(i),o=xt(i)*1.015;for(let e=0;e<=36;e+=1){let s=e/36,c=a+(s*2-1)*o;t.push(c,pt(c,i),i),n.push(s*5,r*18)}}for(let e=0;e<180;e+=1)for(let t=0;t<36;t+=1){let n=e*37+t,i=n+37;r.push(n,n+1,i,i,n+1,i+1)}let i=new K;i.setAttribute(`position`,new p(t,3)),i.setAttribute(`uv`,new p(n,2)),i.setIndex(r),i.computeVertexNormals(),i.computeBoundingSphere();let a=new N(i,this.createMaterial(e,!0));return a.name=`Wet cave floor`,a.receiveShadow=!0,a}createFormations(e){let t=new yt(379422),n=this.createMaterial(e,!0);n.color.multiplyScalar(.66),n.roughness=.86,n.metalness=.015;let r=[20897,20898,20899].map(Ac),i=r.map((e,t)=>{let r=new me(e,n,18);return r.name=`Stalactites organic variant ${t+1}`,r.castShadow=!0,r.receiveShadow=!0,r}),a=new Le(.38,1),o=new me(a,n,82);o.name=`Flowstone formation collars`,o.castShadow=!0,o.receiveShadow=!0;let s=new je,c=new M,l=new I,u=new I,d=new I,f=new I;for(let e=0;e<54;e+=1){let n=t.range(Et.endZ+2,Et.startZ-2),a=t.range(-.92,.92),p=vt(n)+xt(n)*a;u.set(p,Ct(n)-Math.abs(a)*.65,n),c.setFromEuler(new Fe(t.range(-.12,.12),t.range(0,Math.PI),t.range(-.12,.12))),l.set(t.range(.55,1.6),t.range(.55,2.25),t.range(.55,1.6)),s.compose(u,c,l);let m=e%i.length;this.colliderBuilder.addSpeleothem(r[m],s),i[m]?.setMatrixAt(Math.floor(e/i.length),s),d.copy(u),d.y-=.08,f.set(l.x*t.range(.9,1.35),t.range(.2,.38),l.z*t.range(.9,1.35)),s.compose(d,c,f),o.setMatrixAt(e,s),this.colliderBuilder.addCollar(d,f)}i.forEach(e=>{e.instanceMatrix.needsUpdate=!0,this.group.add(e)});let p=[10,9,9],m=r.map(e=>{let t=e.clone();return t.rotateZ(Math.PI),t}),h=m.map((e,t)=>{let r=new me(e,n,p[t]??0);return r.name=`Stalagmites organic variant ${t+1}`,r.castShadow=!0,r.receiveShadow=!0,r}),g=[0,0,0];for(let e=0;e<28;e+=1){let n=t.range(Et.endZ+2,Et.startZ-2),r=t.next()>.5?1:-1,i=vt(n)+r*xt(n)*t.range(.7,.94);u.set(i,pt(i,n),n),c.setFromEuler(new Fe(t.range(-.08,.08),t.range(0,Math.PI),t.range(-.08,.08))),l.set(t.range(.55,1.35),t.range(.45,1.75),t.range(.55,1.35)),s.compose(u,c,l);let a=e%h.length;this.colliderBuilder.addSpeleothem(m[a],s);let p=g[a]??0;h[a]?.setMatrixAt(p,s),g[a]=p+1,d.copy(u),d.y+=.06,f.set(l.x*t.range(.86,1.25),t.range(.18,.34),l.z*t.range(.86,1.25)),s.compose(d,c,f),o.setMatrixAt(54+e,s),this.colliderBuilder.addCollar(d,f)}h.forEach(e=>{e.instanceMatrix.needsUpdate=!0,this.group.add(e)}),o.instanceMatrix.needsUpdate=!0,this.group.add(o)}createRockScatter(e){let t=new yt(11541991),n=Wc(),r=this.createMaterial(e,!0);r.color.multiplyScalar(.66),r.roughness=.84,r.metalness=.02;let i=new me(n,r,72+Lc.length);i.name=`Rock scatter and cape contact course`,i.castShadow=!0,i.receiveShadow=!0;let a=new je,o=new M,s=new I,c=new I,l=new I,u=n.getAttribute(`position`),d=[];for(let e=0;e<Lc.length;e+=1){let t=Lc[e];if(!t)continue;let r=Rc(t);o.setFromEuler(new Fe(...t.rotation)),s.fromArray(t.scale),c.set(r,0,t.z),a.compose(c,o,s);let f=1/0;for(let e=0;e<u.count;e+=1)l.fromBufferAttribute(u,e).applyMatrix4(a),f=Math.min(f,l.y);c.y=pt(r,t.z)-f-t.embedDepth,a.compose(c,o,s),i.setMatrixAt(e,a);let p=t.size===`small`;this.colliderBuilder.addRock(n,a,p),d.push({size:t.size,walkable:p,position:[c.x,c.y,c.z],lateralOffset:t.lateralOffset,scale:t.scale,openLaneWidth:zc(t)})}for(let e=0;e<72;e+=1){let r=t.range(Et.endZ+1.5,Et.startZ-1.5),d=t.next()>.5?1:-1,f=vt(r)+d*xt(r)*t.range(.64,.94);c.set(f,0,r),o.setFromEuler(new Fe(t.range(-.2,.2),t.range(0,Math.PI*2),t.range(-.2,.2))),s.set(t.range(.25,1.25),t.range(.18,.72),t.range(.35,1.4)),a.compose(c,o,s);let p=1/0;for(let e=0;e<u.count;e+=1)l.fromBufferAttribute(u,e).applyMatrix4(a),p=Math.min(p,l.y);c.y=pt(f,r)-p-t.range(.025,.065),a.compose(c,o,s),i.setMatrixAt(Lc.length+e,a),this.colliderBuilder.addRock(n,a)}return i.instanceMatrix.needsUpdate=!0,this.group.add(i),d}},qc=class{lights;selectedIndices;selectedDistances;constructor(e,t){this.lights=Array.from({length:e},(e,n)=>{let r=new ie(16777215,0,1,2);return r.name=`${t} pooled light ${n+1}`,r}),this.selectedIndices=new Int32Array(e),this.selectedDistances=new Float64Array(e)}update(e,t){this.selectedIndices.fill(-1),this.selectedDistances.fill(1/0);for(let n=0;n<t.length;n+=1){let r=t[n];if(!r)continue;let i=r.position.distanceToSquared(e);for(let e=0;e<this.lights.length;e+=1)if(!(i>=(this.selectedDistances[e]??1/0))){for(let t=this.lights.length-1;t>e;--t)this.selectedIndices[t]=this.selectedIndices[t-1]??-1,this.selectedDistances[t]=this.selectedDistances[t-1]??1/0;this.selectedIndices[e]=n,this.selectedDistances[e]=i;break}}this.lights.forEach((n,r)=>{let i=this.selectedIndices[r]??-1,a=i>=0?t[i]:void 0;if(!a){n.position.copy(e),n.intensity=0;return}let o=Math.sqrt(this.selectedDistances[r]??0),s=a.range*.68,c=Math.max(.001,a.range-s),l=G.clamp((o-s)/c,0,1),u=1-l*l*(3-2*l);n.position.copy(a.position),n.color.copy(a.color),n.distance=a.range,n.intensity=a.intensity*u})}getDiagnostics(){return{lights:this.lights.length,visibleLights:this.lights.filter(e=>e.visible).length,activeLights:this.lights.filter(e=>e.intensity>.001).length}}},Jc=class{group=new h;worldColliders=[];clusters=[];lightPool=new qc(2,`Mineral`);constructor(){this.group.name=`Glowing mineral veins`,[{z:1,side:-1,color:4386769},{z:-22,side:1,color:7393279},{z:-43,side:-1,color:10586111},{z:-61,side:1,color:4843202}].forEach((e,t)=>this.createCluster(e.z,e.side,e.color,t)),this.group.add(...this.lightPool.lights)}update(e,t){for(let t of this.clusters)t.intensity=8.5+Math.sin(e*1.3+t.phase)*.65;this.lightPool.update(t,this.clusters)}getClusterPositions(){return this.clusters.map(e=>e.root.toArray())}getLightDiagnostics(){return this.lightPool.getDiagnostics()}createCluster(e,t,n,r){let i=new yt(49833+r*991),a=vt(e)+t*(xt(e)-.48),o=new I(a,i.range(2.1,4.2),e),s=new P(n),c=new f({color:s,emissive:s,emissiveIntensity:5.5,roughness:.23,metalness:.34}),l=new rt({color:s,transparent:!0,opacity:.12,blending:2,depthWrite:!1,side:2}),u=[],d=[];for(let n=0;n<8;n+=1){let a=[o.clone()],s=i.range(-1,1),c=i.range(-1,1),l=i.range(1.1,3),f=i.integer(3,5);for(let i=1;i<=f;i+=1){let u=i/f,d=e+c*l*u+Math.sin(u*7+n)*.14,p=o.y+s*l*u+Math.sin(u*5+r)*.18,m=vt(d)+t*(xt(d)-.46-Math.sin(u*Math.PI)*.08);a.push(new I(m,p,d))}let p=new Qe(a),m=i.range(.018,.045)*(1-n/8*.38);u.push(new Be(p,18,m,5,!1)),d.push(new Be(p,14,m*3.2,5,!1))}let p=Ms(u,!1),m=Ms(d,!1);if(!p||!m)throw Error(`Unable to merge procedural mineral branches.`);let h=new N(p,c);h.name=`Mineral vein core ${r}`;let g=new N(m,l);g.name=`Mineral vein glow ${r}`,this.group.add(g,h),u.forEach(e=>e.dispose()),d.forEach(e=>e.dispose());let _=new O(.11,0),v=new me(_,c,18),y=new je,b=new M,x=new I,S=new I;for(let n=0;n<v.count;n+=1)S.set(a-t*i.range(0,.14),o.y+i.range(-1.8,1.8),e+i.range(-2.1,2.1)),b.setFromEuler(new Fe(i.range(0,Math.PI),i.range(0,Math.PI),i.range(0,Math.PI))),x.set(i.range(.45,1.6),i.range(.8,2.9),i.range(.45,1.2)),y.compose(S,b,x),v.setMatrixAt(n,y),this.worldColliders.push({center:S.clone(),radius:G.clamp(.11*Math.max(x.x,x.y,x.z),.07,.34),walkable:!1,kind:`mineral`});v.instanceMatrix.needsUpdate=!0,this.group.add(v);let C=o.clone().add(new I(-t*.65,0,0));this.clusters.push({root:o,position:C,color:s,intensity:9,range:7.5,phase:i.range(0,Math.PI*2)})}},Yc=`
  uniform float uTime;
...
`,Zc=class{group=new h;worldColliders=[];torches=[];lightPool=new qc(3,`Torch`);shadowLight;activeShadowTorch=-1;constructor(){this.group.name=`Torch lights`;let e=new yt(461508);[11,-2,-15,-29,-43,-57,-68].forEach((t,n)=>this.createTorch(t,n%2==0?-1:1,e)),this.group.add(...this.lightPool.lights),this.shadowLight=new Ke(16756826,72,12,.86,.82,1.7),this.shadowLight.name=`Nearest torch shadow proxy`,this.shadowLight.castShadow=!0,this.shadowLight.shadow.mapSize.set(1024,1024),this.shadowLight.shadow.camera.near=.25,this.shadowLight.shadow.camera.far=12,this.shadowLight.shadow.bias=-16e-5,this.shadowLight.shadow.normalBias=.035,this.group.add(this.shadowLight,this.shadowLight.target)}update(e,t){let n=0,r=1/0;this.torches.forEach((i,a)=>{let o=i.position.distanceTo(t);o<r&&(r=o,n=a);let s=1+Math.sin(e*11.3+i.phase)*.055+Math.sin(e*17.7+i.phase*2.2)*.028;i.intensity=22*s,i.flame.scale.y=s,i.flame.material.uniforms.uTime.value=e}),this.lightPool.update(t,this.torches);let i=this.torches[n];i&&(n!==this.activeShadowTorch&&(this.activeShadowTorch=n,this.shadowLight.position.copy(i.position),this.shadowLight.target.position.copy(i.position).addScaledVector(i.inward,3.1).setY(pt(i.position.x,i.position.z)+.65),this.shadowLight.shadow.needsUpdate=!0),this.shadowLight.intensity=r<13?64+Math.sin(e*12.1)*4:0)}getLightDiagnostics(){return this.lightPool.getDiagnostics()}getShadowDiagnostics(){let e=this.shadowLight.position,t=this.shadowLight.target.position;return{activeTorch:this.activeShadowTorch,enabled:this.shadowLight.castShadow&&this.shadowLight.intensity>0,intensity:this.shadowLight.intensity,position:[e.x,e.y,e.z],target:[t.x,t.y,t.z],mapSize:[this.shadowLight.shadow.mapSize.x,this.shadowLight.shadow.mapSize.y]}}createTorch(e,t,n){let r=new h,i=vt(e)+t*(xt(e)-.48),a=pt(i,e)+n.range(1.62,2.15);r.position.set(i,a,e);let o=new I(-t,-.18,0).normalize();r.rotation.z=t*-.15;let s=new f({color:2104087,roughness:.48,metalness:.82}),c=new f({color:3282699,roughness:.9,metalness:.02}),l=new N(new ot(.055,.08,.82,7),c);l.castShadow=!0;let u=new N(new Oe(.105,.026,6,12),s);u.rotation.x=Math.PI/2,u.position.y=.37;let d=new N(new ot(.035,.035,.54,6),s);d.rotation.z=Math.PI/2,d.position.set(t*.22,-.18,0),r.add(l,u,d);let p=new g({uniforms:{uTime:{value:0},uPhase:{value:n.range(0,Math.PI*2)}},vertexShader:Yc,fragmentShader:Xc,transparent:!0,blending:2,depthWrite:!1,side:2}),m=new N(new b(.15,9,12),p);m.scale.set(.72,1.8,.72),m.position.y=.57,r.add(m),r.updateMatrixWorld(!0);let _=new I,v=new I,y=(e,t,n)=>{_.set(e,t,0),r.localToWorld(v.copy(_)),this.worldColliders.push({center:v.clone(),radius:n,walkable:!1,kind:`torch`})};for(let e of[-.41,-.205,0,.205,.41])y(0,e,.112);for(let e of[-.27,-.135,0,.135,.27])y(t*.22+e,-.18,.104);y(0,.37,.145);let x=new I(i,a+.58,e);this.group.add(r),this.torches.push({root:r,flame:m,position:x,inward:o,phase:n.range(0,Math.PI*2),color:new P(16753230),intensity:22,range:9.5})}},Qc=.12,$c=.55,el=`
