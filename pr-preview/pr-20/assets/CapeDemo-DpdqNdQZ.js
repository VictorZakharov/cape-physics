const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGpuRenderPipeline-7Y2qDAYz.js","assets/three.core-ChQ02iEs.js","assets/three.webgpu-BWV4PpD4.js","assets/three.tsl-ClZ3685B.js","assets/WebGpuTorchSystem-D8fmWzTy.js","assets/caveProfile-DYEEDk2Z.js","assets/WebGpuWaterSystem-C5y-NAWw.js","assets/WebGpuCaveAtmosphere-BWPAgEhf.js","assets/GpuCapeSimulation-COYMe-8P.js","assets/WebGpuCinematicLighting-475YKmAy.js"])))=>i.map(i=>d[i]);
import{t as e}from"./index-BH1-g0g0.js";import{$i as t,$r as n,$s as r,As as i,At as a,B as o,Bt as s,Co as c,Dr as l,Ds as u,Fo as d,Fr as f,Fs as p,Gi as m,Gn as h,Gs as g,Hs as _,Ht as v,I as y,Is as b,J as x,Jr as S,Kr as C,Li as w,Mr as T,Ms as E,Mt as D,Nn as O,Nr as k,Nt as ee,Pi as A,Pn as te,Ps as j,Pt as M,Q as ne,Qr as re,Qs as N,Qt as ie,R as ae,So as oe,Ts as se,Us as ce,V as P,Vt as le,Wt as F,Xi as I,Y as ue,Yi as de,Yr as fe,Zi as pe,Zr as L,_i as me,_r as he,ai as R,as as ge,ba as _e,bo as ve,cc as ye,cn as be,cs as xe,ct as Se,d as Ce,dc as we,do as Te,ec as Ee,ei as De,eo as Oe,et as z,fs as ke,ft as Ae,gi as je,gn as B,gs as Me,gt as Ne,ic as Pe,jn as V,jr as Fe,js as Ie,ks as Le,li as Re,ln as H,lo as U,ma as ze,mn as Be,mo as Ve,na as He,nc as Ue,no as We,nt as W,oc as Ge,oi as Ke,pi as qe,pn as G,pt as Je,qt as Ye,sc as Xe,sn as Ze,so as Qe,ta as $e,tc as K,ti as et,to as tt,ua as nt,uc as q,ur as rt,us as it,vs as at,ws as ot,xa as st,xo as ct,y as lt,yn as ut,ys as dt,zo as ft}from"./three.core-ChQ02iEs.js";import{_ as J,a as pt,b as mt,c as ht,d as gt,f as _t,g as vt,h as yt,i as bt,m as xt,n as St,o as Ct,p as wt,r as Tt,s as Et,u as Dt,v as Ot,x as Y,y as kt}from"./caveProfile-DYEEDk2Z.js";import{browserRendererStartupRecovery as At}from"./RendererStartupRecovery-Dpit0Jv3.js";import{LoadingScreen as jt,a as X,i as Mt,n as Nt,r as Pt,t as Ft}from"./LoadingScreen-f57YDlKP.js";function It(){let e=null,t=!1,n=null,r=null;function i(t,a){n(t,a),r=e.requestAnimationFrame(i)}return{start:function(){t!==!0&&n!==null&&e!==null&&(r=e.requestAnimationFrame(i),t=!0)},stop:function(){e!==null&&e.cancelAnimationFrame(r),t=!1},setAnimationLoop:function(e){n=e},setContext:function(t){e=t}}}function Lt(e){let t=new WeakMap;function n(t,n){let r=t.array,i=t.usage,a=r.byteLength,o=e.createBuffer();e.bindBuffer(n,o),e.bufferData(n,r,i),t.onUploadCallback();let s;if(r instanceof Float32Array)s=e.FLOAT;else if(typeof Float16Array<`u`&&r instanceof Float16Array)s=e.HALF_FLOAT;else if(r instanceof Uint16Array)s=t.isFloat16BufferAttribute?e.HALF_FLOAT:e.UNSIGNED_SHORT;else if(r instanceof Int16Array)s=e.SHORT;else if(r instanceof Uint32Array)s=e.UNSIGNED_INT;else if(r instanceof Int32Array)s=e.INT;else if(r instanceof Int8Array)s=e.BYTE;else if(r instanceof Uint8Array)s=e.UNSIGNED_BYTE;else if(r instanceof Uint8ClampedArray)s=e.UNSIGNED_BYTE;else throw Error(`THREE.WebGLAttributes: Unsupported buffer data format: `+r);return{buffer:o,type:s,bytesPerElement:r.BYTES_PER_ELEMENT,version:t.version,size:a}}function r(t,n,r){let i=n.array,a=n.updateRanges;if(e.bindBuffer(r,t),a.length===0)e.bufferSubData(r,0,i);else{a.sort((e,t)=>e.start-t.start);let t=0;for(let e=1;e<a.length;e++){let n=a[t],r=a[e];r.start<=n.start+n.count+1?n.count=Math.max(n.count,r.start+r.count-n.start):(++t,a[t]=r)}a.length=t+1;for(let t=0,n=a.length;t<n;t++){let n=a[t];e.bufferSubData(r,n.start*i.BYTES_PER_ELEMENT,i,n.start,n.count)}n.clearUpdateRanges()}n.onUploadCallback()}function i(e){return e.isInterleavedBufferAttribute&&(e=e.data),t.get(e)}function a(n){n.isInterleavedBufferAttribute&&(n=n.data);let r=t.get(n);r&&(e.deleteBuffer(r.buffer),t.delete(n))}function o(e,i){if(e.isInterleavedBufferAttribute&&(e=e.data),e.isGLBufferAttribute){let n=t.get(e);(!n||n.version<e.version)&&t.set(e,{buffer:e.buffer,type:e.type,bytesPerElement:e.elementSize,version:e.version});return}let a=t.get(e);if(a===void 0)t.set(e,n(e,i));else if(a.version<e.version){if(a.size!==e.array.byteLength)throw Error(`THREE.WebGLAttributes: The size of the buffer attribute's array buffer does not match the original size. Resizing buffer attributes is not supported.`);r(a.buffer,e,i),a.version=e.version}}return{get:i,remove:a,update:o}}var Z={alphahash_fragment:`#ifdef USE_ALPHAHASH
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function un(e,t,n){let r=new Float32Array(Yt),i=new p(0,1,0);return new c({name:`SphericalGaussianBlur`,defines:{n:Yt,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:pn(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function dn(){return new c({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:pn(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fn(){return new c({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pn(),fragmentShader:`
	...
	`}var mn=class extends ce{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ne(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var zr={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Br(e,t){let n=zr[t];return n===void 0?(q(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Vr=new p;function Hr(){return W.getLuminanceCoefficients(Vr),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Vr.x.toFixed(4)}, ${Vr.y.toFixed(4)}, ${Vr.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=jr(i,i.VERTEX_SHADER,y),S=jr(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Lr(i,x,`vertex`),n=Lr(i,S,`fragment`);K(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`)}var _a=15e3,va=8192,ya=Object.freeze({averageMainThreadMilliseconds:0,p95MainThreadMilliseconds:0,averagePhysicsMilliseconds:0,averageSceneMilliseconds:0,averageRenderMilliseconds:0,averagePhysicsSteps:0,maximumPhysicsSteps:0,sampleCount:0}),ba=class{getReportDetails;panel;fpsLabel;fpsCaption;averageLabel;frameTimeLabel;frameP95Label;mainWorkLabel;mainP95Label;lowLabel;triangleLabel;averageHistoryPath;lowHistoryPath;historyGraphic;copyLabel;sampleTimestamps=new Float64Array(va);sampleDurations=new Float64Array(va);workloadTimestamps=new Float64Array(va);physicsDurations=new Float64Array(va);sceneDurations=new Float64Array(va);renderDurations=new Float64Array(va);physicsStepCounts=new Uint8Array(va);durationScratch=[];workloadScratch=[];averageFpsHistory=[];onePercentLowHistory=[];sampleStart=0;sampleCount=0;workloadStart=0;workloadCount=0;lastTimestamp=null;lastPaint=0;copyFeedbackTimer=null;snapshot={averageFps:0,onePercentLow:0,averageFrameTime:0,medianFrameTime:0,p95FrameTime:0,p99FrameTime:0,refreshEstimate:60,longFrameCount:0,longestFrameTime:0,sampleCount:0,windowElapsedMilliseconds:0};workloadSnapshot=ya;constructor(e,t=document){this.getReportDetails=e,this.panel=X(t.querySelector(`[data-performance-panel]`),`Performance panel is missing.`),this.fpsLabel=X(t.querySelector(`[data-fps]`),`FPS label is missing.`),this.fpsCaption=X(t.querySelector(`[data-fps-caption]`),`FPS caption is missing.`),this.averageLabel=X(t.querySelector(`[data-fps-average]`),`Average-FPS label is missing.`),this.frameTimeLabel=X(t.querySelector(`[data-frame-time]`),`Frame-time label is missing.`),this.frameP95Label=X(t.querySelector(`[data-frame-p95]`),`Frame p95 label is missing.`),this.mainWorkLabel=X(t.querySelector(`[data-main-work]`),`Main-work label is missing.`),this.mainP95Label=X(t.querySelector(`[data-main-p95]`),`Main-work p95 label is missing.`),this.lowLabel=X(t.querySelector(`[data-fps-low]`),`Low-FPS label is missing.`),this.triangleLabel=X(t.querySelector(`[data-triangles]`),`Triangle label is missing.`),this.averageHistoryPath=X(t.querySelector(`[data-fps-average-line]`),`Average-FPS history path is missing.`),this.lowHistoryPath=X(t.querySelector(`[data-fps-low-line]`),`Low-FPS history path is missing.`),this.historyGraphic=X(t.querySelector(`[data-fps-history]`),`FPS history graphic is missing.`),this.copyLabel=X(t.querySelector(`[data-performance-copy]`),`Performance copy label is missing.`),this.panel.addEventListener(`click`,this.handleCopy)}recordFrame(e){if(this.lastTimestamp===null){this.lastTimestamp=e;return}let t=e-this.lastTimestamp;if(this.lastTimestamp=e,t<=0)return;let n=(this.sampleStart+this.sampleCount)%va;this.sampleTimestamps[n]=e,this.sampleDurations[n]=t,this.sampleCount<va?this.sampleCount+=1:this.sampleStart=(this.sampleStart+1)%va;let r=e-_a;for(;this.sampleCount>0&&this.sampleTimestamps[this.sampleStart]<r;)this.sampleStart=(this.sampleStart+1)%va,--this.sampleCount;e-this.lastPaint>=250&&(this.lastPaint=e,this.recalculate(),this.paint())}getSnapshot(){return this.snapshot}recordWorkload(e,t){let n=(this.workloadStart+this.workloadCount)%va;this.workloadTimestamps[n]=e,this.physicsDurations[n]=Math.max(0,t.physicsMilliseconds),this.sceneDurations[n]=Math.max(0,t.sceneMilliseconds),this.renderDurations[n]=Math.max(0,t.renderMilliseconds),this.physicsStepCounts[n]=Math.max(0,Math.min(255,Math.floor(t.physicsSteps))),this.workloadCount<va?this.workloadCount+=1:this.workloadStart=(this.workloadStart+1)%va,this.trimWorkload(e-_a)}getWorkloadSnapshot(){return this.workloadSnapshot}resume(e){this.lastTimestamp=e}reset=()=>{this.sampleStart=0,this.sampleCount=0,this.workloadStart=0,this.workloadCount=0,this.workloadSnapshot=ya,this.averageFpsHistory.length=0,this.onePercentLowHistory.length=0,this.lastTimestamp=null,this.averageHistoryPath.setAttribute(`d`,``),this.lowHistoryPath.setAttribute(`d`,``)};dispose(){this.panel.removeEventListener(`click`,this.handleCopy),this.copyFeedbackTimer!==null&&window.clearTimeout(this.copyFeedbackTimer)}recalculate(){this.durationScratch.length=this.sampleCount;let e=0,t=0,n=0;for(let r=0;r<this.sampleCount;r+=1){let i=(this.sampleStart+r)%va,a=this.sampleDurations[i],o=Math.min(a,250);this.durationScratch[r]=o,e+=o,a>=50&&(t+=1),n=Math.max(n,a)}this.durationScratch.sort((e,t)=>e-t);let r=this.durationScratch.length>0?e/this.durationScratch.length:0,i=r>0?1e3/r:0,a=this.sortedPercentile(.5),o=this.sortedPercentile(.95),s=this.sortedPercentile(.99),c=Math.max(1,Math.ceil(this.durationScratch.length*.01)),l=0;for(let e=Math.max(0,this.durationScratch.length-c);e<this.durationScratch.length;e+=1)l+=this.durationScratch[e]??0;let u=l/c,d=u>0?1e3/u:0,f=this.sortedPercentile(.1),p=f>0?1e3/f:60,m=[30,60,75,90,100,120,144,165,240].reduce((e,t)=>Math.abs(t-p)<Math.abs(e-p)?t:e,60),h=this.sampleStart,g=(this.sampleStart+this.sampleCount-1+va)%va,_=this.sampleCount>0?Math.min(_a,this.sampleTimestamps[g]-this.sampleTimestamps[h]+this.sampleDurations[h]):0;this.snapshot={averageFps:i,onePercentLow:d,averageFrameTime:r,medianFrameTime:a,p95FrameTime:o,p99FrameTime:s,refreshEstimate:m,longFrameCount:t,longestFrameTime:n,sampleCount:this.sampleCount,windowElapsedMilliseconds:_},this.recalculateWorkload(),this.averageFpsHistory.push(i),this.onePercentLowHistory.push(d),this.averageFpsHistory.length>78&&this.averageFpsHistory.shift(),this.onePercentLowHistory.length>78&&this.onePercentLowHistory.shift()}recalculateWorkload(){this.workloadScratch.length=this.workloadCount;let e=0,t=0,n=0,r=0,i=0;for(let a=0;a<this.workloadCount;a+=1){let o=(this.workloadStart+a)%va,s=this.physicsDurations[o]??0,c=this.sceneDurations[o]??0,l=this.renderDurations[o]??0,u=this.physicsStepCounts[o]??0;e+=s,t+=c,n+=l,r+=u,i=Math.max(i,u),this.workloadScratch[a]=s+c+l}this.workloadScratch.sort((e,t)=>e-t);let a=this.workloadCount,o=e+t+n,s=Math.min(Math.max(0,a-1),Math.floor(a*.95));this.workloadSnapshot={averageMainThreadMilliseconds:a>0?o/a:0,p95MainThreadMilliseconds:a>0?this.workloadScratch[s]??0:0,averagePhysicsMilliseconds:a>0?e/a:0,averageSceneMilliseconds:a>0?t/a:0,averageRenderMilliseconds:a>0?n/a:0,averagePhysicsSteps:a>0?r/a:0,maximumPhysicsSteps:i,sampleCount:a}}trimWorkload(e){for(;this.workloadCount>0&&this.workloadTimestamps[this.workloadStart]<e;)this.workloadStart=(this.workloadStart+1)%va,--this.workloadCount}sortedPercentile(e){if(this.durationScratch.length===0)return 0;let t=Math.min(this.durationScratch.length-1,Math.max(0,Math.floor(e*this.durationScratch.length)));return this.durationScratch[t]??0}paint(){let{averageFps:e,onePercentLow:t,averageFrameTime:n,p95FrameTime:r,refreshEstimate:i}=this.snapshot,{averageMainThreadMilliseconds:a,p95MainThreadMilliseconds:o,sampleCount:s}=this.workloadSnapshot,c=this.snapshot.sampleCount>=30&&e>=i*.97;this.fpsLabel.textContent=e>0?e.toFixed(2):`--`,this.averageLabel.textContent=e>0?e.toFixed(2):`--`,this.lowLabel.textContent=t>0?t.toFixed(2):`--`,this.fpsCaption.textContent=c?`DISPLAY FPS / VSYNC-CAPPED`:`DISPLAY FPS / LAST 15S`,this.frameTimeLabel.textContent=n>0?n.toFixed(2):`--`,this.frameP95Label.textContent=r>0?r.toFixed(2):`--`,this.mainWorkLabel.textContent=s>0?a.toFixed(2):`--`,this.mainP95Label.textContent=s>0?o.toFixed(2):`--`,this.triangleLabel.textContent=this.getReportDetails().renderer.triangles.toLocaleString(`en-US`),this.historyGraphic.setAttribute(`aria-label`,`Display cadence over the last ${(this.snapshot.windowElapsedMilliseconds/1e3).toFixed(1)} seconds: ${e.toFixed(2)} average FPS, ${t.toFixed(2)} one-percent low; main-thread work ${a.toFixed(2)} milliseconds average and ${o.toFixed(2)} milliseconds p95`),this.panel.classList.toggle(`has-frame-drop`,e>0&&e<Math.min(52,i*.78));let l=i*.7,u=i*1.02,d=e=>e.map((t,n)=>{let r=e.length<=1?0:n/(e.length-1)*154,i=(1-Math.max(0,Math.min(1,(t-l)/(u-l))))*30;return`${n===0?`M`:`L`}${r.toFixed(1)} ${i.toFixed(1)}`}).join(` `);this.averageHistoryPath.setAttribute(`d`,d(this.averageFpsHistory)),this.lowHistoryPath.setAttribute(`d`,d(this.onePercentLowHistory))}handleCopy=()=>{this.copyPerformanceReport()};async copyPerformanceReport(){try{await ha(ga({capturedAt:new Date().toISOString(),performance:this.snapshot,...this.getReportDetails()})),this.panel.dataset.copyState=`copied`,this.copyLabel.textContent=`COPIED 15S REPORT`}catch(e){console.warn(`Unable to copy performance report.`,e),this.panel.dataset.copyState=`failed`,this.copyLabel.textContent=`COPY FAILED`}this.copyFeedbackTimer!==null&&window.clearTimeout(this.copyFeedbackTimer),this.copyFeedbackTimer=window.setTimeout(()=>{delete this.panel.dataset.copyState,this.copyLabel.textContent=`CLICK TO COPY 15S REPORT`,this.copyFeedbackTimer=null},2e3)}},xa=class extends Error{stage;code;constructor(e,t,n,r){super(n,r),this.stage=e,this.code=t,this.name=`WebGpuBootstrapError`}},Sa={setTimeout:(e,t)=>window.setTimeout(e,t),clearTimeout:e=>window.clearTimeout(e)};async function Ca(e,t,n,r){let i=null,a=new Promise((e,a)=>{i=r.setTimeout(()=>{a(new xa(t,`timeout`,`WebGPU ${t===`request-webgpu-adapter`?`adapter`:`device`} request exceeded ${n} ms.`))},n)});try{return await Promise.race([e,a])}finally{i!==null&&r.clearTimeout(i)}}async function wa(e,t={}){let n=t.timeoutMilliseconds??12e3,r=t.timers??Sa;if(!e)throw new xa(`request-webgpu-adapter`,`unavailable`,`WebGPU is not exposed by this browser.`);t.onStage?.(`request-webgpu-adapter`);let i;try{i=await Ca(e.requestAdapter({powerPreference:`high-performance`}),`request-webgpu-adapter`,n,r)}catch(e){throw e instanceof xa?e:new xa(`request-webgpu-adapter`,`request-failed`,`The browser rejected the WebGPU adapter request.`,{cause:e})}if(!i)throw new xa(`request-webgpu-adapter`,`unavailable`,`The browser could not provide a WebGPU adapter.`);t.onStage?.(`request-webgpu-device`);let a=(t.requestedFeatures??[]).filter(e=>i.features.has(e)),o;try{o=i.requestDevice({requiredFeatures:a,requiredLimits:t.requiredLimits})}catch(e){throw new xa(`request-webgpu-device`,`request-failed`,`The browser rejected the WebGPU device request.`,{cause:e})}let s=!1;try{let e=await Ca(o,`request-webgpu-device`,n,r);return s=!0,e}catch(e){throw e instanceof xa?e:new xa(`request-webgpu-device`,`request-failed`,`The browser rejected the WebGPU device request.`,{cause:e})}finally{s||o.then(e=>e.destroy()).catch(()=>void 0)}}var Ta={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},Ea=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Da=new m(-1,1,1,-1,0,1),Oa=new class extends P{constructor(){super(),this.setAttribute(`position`,new G([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new G([0,2,0,0,2,0],2))}},ka=class{constructor(e){this._mesh=new L(Oa,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Da)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Aa=class extends Ea{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof c?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ot.clone(e.uniforms),this.material=new c({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new ka(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},ja=class extends Ea{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Ma=class extends Ea{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Na=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new j);this._width=n.width,this._height=n.height,t=new ce(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:O}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Aa(Ta),this.copyPass.material.blending=0,this.timer=new xe}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}ja!==void 0&&(r instanceof ja?n=!0:r instanceof Ma&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new j);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Pa={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Ra.BlurDirectionX=new j(1,0),Ra.BlurDirectionY=new j(0,1);function za(e){return e>=.999?`direct-opaque`:`isolated-fade`}var Ba=36e5,Va=1.5;function Ha(e,t,n,r){let i=Math.max(1,Math.floor(e)),a=Math.max(1,Math.floor(t)),o=i*a,s=Math.min(Math.max(n,.25),Va),c=Math.sqrt(Ba/o),l=Math.max(.25,Math.min(s,c)*Math.min(Math.max(r,.5),1)),u=Math.max(1,Math.floor(i*l)),d=Math.max(1,Math.floor(a*l));return{width:i,height:a,pixelRatio:l,drawingBufferWidth:u,drawingBufferHeight:d,renderPixels:u*d}}var Ua=1e-6;function Wa(e){let t=new v(1,1,Le);return t.name=e,t.format=s,t.minFilter=qe,t.magFilter=qe,t.generateMipmaps=!1,t}var Ga=Object.freeze({calls:0,triangles:0,points:0,lines:0});function Ka(e){return{calls:e.drawCalls??e.calls??0,triangles:e.triangles,points:e.points,lines:e.lines}}var qa=`
  varying vec2 vUv;
...
`,Ja=`
  ...
  void main() {
    ...
    float depthVisible = step(layerDepth, worldDepth + ${Ua.toExponential()});
...
`,ol=class{points;material;constructor(){let e=new xt(53335),t=new Float32Array(1860),n=new Float32Array(620),r=new Float32Array(620);for(let i=0;i<620;i+=1){let a=e.range(Ot.endZ,Ot.startZ),o=bt(a)+e.range(-1,1)*Ct(a)*.83;t[i*3]=o,t[i*3+1]=e.range(.25,Tt(a)*.92),t[i*3+2]=a,n[i]=e.range(0,Math.PI*2),r[i]=e.range(.45,1.15)}let i=new P;i.setAttribute(`position`,new o(t,3)),i.setAttribute(`aPhase`,new o(n,1)),i.setAttribute(`aSize`,new o(r,1)),this.material=new c({uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)}},vertexShader:il,fragmentShader:al,transparent:!0,depthWrite:!1,blending:2}),this.points=new $e(i,this.material),this.points.name=`Suspended cave dust`,this.points.frustumCulled=!1}update(e){this.material.uniforms.uTime.value=e}resize(){this.material.uniforms.uPixelRatio.value=Math.min(window.devicePixelRatio,2)}};function sl(e){let t=new xt(e),n=[],r=[],i=[],a=Math.abs(e)%3,o=Array.from({length:10},()=>t.range(-.11,.11)),s=t.range(0,Math.PI*2),c=t.range(0,Math.PI*2),l=t.range(.1,.22),u=t.range(.08,.19),d=a===1?t.range(1.4,1.85):t.range(.76,1.28),f=e=>[(Math.sin(e*3.4+s)-Math.sin(s))*l*e+Math.sin(e*8.7+c)*.018*e,(Math.sin(e*2.8+c)-Math.sin(c))*u*e+Math.cos(e*7.3+s)*.016*e];for(let e=0;e<9;e+=1){let i=e/9,l=a===2?.58:.74,u=(1-i)**l,p=Math.exp(-(((i-.3)/.12)**2))*(a===0?.26:.13),m=Math.exp(-(((i-.58)/.09)**2))*(a===2?.22:.1),h=Math.exp(-(((i-.46)/.075)**2))*.1,g=1+Math.sin(i*17+s)*.105+Math.sin(i*31+c)*.045+t.range(-.055,.055),_=1+Math.exp(-i*8)*.3,v=Math.max(.025,.32*u*g*_*(1+p+m-h)),[y,b]=f(i),x=i*t.range(-.45,.45);for(let e=0;e<=10;e+=1){let t=e%10,a=e/10*Math.PI*2+x,c=1+(o[t]??0)+Math.sin(a*3+i*9+s)*.035;n.push(y+Math.cos(a)*v*d*c,-1.6*i,b+Math.sin(a)*v/d*c),r.push(e/10,i)}}for(let e=0;e<8;e+=1)for(let t=0;t<10;t+=1){let n=e*11+t,r=n+11;i.push(n,n+1,r,r,n+1,r+1)}let[p,m]=f(1),h=n.length/3;n.push(p,-1.6,m),r.push(.5,1);for(let e=0;e<10;e+=1)i.push(88+e,88+e+1,h);let g=n.length/3;n.push(0,0,0),r.push(.5,0);for(let e=0;e<10;e+=1)i.push(g,e+1,e);let _=new P;return _.setAttribute(`position`,new G(n,3)),_.setAttribute(`uv`,new G(r,2)),_.setIndex(i),_.computeVertexNormals(),_.computeBoundingSphere(),_}var cl=.14,ll=.012,ul=class{colliders=[];localVertex=new p;worldVertex=new p;sampleCenter=new p;addSpeleothem(e,t){let n=e.getAttribute(`position`);if(!n)throw Error(`Speleothem collision geometry has no positions.`);let r=[];for(let e=0;e<9;e+=1){let i=new p;for(let t=0;t<10;t+=1){let r=e*11+t;this.localVertex.fromBufferAttribute(n,r),i.add(this.localVertex)}i.multiplyScalar(1/10).applyMatrix4(t);let a=0;for(let r=0;r<10;r+=1){let o=e*11+r;this.worldVertex.fromBufferAttribute(n,o).applyMatrix4(t),a=Math.max(a,this.worldVertex.distanceTo(i))}r.push({center:i,radius:a})}let i=new p().fromBufferAttribute(n,99).applyMatrix4(t);r.push({center:i,radius:0}),this.addFormationSections(r)}addCollar(e,t){this.addSphere(e,.38*Math.max(t.x,t.z),!1,`formation`)}addRock(e,t,n=!0){this.colliders.push(Io(e,t,n))}addFormationSections(e){for(let t=0;t<e.length-1;t+=1){let n=e[t],r=e[t+1];if(!n||!r)continue;let i=n.center.distanceTo(r.center),a=Math.max(1,Math.ceil(i/cl)),o=i/a*.5,s=Math.abs(r.radius-n.radius)/a*.5,c=Math.hypot(o,s)+ll,l=t===0?0:1;for(let e=l;e<=a;e+=1){let t=e/a;this.sampleCenter.lerpVectors(n.center,r.center,t),this.addSphere(this.sampleCenter,C.lerp(n.radius,r.radius,t)+c,!1,`formation`)}}}addSphere(e,t,n,r){this.colliders.push({center:e.clone(),radius:t,walkable:n,kind:r})}},dl=.42,fl=Y.radius+.42,pl=.08;Y.radius*2+.25;var ml=[{size:`large`,z:3.1,lateralOffset:-.82,scale:[1.65,1.35,1.05],rotation:[.16,.48,-.1],embedDepth:.08},{size:`small`,z:1.2,lateralOffset:.44,scale:[.55,.48,.62],rotation:[-.08,1.12,.2],embedDepth:.035},{size:`large`,z:-.9,lateralOffset:.94,scale:[1.12,1.05,.78],rotation:[.24,2.08,-.14],embedDepth:.065},{size:`small`,z:-2.9,lateralOffset:-.4,scale:[.48,.38,.7],rotation:[.12,2.72,.08],embedDepth:.03},{size:`large`,z:-5,lateralOffset:-.98,scale:[1.38,1.08,1.48],rotation:[-.18,.86,.14],embedDepth:.075},{size:`small`,z:-6.8,lateralOffset:.5,scale:[.64,.46,.52],rotation:[.18,1.66,-.16],embedDepth:.035}];function hl(e){return bt(e.z)+e.lateralOffset}function gl(e){let t=Ct(e.z)-fl,n=dl*Math.max(...e.scale)+Y.radius+pl,r=t+e.lateralOffset-n,i=t-e.lateralOffset-n;return Math.max(r,i)}var _l=10,vl=-.2,yl=.07,bl=.3;function xl(){let e=[...Sl(vl,1,0,0),...Sl(yl,.78,.018,-.012),...Sl(bl,.28,.034,-.022),new p(0,vl,0),new p(.034,bl,-.022)],t=[];for(let e=0;e<_l;e+=1){let n=(e+1)%_l,r=_l+e,i=_l+n,a=20+e,o=20+n;t.push([e,n,i],[e,i,r],[r,i,o],[r,o,a],[30,n,e],[31,a,o])}let n=e.reduce((e,t)=>e.add(t),new p).multiplyScalar(1/e.length),r=[],i=[],a=new p,o=new p,s=new p,c=new p;for(let l of t){let[t,u,d]=l,f=e[t],p=e[u],m=e[d];if(!(!f||!p||!m)){if(s.crossVectors(a.copy(p).sub(f),o.copy(m).sub(f)),c.copy(f).add(p).add(m).multiplyScalar(1/3),s.dot(c.sub(n))<0){let t=u;if(u=d,d=t,p=e[u],m=e[d],!p||!m)continue}for(let e of[f,p,m])r.push(e.x,e.y,e.z),i.push(.5+Math.atan2(e.z,e.x)/(Math.PI*2),C.inverseLerp(vl,bl,e.y))}}let l=new P;return l.setAttribute(`position`,new G(r,3)),l.setAttribute(`uv`,new G(i,2)),l.computeVertexNormals(),l.computeBoundingBox(),l.computeBoundingSphere(),l.name=`Deterministic grounded irregular rock`,l}function Sl(e,t,n,r){return Array.from({length:_l},(i,a)=>{let o=a/_l*Math.PI*2,s=Math.cos(o),c=Math.sin(o);return new p((s*.44+c*.025)*t+n,e,(c*.36-s*.018)*t+r)})}var Cl=class{group=new V;worldColliders;contactRocks;walls;floor;colliderBuilder=new ul;constructor(e){this.group.name=`Procedural cave`,this.walls=this.createWalls(e),this.floor=this.createFloor(e),this.group.add(this.walls,this.floor),this.createFormations(e),this.contactRocks=this.createRockScatter(e),this.worldColliders=this.colliderBuilder.colliders}createMaterial(e,t=!1){return new Ke({map:e.color,normalMap:e.normal,normalScale:new j(t?.72:1.05,t?.72:1.05),roughnessMap:e.roughness,roughness:t?.58:.91,metalness:t?.08:.015,color:t?6779246:8092531})}createWalls(e){let t=[],n=[],r=[],{segments:i,radialSegments:a,startZ:o,endZ:s}=Ot;for(let e=0;e<=i;e+=1){let r=e/i,c=C.lerp(o,s,r),l=bt(c),u=Tt(c),d=u*.5-.25,f=u*.5+.45,p=Ct(c);for(let e=0;e<=a;e+=1){let i=e/a,o=i*Math.PI*2,s=yt(r*11.5,i*8,8,30767)-.5,u=Math.sin(c*.42+o*5)*.12,m=s*.72+u,h=Math.cos(o),g=Math.sin(o);t.push(l+h*(p+m),d+g*(f+m*.66),c),n.push(i*4,r*16)}}let c=a+1;for(let e=0;e<i;e+=1)for(let t=0;t<a;t+=1){let n=e*c+t,i=n+c;r.push(n,i,n+1,i,i+1,n+1)}let l=new P;l.setAttribute(`position`,new G(t,3)),l.setAttribute(`uv`,new G(n,2)),l.setIndex(r),l.computeVertexNormals(),this.stitchWallSeamNormals(l,i,a),l.computeBoundingSphere();let u=this.createMaterial(e);u.side=1,u.normalScale.set(-1.05,-1.05);let d=new L(l,u);return d.name=`Cave shell`,d.receiveShadow=!0,d}stitchWallSeamNormals(e,t,n){let r=e.getAttribute(`normal`),i=new p,a=new p,o=new p,s=n+1;for(let e=0;e<=t;e+=1){let t=e*s,c=t+n;i.fromBufferAttribute(r,t),a.fromBufferAttribute(r,c),o.copy(i).add(a).normalize(),r.setXYZ(t,o.x,o.y,o.z),r.setXYZ(c,o.x,o.y,o.z)}r.needsUpdate=!0}createFloor(e){let t=[],n=[],r=[];for(let e=0;e<=180;e+=1){let r=e/180,i=C.lerp(Ot.startZ,Ot.endZ,r),a=bt(i),o=Ct(i)*1.015;for(let e=0;e<=36;e+=1){let s=e/36,c=a+(s*2-1)*o;t.push(c,ht(c,i),i),n.push(s*5,r*18)}}for(let e=0;e<180;e+=1)for(let t=0;t<36;t+=1){let n=e*37+t,i=n+37;r.push(n,n+1,i,i,n+1,i+1)}let i=new P;i.setAttribute(`position`,new G(t,3)),i.setAttribute(`uv`,new G(n,2)),i.setIndex(r),i.computeVertexNormals(),i.computeBoundingSphere();let a=new L(i,this.createMaterial(e,!0));return a.name=`Wet cave floor`,a.receiveShadow=!0,a}createFormations(e){let t=new xt(379422),n=this.createMaterial(e,!0);n.color.multiplyScalar(.66),n.roughness=.86,n.metalness=.015;let r=[20897,20898,20899].map(sl),i=r.map((e,t)=>{let r=new h(e,n,18);return r.name=`Stalactites organic variant ${t+1}`,r.castShadow=!0,r.receiveShadow=!0,r}),a=new Ye(.38,1),o=new h(a,n,82);o.name=`Flowstone formation collars`,o.castShadow=!0,o.receiveShadow=!0;let s=new fe,c=new nt,l=new p,u=new p,d=new p,f=new p;for(let e=0;e<54;e+=1){let n=t.range(Ot.endZ+2,Ot.startZ-2),a=t.range(-.92,.92),p=bt(n)+Ct(n)*a;u.set(p,Tt(n)-Math.abs(a)*.65,n),c.setFromEuler(new Ze(t.range(-.12,.12),t.range(0,Math.PI),t.range(-.12,.12))),l.set(t.range(.55,1.6),t.range(.55,2.25),t.range(.55,1.6)),s.compose(u,c,l);let m=e%i.length;this.colliderBuilder.addSpeleothem(r[m],s),i[m]?.setMatrixAt(Math.floor(e/i.length),s),d.copy(u),d.y-=.08,f.set(l.x*t.range(.9,1.35),t.range(.2,.38),l.z*t.range(.9,1.35)),s.compose(d,c,f),o.setMatrixAt(e,s),this.colliderBuilder.addCollar(d,f)}i.forEach(e=>{e.instanceMatrix.needsUpdate=!0,this.group.add(e)});let m=[10,9,9],g=r.map(e=>{let t=e.clone();return t.rotateZ(Math.PI),t}),_=g.map((e,t)=>{let r=new h(e,n,m[t]??0);return r.name=`Stalagmites organic variant ${t+1}`,r.castShadow=!0,r.receiveShadow=!0,r}),v=[0,0,0];for(let e=0;e<28;e+=1){let n=t.range(Ot.endZ+2,Ot.startZ-2),r=t.next()>.5?1:-1,i=bt(n)+r*Ct(n)*t.range(.7,.94);u.set(i,ht(i,n),n),c.setFromEuler(new Ze(t.range(-.08,.08),t.range(0,Math.PI),t.range(-.08,.08))),l.set(t.range(.55,1.35),t.range(.45,1.75),t.range(.55,1.35)),s.compose(u,c,l);let a=e%_.length;this.colliderBuilder.addSpeleothem(g[a],s);let p=v[a]??0;_[a]?.setMatrixAt(p,s),v[a]=p+1,d.copy(u),d.y+=.06,f.set(l.x*t.range(.86,1.25),t.range(.18,.34),l.z*t.range(.86,1.25)),s.compose(d,c,f),o.setMatrixAt(54+e,s),this.colliderBuilder.addCollar(d,f)}_.forEach(e=>{e.instanceMatrix.needsUpdate=!0,this.group.add(e)}),o.instanceMatrix.needsUpdate=!0,this.group.add(o)}createRockScatter(e){let t=new xt(11541991),n=xl(),r=this.createMaterial(e,!0);r.color.multiplyScalar(.66),r.roughness=.84,r.metalness=.02;let i=new h(n,r,72+ml.length);i.name=`Rock scatter and cape contact course`,i.castShadow=!0,i.receiveShadow=!0;let a=new fe,o=new nt,s=new p,c=new p,l=new p,u=n.getAttribute(`position`),d=[];for(let e=0;e<ml.length;e+=1){let t=ml[e];if(!t)continue;let r=hl(t);o.setFromEuler(new Ze(...t.rotation)),s.fromArray(t.scale),c.set(r,0,t.z),a.compose(c,o,s);let f=1/0;for(let e=0;e<u.count;e+=1)l.fromBufferAttribute(u,e).applyMatrix4(a),f=Math.min(f,l.y);c.y=ht(r,t.z)-f-t.embedDepth,a.compose(c,o,s),i.setMatrixAt(e,a);let p=t.size===`small`;this.colliderBuilder.addRock(n,a,p),d.push({size:t.size,walkable:p,position:[c.x,c.y,c.z],lateralOffset:t.lateralOffset,scale:t.scale,openLaneWidth:gl(t)})}for(let e=0;e<72;e+=1){let r=t.range(Ot.endZ+1.5,Ot.startZ-1.5),d=t.next()>.5?1:-1,f=bt(r)+d*Ct(r)*t.range(.64,.94);c.set(f,0,r),o.setFromEuler(new Ze(t.range(-.2,.2),t.range(0,Math.PI*2),t.range(-.2,.2))),s.set(t.range(.25,1.25),t.range(.18,.72),t.range(.35,1.4)),a.compose(c,o,s);let p=1/0;for(let e=0;e<u.count;e+=1)l.fromBufferAttribute(u,e).applyMatrix4(a),p=Math.min(p,l.y);c.y=ht(f,r)-p-t.range(.025,.065),a.compose(c,o,s),i.setMatrixAt(ml.length+e,a),this.colliderBuilder.addRock(n,a)}return i.instanceMatrix.needsUpdate=!0,this.group.add(i),d}},wl=class{lights;selectedIndices;selectedDistances;constructor(e,n){this.lights=Array.from({length:e},(e,r)=>{let i=new t(16777215,0,1,2);return i.name=`${n} pooled light ${r+1}`,i}),this.selectedIndices=new Int32Array(e),this.selectedDistances=new Float64Array(e)}update(e,t){this.selectedIndices.fill(-1),this.selectedDistances.fill(1/0);for(let n=0;n<t.length;n+=1){let r=t[n];if(!r)continue;let i=r.position.distanceToSquared(e);for(let e=0;e<this.lights.length;e+=1)if(!(i>=(this.selectedDistances[e]??1/0))){for(let t=this.lights.length-1;t>e;--t)this.selectedIndices[t]=this.selectedIndices[t-1]??-1,this.selectedDistances[t]=this.selectedDistances[t-1]??1/0;this.selectedIndices[e]=n,this.selectedDistances[e]=i;break}}this.lights.forEach((n,r)=>{let i=this.selectedIndices[r]??-1,a=i>=0?t[i]:void 0;if(!a){n.position.copy(e),n.intensity=0;return}let o=Math.sqrt(this.selectedDistances[r]??0),s=a.range*.68,c=Math.max(.001,a.range-s),l=C.clamp((o-s)/c,0,1),u=1-l*l*(3-2*l);n.position.copy(a.position),n.color.copy(a.color),n.distance=a.range,n.intensity=a.intensity*u})}getDiagnostics(){return{lights:this.lights.length,visibleLights:this.lights.filter(e=>e.visible).length,activeLights:this.lights.filter(e=>e.intensity>.001).length}}},Tl=class{group=new V;worldColliders=[];clusters=[];lightPool=new wl(2,`Mineral`);constructor(){this.group.name=`Glowing mineral veins`,[{z:1,side:-1,color:4386769},{z:-22,side:1,color:7393279},{z:-43,side:-1,color:10586111},{z:-61,side:1,color:4843202}].forEach((e,t)=>this.createCluster(e.z,e.side,e.color,t)),this.group.add(...this.lightPool.lights)}update(e,t){for(let t of this.clusters)t.intensity=8.5+Math.sin(e*1.3+t.phase)*.65;this.lightPool.update(t,this.clusters)}getClusterPositions(){return this.clusters.map(e=>e.root.toArray())}getLightDiagnostics(){return this.lightPool.getDiagnostics()}createCluster(e,t,n,r){let i=new xt(49833+r*991),a=bt(e)+t*(Ct(e)-.48),o=new p(a,i.range(2.1,4.2),e),s=new z(n),c=new Ke({color:s,emissive:s,emissiveIntensity:5.5,roughness:.23,metalness:.34}),l=new re({color:s,transparent:!0,opacity:.12,blending:2,depthWrite:!1,side:2}),u=[],d=[];for(let n=0;n<8;n+=1){let a=[o.clone()],s=i.range(-1,1),c=i.range(-1,1),l=i.range(1.1,3),f=i.integer(3,5);for(let i=1;i<=f;i+=1){let u=i/f,d=e+c*l*u+Math.sin(u*7+n)*.14,m=o.y+s*l*u+Math.sin(u*5+r)*.18,h=bt(d)+t*(Ct(d)-.46-Math.sin(u*Math.PI)*.08);a.push(new p(h,m,d))}let m=new ue(a),h=i.range(.018,.045)*(1-n/8*.38);u.push(new Me(m,18,h,5,!1)),d.push(new Me(m,14,h*3.2,5,!1))}let f=uc(u,!1),m=uc(d,!1);if(!f||!m)throw Error(`Unable to merge procedural mineral branches.`);let g=new L(f,c);g.name=`Mineral vein core ${r}`;let _=new L(m,l);_.name=`Mineral vein glow ${r}`,this.group.add(_,g),u.forEach(e=>e.dispose()),d.forEach(e=>e.dispose());let v=new w(.11,0),y=new h(v,c,18),b=new fe,x=new nt,S=new p,T=new p;for(let n=0;n<y.count;n+=1)T.set(a-t*i.range(0,.14),o.y+i.range(-1.8,1.8),e+i.range(-2.1,2.1)),x.setFromEuler(new Ze(i.range(0,Math.PI),i.range(0,Math.PI),i.range(0,Math.PI))),S.set(i.range(.45,1.6),i.range(.8,2.9),i.range(.45,1.2)),b.compose(T,x,S),y.setMatrixAt(n,b),this.worldColliders.push({center:T.clone(),radius:C.clamp(.11*Math.max(S.x,S.y,S.z),.07,.34),walkable:!1,kind:`mineral`});y.instanceMatrix.needsUpdate=!0,this.group.add(y);let E=o.clone().add(new p(-t*.65,0,0));this.clusters.push({root:o,position:E,color:s,intensity:9,range:7.5,phase:i.range(0,Math.PI*2)})}},El=`
  uniform float uTime;
