const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGpuRenderPipeline-_qCY6m4J.js","assets/three.tsl-BREFXy_i.js","assets/three.webgpu-BWV4PpD4.js","assets/three.core-ChQ02iEs.js","assets/WebGpuTorchSystem-BaoODHzA.js","assets/CapeSimulation-BdRaWfa2.js","assets/WebGpuWaterSystem-Byf9vz6A.js","assets/WebGpuCaveAtmosphere-CHTHT1Qf.js","assets/GpuCapeSimulation-Df7FDV5O.js","assets/WebGpuCinematicLighting-PSyt7LCc.js"])))=>i.map(i=>d[i]);
import{t as e}from"./index-DtjItd6S.js";import{$i as t,$r as n,$s as r,As as i,At as a,B as o,Bt as s,Co as c,Dr as l,Ds as u,Fo as d,Fr as f,Fs as p,Gi as m,Gn as h,Gs as g,Hs as _,Ht as v,I as y,Is as b,J as x,Jr as S,Kr as C,Li as w,Mr as T,Ms as E,Mt as D,Nn as O,Nr as k,Nt as ee,Pi as A,Pn as te,Ps as j,Pt as M,Q as ne,Qr as re,Qs as N,Qt as ie,R as ae,So as oe,Ts as se,Us as ce,V as P,Vt as le,Wt as F,Xi as ue,Y as de,Yi as fe,Yr as pe,Zi as me,Zr as I,_i as he,_r as ge,ai as L,as as _e,ba as ve,bo as ye,cc as be,cn as xe,cs as Se,ct as Ce,d as we,dc as Te,do as Ee,ec as De,ei as Oe,eo as ke,et as R,ft as Ae,gi as je,gn as Me,gs as z,gt as Ne,ic as Pe,jn as B,jr as Fe,js as Ie,ks as Le,li as V,ln as Re,lo as H,ma as U,mn as ze,mo as Be,na as Ve,nc as He,no as Ue,nt as We,oc as Ge,oi as Ke,pi as qe,pn as Je,pt as Ye,qt as Xe,sc as W,sn as Ze,so as Qe,ta as $e,tc as G,ti as et,to as tt,ua as nt,uc as K,ur as rt,us as it,vs as at,ws as q,xa as ot,xo as st,y as ct,yn as lt,ys as ut,zo as dt}from"./three.core-ChQ02iEs.js";import{B as ft,D as pt,F as mt,G as ht,H as gt,I as _t,J as vt,K as J,L as yt,M as bt,N as xt,O as St,P as Ct,S as wt,T as Tt,U as Et,V as Dt,W as Ot,X as Y,Y as kt,c as At,j as jt,k as Mt,n as Nt,o as Pt,q as Ft,s as It,t as Lt,v as Rt,y as zt,z as Bt}from"./CapeSimulation-BdRaWfa2.js";import{browserRendererStartupRecovery as Vt}from"./RendererStartupRecovery-Dpit0Jv3.js";import{LoadingScreen as Ht,a as X,i as Ut,n as Wt,r as Gt,t as Kt}from"./LoadingScreen-f57YDlKP.js";function qt(){let e=null,t=!1,n=null,r=null;function i(t,a){n(t,a),r=e.requestAnimationFrame(i)}return{start:function(){t!==!0&&n!==null&&e!==null&&(r=e.requestAnimationFrame(i),t=!0)},stop:function(){e!==null&&e.cancelAnimationFrame(r),t=!1},setAnimationLoop:function(e){n=e},setContext:function(t){e=t}}}function Jt(e){let t=new WeakMap;function n(t,n){let r=t.array,i=t.usage,a=r.byteLength,o=e.createBuffer();e.bindBuffer(n,o),e.bufferData(n,r,i),t.onUploadCallback();let s;if(r instanceof Float32Array)s=e.FLOAT;else if(typeof Float16Array<`u`&&r instanceof Float16Array)s=e.HALF_FLOAT;else if(r instanceof Uint16Array)s=t.isFloat16BufferAttribute?e.HALF_FLOAT:e.UNSIGNED_SHORT;else if(r instanceof Int16Array)s=e.SHORT;else if(r instanceof Uint32Array)s=e.UNSIGNED_INT;else if(r instanceof Int32Array)s=e.INT;else if(r instanceof Int8Array)s=e.BYTE;else if(r instanceof Uint8Array)s=e.UNSIGNED_BYTE;else if(r instanceof Uint8ClampedArray)s=e.UNSIGNED_BYTE;else throw Error(`THREE.WebGLAttributes: Unsupported buffer data format: `+r);return{buffer:o,type:s,bytesPerElement:r.BYTES_PER_ELEMENT,version:t.version,size:a}}function r(t,n,r){let i=n.array,a=n.updateRanges;if(e.bindBuffer(r,t),a.length===0)e.bufferSubData(r,0,i);else{a.sort((e,t)=>e.start-t.start);let t=0;for(let e=1;e<a.length;e++){let n=a[t],r=a[e];r.start<=n.start+n.count+1?n.count=Math.max(n.count,r.start+r.count-n.start):(++t,a[t]=r)}a.length=t+1;for(let t=0,n=a.length;t<n;t++){let n=a[t];e.bufferSubData(r,n.start*i.BYTES_PER_ELEMENT,i,n.start,n.count)}n.clearUpdateRanges()}n.onUploadCallback()}function i(e){return e.isInterleavedBufferAttribute&&(e=e.data),t.get(e)}function a(n){n.isInterleavedBufferAttribute&&(n=n.data);let r=t.get(n);r&&(e.deleteBuffer(r.buffer),t.delete(n))}function o(e,i){if(e.isInterleavedBufferAttribute&&(e=e.data),e.isGLBufferAttribute){let n=t.get(e);(!n||n.version<e.version)&&t.set(e,{buffer:e.buffer,type:e.type,bytesPerElement:e.elementSize,version:e.version});return}let a=t.get(e);if(a===void 0)t.set(e,n(e,i));else if(a.version<e.version){if(a.size!==e.array.byteLength)throw Error(`THREE.WebGLAttributes: The size of the buffer attribute's array buffer does not match the original size. Resizing buffer attributes is not supported.`);r(a.buffer,e,i),a.version=e.version}}return{get:i,remove:a,update:o}}var Z={alphahash_fragment:`#ifdef USE_ALPHAHASH
...
void main() {
	...
	`}var Tn=class extends ce{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ne(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Xr={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Zr(e,t){let n=Xr[t];return n===void 0?(K(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Qr=new p;function $r(){return We.getLuminanceCoefficients(Qr),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Qr.x.toFixed(4)}, ${Qr.y.toFixed(4)}, ${Qr.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Hr(i,i.VERTEX_SHADER,y),S=Hr(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Jr(i,x,`vertex`),n=Jr(i,S,`fragment`);G(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`,sc=class{group=new B;worldColliders=[];torches=[];lightPool=new rc(3,`Torch`);shadowLight;activeShadowTorch=-1;constructor(){this.group.name=`Torch lights`;let e=new Et(461508);[11,-2,-15,-29,-43,-57,-68].forEach((t,n)=>this.createTorch(t,n%2==0?-1:1,e)),this.group.add(...this.lightPool.lights),this.shadowLight=new dt(16756826,72,12,.86,.82,1.7),this.shadowLight.name=`Nearest torch shadow proxy`,this.shadowLight.castShadow=!0,this.shadowLight.shadow.mapSize.set(1024,1024),this.shadowLight.shadow.camera.near=.25,this.shadowLight.shadow.camera.far=12,this.shadowLight.shadow.bias=-16e-5,this.shadowLight.shadow.normalBias=.035,this.group.add(this.shadowLight,this.shadowLight.target)}update(e,t){let n=0,r=1/0;this.torches.forEach((i,a)=>{let o=i.position.distanceTo(t);o<r&&(r=o,n=a);let s=1+Math.sin(e*11.3+i.phase)*.055+Math.sin(e*17.7+i.phase*2.2)*.028;i.intensity=22*s,i.flame.scale.y=s,i.flame.material.uniforms.uTime.value=e}),this.lightPool.update(t,this.torches);let i=this.torches[n];i&&(n!==this.activeShadowTorch&&(this.activeShadowTorch=n,this.shadowLight.position.copy(i.position),this.shadowLight.target.position.copy(i.position).addScaledVector(i.inward,3.1).setY(yt(i.position.x,i.position.z)+.65),this.shadowLight.shadow.needsUpdate=!0),this.shadowLight.intensity=r<13?64+Math.sin(e*12.1)*4:0)}getLightDiagnostics(){return this.lightPool.getDiagnostics()}getShadowDiagnostics(){let e=this.shadowLight.position,t=this.shadowLight.target.position;return{activeTorch:this.activeShadowTorch,enabled:this.shadowLight.castShadow&&this.shadowLight.intensity>0,intensity:this.shadowLight.intensity,position:[e.x,e.y,e.z],target:[t.x,t.y,t.z],mapSize:[this.shadowLight.shadow.mapSize.x,this.shadowLight.shadow.mapSize.y]}}createTorch(e,t,n){let r=new B,i=xt(e)+t*(mt(e)-.48),o=yt(i,e)+n.range(1.62,2.15);r.position.set(i,o,e);let s=new p(-t,-.18,0).normalize();r.rotation.z=t*-.15;let l=new Ke({color:2104087,roughness:.48,metalness:.82}),u=new Ke({color:3282699,roughness:.9,metalness:.02}),f=new I(new a(.055,.08,.82,7),u);f.castShadow=!0;let m=new I(new it(.105,.026,6,12),l);m.rotation.x=Math.PI/2,m.position.y=.37;let h=new I(new a(.035,.035,.54,6),l);h.rotation.z=Math.PI/2,h.position.set(t*.22,-.18,0),r.add(f,m,h);let g=new c({uniforms:{uTime:{value:0},uPhase:{value:n.range(0,Math.PI*2)}},vertexShader:ac,fragmentShader:oc,transparent:!0,blending:2,depthWrite:!1,side:2}),_=new I(new d(.15,9,12),g);_.scale.set(.72,1.8,.72),_.position.y=.57,r.add(_),r.updateMatrixWorld(!0);let v=new p,y=new p,b=(e,t,n)=>{v.set(e,t,0),r.localToWorld(y.copy(v)),this.worldColliders.push({center:y.clone(),radius:n,walkable:!1,kind:`torch`})};for(let e of[-.41,-.205,0,.205,.41])b(0,e,.112);for(let e of[-.27,-.135,0,.135,.27])b(t*.22+e,-.18,.104);b(0,.37,.145);let x=new p(i,o+.58,e);this.group.add(r),this.torches.push({root:r,flame:_,position:x,inward:s,phase:n.range(0,Math.PI*2),color:new R(16753230),intensity:22,range:9.5})}},cc=.12,lc=.55,uc=`
